...
function(RPI BOARD_NAME)
  ...
  if(BOARD_NAME STREQUAL "rpi0" OR BOARD_NAME STREQUAL "rpi1" OR BOARD_NAME STREQUAL "rpi2")
    set(CMAKE_C_COMPILER ${TC_PATH}arm-linux-gnueabihf-gcc)
  ...
  elseif((BOARD_NAME STREQUAL "rpi3") OR (BOARD_NAME STREQUAL "rpi4"))
    ...
    set(CMAKE_C_COMPILER ${TC_PATH}aarch64-linux-gnu-gcc CACHE PATH "" FORCE)
    set(CMAKE_CXX_COMPILER ${TC_PATH}aarch64-linux-gnu-g++ CACHE PATH "" FORCE)
  endif()
