...
if((TOOLCHAIN_PREFIX) AND (CMAKE_SYSROOT))
...
elseif(NOT CMAKE_SYSROOT)
  message(FATAL_ERROR "Can not proceed CMAKE_SYSROOT is not defined, please define CMAKE_SYSROOT in addition to TOOLCHAIN_PREFIX")
elseif(NOT TOOLCHAIN_PREFIX)
  message(FATAL_ERROR  "Can not proceed TOOLCHAIN_PREFIX is not defined, please define TOOLCHAIN_PREFIX in addition to CMAKE_SYSROOT")
else ()
