\section{src/mlpack/methods/ann/layer/convolution.hpp File Reference}
\label{convolution_8hpp}\index{src/mlpack/methods/ann/layer/convolution.\+hpp@{src/mlpack/methods/ann/layer/convolution.\+hpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=175pt]{convolution_8hpp__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
