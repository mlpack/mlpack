...
@code
 ...
 - C:\mlpack\mlpack-3.4.0\build\include
@endcode
- Under Linker > Input > Additional Dependencies add:
@code
 - C:\mlpack\mlpack-3.4.0\build\Debug\mlpack.lib
...
@code
 - xcopy /y "C:\mlpack\mlpack-3.4.0\build\Debug\mlpack.dll" $(OutDir)
 - xcopy /y "C:\mlpack\mlpack-3.4.0\packages\OpenBLAS.0.2.14.1\lib\native\bin\x64\*.dll" $(OutDir)
@endcode
