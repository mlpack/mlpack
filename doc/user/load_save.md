...
|---------------------------|---------------------------------------|----------------------------|-------------------|
| _Metadata._               |                                       |                            |                   |
| _(n/a)_                   | `opts.AudioDuration()`                | [Audio data](#audio-data)  | Returns a . |
| _(n/a)_                   | `opts.AvgBytesPerSec()`               | [Audio data](#audio-data)  | Returns a . |
| _(n/a)_                   | `opts.BitPerSample()`                 | [Audio data](#audio-data)  | Returns a . |
| _(n/a)_                   | `opts.Channels()`                     | [Audio data](#audio-data)  | Returns a . |
| _(n/a)_                   | `opts.FileBitRate()`                  | [Audio data](#audio-data)  | Returns a . |
| _(n/a)_                   | `opts.SampleRate()`                   | [Audio data](#audio-data)  | Returns a . |
| _(n/a)_                   | `opts.TotalFramesRead()`              | [Audio data](#audio-data)  | Returns a . |
| _(n/a)_                   | `opts.TotalPCMFramesCount()`          | [Audio data](#audio-data)  | Returns a . |
| _(n/a)_                   | `opts.TotalPCMFramesCount()`          | [Audio data](#audio-data)  | Returns a . |
| _(n/a)_                   | `opts.TotalSamples()`                 | [Audio data](#audio-data)  | Returns a . |
|---------------------------|---------------------------------------|----------------------------|-------------------|
<!-- @rcurtin other metadata exists, but I think only the above are the relevant one -->
<!-- @rcurtin Return type for the above to be added later, once we agreed on them -->
 ...
 * When calling [`Load()`](#load) and [`Save()`](#save), `X`
...
[`Save()`](#save); this object contains a `DatasetInfo` object,
accessible via the
...
namespace) can be saved with [`Save()`](#save) and loaded with
