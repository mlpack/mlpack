...
| `-DMLPACK_USE_SYSTEM_DR_LIBS` | `#define MLPACK_USE_SYSTEM_DR_LIBS` | Use the version of dr\_mp3 and dr\_wav available on the system instead of the version bundled with mlpack.  If set, make sure `dr_mp3.h` and `dr_wav.h` are available. |
| `-DMLPACK_DISABLE_WAV` | `#define MLPACK_DISABLE_WAV` | Disable WAV file's loading support within mlpack; use this if you do not have an audio support on your system or if you simply not planning to load audio files. |
| `-DMLPACK_DISABLE_MP3` | `#define MLPACK_DISABLE_MP3` | Disable MP3 file's loading support within mlpack; use this if you do not have an audio support on your system or if you simply not planning to load audio files. |
