...
| `-DMLPACK_DISABLE_STB` | `#define MLPACK_DISABLE_STB` | Disable stb (image) support within mlpack; use this if your system does not need image processing (e.g., real time sensors data). |
...
| `-DMLPACK_DISABLE_DR_LIBS` | `#define MLPACK_DISABLE_DR_LIBS` | Disable dr\_libs (audio) support within mlpack; use this if your system does not need audio processing (e.g., real time sensors data). |
