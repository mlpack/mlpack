...
| `-DDISABLE_DR_LIBS=OFF` | Disable dr\_libs (audio) support within mlpack; use this if your system does not need audio processing (e.g., real time sensors data). | `OFF` |
