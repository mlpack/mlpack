 ...
 * [The R\*-tree: An Efficient And Robust Access Method for Points and Rectangles (pdf)](https://files.core.ac.uk/download/pdf/12165134.pdf)
...
Build two `RStarTree`s on subsets of the corel dataset and compute minimum and
