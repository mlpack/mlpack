...
.. _file__home_aakash_mlpack_src_mlpack_methods_ann_layer_recurrent_attention.hpp:
...
Definition (``/home/aakash/mlpack/src/mlpack/methods/ann/layer/recurrent_attention.hpp``)
-----------------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file__home_aakash_mlpack_src_mlpack_methods_ann_layer_recurrent_attention.hpp.rst
...
- ``../visitor/reset_visitor.hpp``

- ``../visitor/weight_size_visitor.hpp``
...
.. doxygenfile:: /home/aakash/mlpack/src/mlpack/methods/ann/layer/recurrent_attention.hpp
