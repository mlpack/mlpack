...
.. _program_listing_file__home_aakash_mlpack_src_mlpack_bindings_R_get_printable_type.hpp:

Program Listing for File get_printable_type.hpp
===============================================

|exhale_lsh| :ref:`Return to documentation for file <file__home_aakash_mlpack_src_mlpack_bindings_R_get_printable_type.hpp>` (``/home/aakash/mlpack/src/mlpack/bindings/R/get_printable_type.hpp``)
