...
.. _file__home_aakash_mlpack_src_mlpack_methods_ann_layer_flatten_t_swish_impl.hpp:

File flatten_t_swish_impl.hpp
=============================
...
Definition (``/home/aakash/mlpack/src/mlpack/methods/ann/layer/flatten_t_swish_impl.hpp``)
------------------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file__home_aakash_mlpack_src_mlpack_methods_ann_layer_flatten_t_swish_impl.hpp.rst
...
- ``mlpack/methods/ann/activation_functions/rectifier_function.hpp`` (:ref:`file__home_aakash_mlpack_src_mlpack_methods_ann_activation_functions_rectifier_function.hpp`)
...
.. doxygenfile:: /home/aakash/mlpack/src/mlpack/methods/ann/layer/flatten_t_swish_impl.hpp
