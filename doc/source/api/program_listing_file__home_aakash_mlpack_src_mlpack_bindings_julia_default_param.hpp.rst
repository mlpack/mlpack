...
.. _program_listing_file__home_aakash_mlpack_src_mlpack_bindings_julia_default_param.hpp:

Program Listing for File default_param.hpp
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file__home_aakash_mlpack_src_mlpack_bindings_julia_default_param.hpp>` (``/home/aakash/mlpack/src/mlpack/bindings/julia/default_param.hpp``)
...
.. code-block:: cpp
   ...
   #ifndef MLPACK_BINDINGS_JULIA_DEFAULT_PARAM_HPP
   #define MLPACK_BINDINGS_JULIA_DEFAULT_PARAM_HPP
