\doxysection{Hard\+Sigmoid\+Function Class Reference}
\label{classmlpack_1_1ann_1_1HardSigmoidFunction}\index{HardSigmoidFunction@{HardSigmoidFunction}}
...
\begin{eqnarray*} f(x) &=& \min(1, \max(0, 0.2 * x + 0.5)) \\ f\textnormal{\textquotesingle}(x) &=& \left\{ \begin{array}{lr} 0.0 & : x={0,1} \\ 0.2 \end{array} \right. \end{eqnarray*} 
...
\index{HardSigmoidFunction@{HardSigmoidFunction}!Deriv@{Deriv}}
\index{Deriv@{Deriv}!HardSigmoidFunction@{HardSigmoidFunction}}
...
\index{HardSigmoidFunction@{HardSigmoidFunction}!Fn@{Fn}}
\index{Fn@{Fn}!HardSigmoidFunction@{HardSigmoidFunction}}
