\doxysection{/home/aakash/mlpack/src/mlpack/methods/fastmks/fastmks.hpp File Reference}
...
\begin{center}
\leavevmode
\includegraphics[width=203pt]{fastmks_8hpp__dep__incl}
\end{center}
\end{figure}
\doxysubsection*{Classes}
\begin{DoxyCompactItemize}
\item 
class \textbf{ Fast\+MKS$<$ Kernel\+Type, Mat\+Type, Tree\+Type $>$}
...
Ryan Curtin
\end{DoxyAuthor}
Definition of the Fast\+MKS class, which implements fast exact max-\/kernel search.
