\doxysection{Multi\+Quad\+Function Class Reference}
\label{classmlpack_1_1ann_1_1MultiQuadFunction}\index{MultiQuadFunction@{MultiQuadFunction}}
...
\begin{eqnarray*} f(x) = \sqrt(1 + x^2) \\ f\textnormal{\textquotesingle}(x) = x / f(x) \\ \end{eqnarray*} 
...
\index{MultiQuadFunction@{MultiQuadFunction}!Deriv@{Deriv}}
\index{Deriv@{Deriv}!MultiQuadFunction@{MultiQuadFunction}}
...
\index{MultiQuadFunction@{MultiQuadFunction}!Fn@{Fn}}
\index{Fn@{Fn}!MultiQuadFunction@{MultiQuadFunction}}
