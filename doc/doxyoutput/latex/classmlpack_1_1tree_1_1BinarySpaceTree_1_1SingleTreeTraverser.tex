\doxysection{Binary\+Space\+Tree$<$ Metric\+Type, Statistic\+Type, Mat\+Type, Bound\+Type, Split\+Type $>$\+::Single\+Tree\+Traverser$<$ Rule\+Type $>$ Class Template Reference}
\label{classmlpack_1_1tree_1_1BinarySpaceTree_1_1SingleTreeTraverser}\index{BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$@{BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$}}
...
\index{BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$@{BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$}!SingleTreeTraverser@{SingleTreeTraverser}}
\index{SingleTreeTraverser@{SingleTreeTraverser}!BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$@{BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$}}
...
\index{BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$@{BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$}!NumPrunes@{NumPrunes}}
\index{NumPrunes@{NumPrunes}!BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$@{BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$}}
...
\index{BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$@{BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$}!Traverse@{Traverse}}
\index{Traverse@{Traverse}!BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$@{BinarySpaceTree$<$ MetricType, StatisticType, MatType, BoundType, SplitType $>$::SingleTreeTraverser$<$ RuleType $>$}}
