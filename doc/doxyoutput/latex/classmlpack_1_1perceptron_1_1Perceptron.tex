\doxysection{Perceptron$<$ Learn\+Policy, Weight\+Initialization\+Policy, Mat\+Type $>$ Class Template Reference}
\label{classmlpack_1_1perceptron_1_1Perceptron}\index{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}}
...
\begin{DoxyCompactList}\small\item\em Modify the weight matrix. You had better know what you are doing! \end{DoxyCompactList}\item 
const arma\+::mat \& \textbf{ Weights} () const
\begin{DoxyCompactList}\small\item\em Get the weight matrix. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\index{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}!Perceptron@{Perceptron}}
\index{Perceptron@{Perceptron}!Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}}
\doxysubsubsection{Perceptron()\hspace{0.1cm}{\footnotesize\ttfamily [1/3]}}
...
\index{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}!Perceptron@{Perceptron}}
\index{Perceptron@{Perceptron}!Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}}
\doxysubsubsection{Perceptron()\hspace{0.1cm}{\footnotesize\ttfamily [2/3]}}
...
\index{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}!Perceptron@{Perceptron}}
\index{Perceptron@{Perceptron}!Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}}
\doxysubsubsection{Perceptron()\hspace{0.1cm}{\footnotesize\ttfamily [3/3]}}
...
\index{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}!Biases@{Biases}}
\index{Biases@{Biases}!Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}}
\doxysubsubsection{Biases()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}!Biases@{Biases}}
\index{Biases@{Biases}!Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}}
\doxysubsubsection{Biases()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}!Classify@{Classify}}
\index{Classify@{Classify}!Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}}
...
\index{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}!MaxIterations@{MaxIterations}}
\index{MaxIterations@{MaxIterations}!Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}}
...
\index{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}!NumClasses@{NumClasses}}
\index{NumClasses@{NumClasses}!Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}}
...
\index{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}!serialize@{serialize}}
\index{serialize@{serialize}!Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}}
...
\index{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}!Train@{Train}}
\index{Train@{Train}!Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}}
...
\index{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}!Weights@{Weights}}
\index{Weights@{Weights}!Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$@{Perceptron$<$ LearnPolicy, WeightInitializationPolicy, MatType $>$}}
