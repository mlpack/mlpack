\doxysection{mlpack\+::regression Namespace Reference}
...
class \textbf{ LARS}
\begin{DoxyCompactList}\small\item\em An implementation of \doxyref{LARS}{p.}{classmlpack_1_1regression_1_1LARS}, a stage-\/wise homotopy-\/based algorithm for l1-\/regularized linear regression (LASSO) and l1+l2 regularized linear regression (Elastic Net). \end{DoxyCompactList}\item 
