\doxysection{Columns\+To\+Blocks Class Reference}
\label{classmlpack_1_1math_1_1ColumnsToBlocks}\index{ColumnsToBlocks@{ColumnsToBlocks}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{comment}{// We assume we have a sparse autoencoder 'encoder'.}}
...
\DoxyCodeLine{\textcolor{comment}{// You can save the output as a pgm, this may help you visualize the training}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{comment}{// This matrix has two columns.}}
\DoxyCodeLine{arma::mat input;}
\DoxyCodeLine{input = \{ \{ -\/1.0000, 0.1429 \},}
\DoxyCodeLine{          \{ -\/0.7143, 0.4286 \},}
\DoxyCodeLine{          \{ -\/0.4286, 0.7143 \},}
\DoxyCodeLine{          \{ -\/0.1429, 1.0000 \} \};}
\DoxyCodeLine{}
\DoxyCodeLine{arma::mat output;}
\DoxyCodeLine{ColumnsToBlocks ctb(1, 2);}
\DoxyCodeLine{ctb.Transform(input, output);}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// The columns of the input will be reshaped as a square which is}}
\DoxyCodeLine{\textcolor{comment}{// surrounded by padding value -\/1 (this value could be changed with the}}
\DoxyCodeLine{\textcolor{comment}{// BufValue() method):}}
\DoxyCodeLine{\textcolor{comment}{// -\/1.0000  -\/1.0000  -\/1.0000  -\/1.0000  -\/1.0000  -\/1.0000  -\/1.0000}}
\DoxyCodeLine{\textcolor{comment}{// -\/1.0000  -\/1.0000  -\/0.4286  -\/1.0000   0.1429   0.7143  -\/1.0000}}
\DoxyCodeLine{\textcolor{comment}{// -\/1.0000  -\/0.7143  -\/0.1429  -\/1.0000   0.4286   1.0000  -\/1.0000}}
\DoxyCodeLine{\textcolor{comment}{// -\/1.0000  -\/1.0000  -\/1.0000  -\/1.0000  -\/1.0000  -\/1.0000  -\/1.0000}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Now, let's change some parameters; let's have each input column output not}}
\DoxyCodeLine{\textcolor{comment}{// as a square, but as a 4x1 vector.}}
\DoxyCodeLine{ctb.BlockWidth(1);}
\DoxyCodeLine{ctb.BlockHeight(4);}
\DoxyCodeLine{ctb.Transform(input, output);}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// The output here will be similar, but each maximal input is 4x1:}}
\DoxyCodeLine{\textcolor{comment}{// -\/1.0000 -\/1.0000 -\/1.0000 -\/1.0000 -\/1.0000}}
\DoxyCodeLine{\textcolor{comment}{// -\/1.0000 -\/1.0000 -\/1.0000  0.1429 -\/1.0000}}
\DoxyCodeLine{\textcolor{comment}{// -\/1.0000 -\/0.7143 -\/1.0000  0.4286 -\/1.0000}}
\DoxyCodeLine{\textcolor{comment}{// -\/1.0000 -\/0.4286 -\/1.0000  0.7143 -\/1.0000}}
\DoxyCodeLine{\textcolor{comment}{// -\/1.0000 -\/0.1429 -\/1.0000  1.0000 -\/1.0000}}
\DoxyCodeLine{\textcolor{comment}{// -\/1.0000 -\/1.0000 -\/1.0000 -\/1.0000 -\/1.0000}}

\end{DoxyCode}


The \doxyref{Columns\+To\+Blocks}{p.}{classmlpack_1_1math_1_1ColumnsToBlocks} class can also, depending on the parameters, scale the input to a given range (useful for exporting to PGM, for instance), and also set the buffer size and value. See the \doxyref{Scale()}{p.}{classmlpack_1_1math_1_1ColumnsToBlocks_a668b1e7a0dab0c0dc31f1097f57f1c38}, \doxyref{Min\+Range()}{p.}{classmlpack_1_1math_1_1ColumnsToBlocks_abcc192d4fe9322997d9bc1b6fbd5fb40}, \doxyref{Max\+Range()}{p.}{classmlpack_1_1math_1_1ColumnsToBlocks_a87701466a13a6cc63643b9f46eaa2bed}, \doxyref{Buf\+Size()}{p.}{classmlpack_1_1math_1_1ColumnsToBlocks_a0ed6759ae521a7c0183187697bc048e9}, and \doxyref{Buf\+Value()}{p.}{classmlpack_1_1math_1_1ColumnsToBlocks_a1f975716805f8568cda0888a78e917b8} methods for more details. 
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!ColumnsToBlocks@{ColumnsToBlocks}}
\index{ColumnsToBlocks@{ColumnsToBlocks}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{ColumnsToBlocks()}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!BlockHeight@{BlockHeight}}
\index{BlockHeight@{BlockHeight}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{BlockHeight()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!BlockHeight@{BlockHeight}}
\index{BlockHeight@{BlockHeight}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{BlockHeight()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!BlockWidth@{BlockWidth}}
\index{BlockWidth@{BlockWidth}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{BlockWidth()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!BlockWidth@{BlockWidth}}
\index{BlockWidth@{BlockWidth}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{BlockWidth()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!BufSize@{BufSize}}
\index{BufSize@{BufSize}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{BufSize()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!BufSize@{BufSize}}
\index{BufSize@{BufSize}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{BufSize()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!BufValue@{BufValue}}
\index{BufValue@{BufValue}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{BufValue()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!BufValue@{BufValue}}
\index{BufValue@{BufValue}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{BufValue()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!Cols@{Cols}}
\index{Cols@{Cols}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{Cols()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!Cols@{Cols}}
\index{Cols@{Cols}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{Cols()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!MaxRange@{MaxRange}}
\index{MaxRange@{MaxRange}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{MaxRange()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!MaxRange@{MaxRange}}
\index{MaxRange@{MaxRange}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{MaxRange()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!MinRange@{MinRange}}
\index{MinRange@{MinRange}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{MinRange()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!MinRange@{MinRange}}
\index{MinRange@{MinRange}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{MinRange()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!Rows@{Rows}}
\index{Rows@{Rows}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{Rows()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!Rows@{Rows}}
\index{Rows@{Rows}!ColumnsToBlocks@{ColumnsToBlocks}}
\doxysubsubsection{Rows()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!Scale@{Scale}}
\index{Scale@{Scale}!ColumnsToBlocks@{ColumnsToBlocks}}
...
\index{ColumnsToBlocks@{ColumnsToBlocks}!Transform@{Transform}}
\index{Transform@{Transform}!ColumnsToBlocks@{ColumnsToBlocks}}
