...
\index{Timers@{Timers}!Enabled@{Enabled}}
\index{Enabled@{Enabled}!Timers@{Timers}}
\doxysubsubsection{Enabled()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{Timers@{Timers}!Enabled@{Enabled}}
\index{Enabled@{Enabled}!Timers@{Timers}}
\doxysubsubsection{Enabled()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{Timers@{Timers}!GetAllTimers@{GetAllTimers}}
\index{GetAllTimers@{GetAllTimers}!Timers@{Timers}}
\doxysubsubsection{GetAllTimers()}
...
\index{Timers@{Timers}!GetTimer@{GetTimer}}
\index{GetTimer@{GetTimer}!Timers@{Timers}}
\doxysubsubsection{GetTimer()}
...
\index{Timers@{Timers}!PrintTimer@{PrintTimer}}
\index{PrintTimer@{PrintTimer}!Timers@{Timers}}
\doxysubsubsection{PrintTimer()}
...
\index{Timers@{Timers}!Reset@{Reset}}
\index{Reset@{Reset}!Timers@{Timers}}
...
\index{Timers@{Timers}!StartTimer@{StartTimer}}
\index{StartTimer@{StartTimer}!Timers@{Timers}}
...
\index{Timers@{Timers}!StopAllTimers@{StopAllTimers}}
\index{StopAllTimers@{StopAllTimers}!Timers@{Timers}}
\doxysubsubsection{StopAllTimers()}
...
\index{Timers@{Timers}!StopTimer@{StopTimer}}
\index{StopTimer@{StopTimer}!Timers@{Timers}}
