\doxysection{SILUFunction Class Reference}
\label{classmlpack_1_1ann_1_1SILUFunction}\index{SILUFunction@{SILUFunction}}
...
\begin{DoxyCompactList}\small\item\em Computes the first derivative of the SILU function. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Computes the first derivatives of the SILU function. \end{DoxyCompactList}\item 
static double \textbf{ Fn} (const double x)
\begin{DoxyCompactList}\small\item\em Computes the SILU function. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Computes the SILU function. \end{DoxyCompactList}\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
The SILU function, defined by. 

\begin{eqnarray*} f(x) &=& x * \frac{1}{1 + e^{-x}}\\ f\textnormal{\textquotesingle}(x) &=& \frac{1}{1 + e^{-x}} * (1 + x * (1-\frac{1}{1 + e^{-x}}))\\ \end{eqnarray*} 
...
\index{SILUFunction@{SILUFunction}!Deriv@{Deriv}}
\index{Deriv@{Deriv}!SILUFunction@{SILUFunction}}
...
\index{SILUFunction@{SILUFunction}!Fn@{Fn}}
\index{Fn@{Fn}!SILUFunction@{SILUFunction}}
