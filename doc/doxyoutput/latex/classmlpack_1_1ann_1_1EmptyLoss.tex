\doxysection{Empty\+Loss$<$ Input\+Data\+Type, Output\+Data\+Type $>$ Class Template Reference}
\label{classmlpack_1_1ann_1_1EmptyLoss}\index{EmptyLoss$<$ InputDataType, OutputDataType $>$@{EmptyLoss$<$ InputDataType, OutputDataType $>$}}
...
\index{EmptyLoss$<$ InputDataType, OutputDataType $>$@{EmptyLoss$<$ InputDataType, OutputDataType $>$}!EmptyLoss@{EmptyLoss}}
\index{EmptyLoss@{EmptyLoss}!EmptyLoss$<$ InputDataType, OutputDataType $>$@{EmptyLoss$<$ InputDataType, OutputDataType $>$}}
\doxysubsubsection{EmptyLoss()}
...
\index{EmptyLoss$<$ InputDataType, OutputDataType $>$@{EmptyLoss$<$ InputDataType, OutputDataType $>$}!Backward@{Backward}}
\index{Backward@{Backward}!EmptyLoss$<$ InputDataType, OutputDataType $>$@{EmptyLoss$<$ InputDataType, OutputDataType $>$}}
...
\index{EmptyLoss$<$ InputDataType, OutputDataType $>$@{EmptyLoss$<$ InputDataType, OutputDataType $>$}!Forward@{Forward}}
\index{Forward@{Forward}!EmptyLoss$<$ InputDataType, OutputDataType $>$@{EmptyLoss$<$ InputDataType, OutputDataType $>$}}
