\doxysection{SVDBatch\+Learning Class Reference}
\label{classmlpack_1_1amf_1_1SVDBatchLearning}\index{SVDBatchLearning@{SVDBatchLearning}}
...
\item 
\textbf{ SVDBatch\+Learning} (double u=0.\+0002, double kw=0, double kh=0, double momentum=0.\+9)
\begin{DoxyCompactList}\small\item\em SVD Batch learning constructor. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Serialize the SVDBatch object. \end{DoxyCompactList}\item 
...
\index{SVDBatchLearning@{SVDBatchLearning}!SVDBatchLearning@{SVDBatchLearning}}
\index{SVDBatchLearning@{SVDBatchLearning}!SVDBatchLearning@{SVDBatchLearning}}
\doxysubsubsection{SVDBatchLearning()}
{\footnotesize\ttfamily \textbf{ SVDBatch\+Learning} (\begin{DoxyParamCaption}\item[{double}]{u = {\ttfamily 0.0002},  }\item[{double}]{kw = {\ttfamily 0},  }\item[{double}]{kh = {\ttfamily 0},  }\item[{double}]{momentum = {\ttfamily 0.9} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\index{SVDBatchLearning@{SVDBatchLearning}!HUpdate@{HUpdate}}
\index{HUpdate@{HUpdate}!SVDBatchLearning@{SVDBatchLearning}}
...
\index{SVDBatchLearning@{SVDBatchLearning}!Initialize@{Initialize}}
\index{Initialize@{Initialize}!SVDBatchLearning@{SVDBatchLearning}}
...
\index{SVDBatchLearning@{SVDBatchLearning}!serialize@{serialize}}
\index{serialize@{serialize}!SVDBatchLearning@{SVDBatchLearning}}
...
\index{SVDBatchLearning@{SVDBatchLearning}!WUpdate@{WUpdate}}
\index{WUpdate@{WUpdate}!SVDBatchLearning@{SVDBatchLearning}}
