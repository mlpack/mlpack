...
\label{classmlpack_1_1data_1_1ImageInfo}\index{ImageInfo@{ImageInfo}}
...
\begin{DoxyCompactList}\small\item\em Modify the image width. \end{DoxyCompactList}\item 
const size\+\_\+t \& \textbf{ Width} () const
\begin{DoxyCompactList}\small\item\em Get the image width. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\index{ImageInfo@{ImageInfo}!Channels@{Channels}}
\index{Channels@{Channels}!ImageInfo@{ImageInfo}}
\doxysubsubsection{Channels()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{ImageInfo@{ImageInfo}!Channels@{Channels}}
\index{Channels@{Channels}!ImageInfo@{ImageInfo}}
\doxysubsubsection{Channels()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\doxysubsubsection{Height()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{ImageInfo@{ImageInfo}!Height@{Height}}
\index{Height@{Height}!ImageInfo@{ImageInfo}}
\doxysubsubsection{Height()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{ImageInfo@{ImageInfo}!Quality@{Quality}}
\index{Quality@{Quality}!ImageInfo@{ImageInfo}}
\doxysubsubsection{Quality()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{ImageInfo@{ImageInfo}!Quality@{Quality}}
\index{Quality@{Quality}!ImageInfo@{ImageInfo}}
\doxysubsubsection{Quality()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{ImageInfo@{ImageInfo}!serialize@{serialize}}
\index{serialize@{serialize}!ImageInfo@{ImageInfo}}
