\doxysection{Dice\+Loss$<$ Input\+Data\+Type, Output\+Data\+Type $>$ Class Template Reference}
\label{classmlpack_1_1ann_1_1DiceLoss}\index{DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}}
...
double \& \textbf{ Smooth} ()
\begin{DoxyCompactList}\small\item\em Modify the smooth. \end{DoxyCompactList}\item 
double \textbf{ Smooth} () const
\begin{DoxyCompactList}\small\item\em Get the smooth. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{@article\{Milletari2016,}
\DoxyCodeLine{  author    = \{Fausto Milletari and Nassir Navab and Seyed\{-\/\}Ahmad Ahmadi\},}
\DoxyCodeLine{  title     = \{V-\/Net: Fully Convolutional Neural Networks \textcolor{keywordflow}{for}}
\DoxyCodeLine{               Volumetric Medical Image Segmentation\},}
\DoxyCodeLine{  journal   = \{CoRR\},}
\DoxyCodeLine{  volume    = \{abs/1606.04797\},}
\DoxyCodeLine{  year      = \{2016\},}
\DoxyCodeLine{  url       = \{http:\textcolor{comment}{//arxiv.org/abs/1606.04797\},}}
\DoxyCodeLine{  archivePrefix = \{arXiv\},}
\DoxyCodeLine{  eprint    = \{1606.04797\},}
\DoxyCodeLine{\}}
...
\index{DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}!DiceLoss@{DiceLoss}}
\index{DiceLoss@{DiceLoss}!DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}}
\doxysubsubsection{DiceLoss()}
...
\index{DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}!Backward@{Backward}}
\index{Backward@{Backward}!DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}}
...
\index{DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}!Forward@{Forward}}
\index{Forward@{Forward}!DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}}
...
\index{DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}!OutputParameter@{OutputParameter}}
\index{OutputParameter@{OutputParameter}!DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}}
...
\index{DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}!serialize@{serialize}}
\index{serialize@{serialize}!DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}}
...
\index{DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}!Smooth@{Smooth}}
\index{Smooth@{Smooth}!DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}}
\doxysubsubsection{Smooth()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}!Smooth@{Smooth}}
\index{Smooth@{Smooth}!DiceLoss$<$ InputDataType, OutputDataType $>$@{DiceLoss$<$ InputDataType, OutputDataType $>$}}
\doxysubsubsection{Smooth()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
