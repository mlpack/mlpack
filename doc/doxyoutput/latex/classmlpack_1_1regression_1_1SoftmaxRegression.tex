\doxysection{Softmax\+Regression Class Reference}
\label{classmlpack_1_1regression_1_1SoftmaxRegression}\index{SoftmaxRegression@{SoftmaxRegression}}
...
{\footnotesize template$<$typename Optimizer\+Type  = ens\+::\+L\+\_\+\+BFGS$>$ }\\\textbf{ Softmax\+Regression} (const arma\+::mat \&data, const arma\+::\+Row$<$ size\+\_\+t $>$ \&labels, const size\+\_\+t num\+Classes, const double lambda=0.\+0001, const bool fit\+Intercept=false, Optimizer\+Type optimizer=Optimizer\+Type())
\begin{DoxyCompactList}\small\item\em Construct the \doxyref{Softmax\+Regression}{p.}{classmlpack_1_1regression_1_1SoftmaxRegression} class with the provided data and labels. \end{DoxyCompactList}\item 
...
{\footnotesize template$<$typename Optimizer\+Type  = ens\+::\+L\+\_\+\+BFGS, typename... Callback\+Types$>$ }\\double \textbf{ Train} (const arma\+::mat \&data, const arma\+::\+Row$<$ size\+\_\+t $>$ \&labels, const size\+\_\+t num\+Classes, Optimizer\+Type optimizer, Callback\+Types \&\&... callbacks)
\begin{DoxyCompactList}\small\item\em Train the softmax regression with the given training data. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Optimizer\+Type  = ens\+::\+L\+\_\+\+BFGS$>$ }\\double \textbf{ Train} (const arma\+::mat \&data, const arma\+::\+Row$<$ size\+\_\+t $>$ \&labels, const size\+\_\+t num\+Classes, Optimizer\+Type optimizer=Optimizer\+Type())
...
{\texttt{ http\+://ufldl.\+stanford.\+edu/wiki/index.\+php/\+Softmax\+\_\+\+Regression}}

An example on how to use the interface is shown below\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{arma::mat trainData; \textcolor{comment}{// Training data matrix.}}
...
\DoxyCodeLine{\textcolor{keyword}{const} \textcolor{keywordtype}{size\_t} numClasses = 10; \textcolor{comment}{// Number of classes.}}
\DoxyCodeLine{\textcolor{keyword}{const} \textcolor{keywordtype}{double} lambda = 0.0001; \textcolor{comment}{// L2-\/Regularization parameter.}}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Train the model using an instantiated optimizer for the training.}}
\DoxyCodeLine{SoftmaxRegression regressor(trainData.n\_rows, numClasses);}
\DoxyCodeLine{ens::L\_BFGS optimizer(numBasis, numIterations);}
\DoxyCodeLine{regressor.Train(trainData, labels, numClasses, std::move(optimizer));}
\DoxyCodeLine{}
\DoxyCodeLine{arma::mat testData; \textcolor{comment}{// Test data matrix.}}
\DoxyCodeLine{arma::Row<size\_t> predictions; \textcolor{comment}{// Vectors to store predictions in.}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Obtain predictions from both the learned models.}}
\DoxyCodeLine{regressor.Classify(testData, predictions);}
...
\index{SoftmaxRegression@{SoftmaxRegression}!SoftmaxRegression@{SoftmaxRegression}}
\index{SoftmaxRegression@{SoftmaxRegression}!SoftmaxRegression@{SoftmaxRegression}}
\doxysubsubsection{SoftmaxRegression()\hspace{0.1cm}{\footnotesize\ttfamily [1/3]}}
...
\index{SoftmaxRegression@{SoftmaxRegression}!SoftmaxRegression@{SoftmaxRegression}}
\index{SoftmaxRegression@{SoftmaxRegression}!SoftmaxRegression@{SoftmaxRegression}}
\doxysubsubsection{SoftmaxRegression()\hspace{0.1cm}{\footnotesize\ttfamily [2/3]}}
...
\index{SoftmaxRegression@{SoftmaxRegression}!SoftmaxRegression@{SoftmaxRegression}}
\index{SoftmaxRegression@{SoftmaxRegression}!SoftmaxRegression@{SoftmaxRegression}}
\doxysubsubsection{SoftmaxRegression()\hspace{0.1cm}{\footnotesize\ttfamily [3/3]}}
...
\index{SoftmaxRegression@{SoftmaxRegression}!Classify@{Classify}}
\index{Classify@{Classify}!SoftmaxRegression@{SoftmaxRegression}}
...
\index{SoftmaxRegression@{SoftmaxRegression}!ComputeAccuracy@{ComputeAccuracy}}
\index{ComputeAccuracy@{ComputeAccuracy}!SoftmaxRegression@{SoftmaxRegression}}
...
\index{SoftmaxRegression@{SoftmaxRegression}!FeatureSize@{FeatureSize}}
\index{FeatureSize@{FeatureSize}!SoftmaxRegression@{SoftmaxRegression}}
...
\index{SoftmaxRegression@{SoftmaxRegression}!FitIntercept@{FitIntercept}}
\index{FitIntercept@{FitIntercept}!SoftmaxRegression@{SoftmaxRegression}}
...
\index{SoftmaxRegression@{SoftmaxRegression}!Lambda@{Lambda}}
\index{Lambda@{Lambda}!SoftmaxRegression@{SoftmaxRegression}}
...
\index{SoftmaxRegression@{SoftmaxRegression}!NumClasses@{NumClasses}}
\index{NumClasses@{NumClasses}!SoftmaxRegression@{SoftmaxRegression}}
...
\index{SoftmaxRegression@{SoftmaxRegression}!Parameters@{Parameters}}
\index{Parameters@{Parameters}!SoftmaxRegression@{SoftmaxRegression}}
...
\index{SoftmaxRegression@{SoftmaxRegression}!serialize@{serialize}}
\index{serialize@{serialize}!SoftmaxRegression@{SoftmaxRegression}}
...
\index{SoftmaxRegression@{SoftmaxRegression}!Train@{Train}}
\index{Train@{Train}!SoftmaxRegression@{SoftmaxRegression}}
