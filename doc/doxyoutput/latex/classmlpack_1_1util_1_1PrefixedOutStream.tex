\doxysection{Prefixed\+Out\+Stream Class Reference}
\label{classmlpack_1_1util_1_1PrefixedOutStream}\index{PrefixedOutStream@{PrefixedOutStream}}
...
\begin{DoxyCompactList}\small\item\em Write anything else to the stream. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Write a void pointer to the stream. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Public Attributes}
\begin{DoxyCompactItemize}
\item 
bool \textbf{ backtrace}
\begin{DoxyCompactList}\small\item\em If true, on a fatal error, a backtrace will be printed if HAS\+\_\+\+BFD\+\_\+\+DL is defined. \end{DoxyCompactList}\item 
std\+::ostream \& \textbf{ destination}
\begin{DoxyCompactList}\small\item\em The output stream that all data is to be sent to; example\+: MLPACK\+\_\+\+COUT\+\_\+\+STREAM. \end{DoxyCompactList}\item 
...
\begin{DoxyCode}{0}
\DoxyCodeLine{PrefixedOutStream outstr(MLPACK\_COUT\_STREAM, \textcolor{stringliteral}{"{}[TEST] "{}});}
\DoxyCodeLine{outstr << \textcolor{stringliteral}{"{}Hello world I like "{}} << 7.5;}
\DoxyCodeLine{outstr << \textcolor{stringliteral}{"{}...Continue"{}} << std::endl;}
\DoxyCodeLine{outstr << \textcolor{stringliteral}{"{}After the CR\(\backslash\)n"{}} << std::endl;}

\end{DoxyCode}


would give, on MLPACK\+\_\+\+COUT\+\_\+\+STREAM,


\begin{DoxyCode}{0}
\DoxyCodeLine{[TEST] Hello world I like 7.5...Continue}
\DoxyCodeLine{[TEST] After the CR}
\DoxyCodeLine{[TEST]}

\end{DoxyCode}


These objects are used for the \doxyref{mlpack\+::\+Log}{p.}{classmlpack_1_1Log} levels (DEBUG, INFO, WARN, and FATAL). 
...
\index{PrefixedOutStream@{PrefixedOutStream}!PrefixedOutStream@{PrefixedOutStream}}
\index{PrefixedOutStream@{PrefixedOutStream}!PrefixedOutStream@{PrefixedOutStream}}
\doxysubsubsection{PrefixedOutStream()}
...
\hline
{\em backtrace} & If true, attempt to print a backtrace (will only be done if HAS\+\_\+\+BFD\+\_\+\+DL is defined). \\
\hline
\end{DoxyParams}
...
\index{PrefixedOutStream@{PrefixedOutStream}!operator$<$$<$@{operator$<$$<$}}
\index{operator$<$$<$@{operator$<$$<$}!PrefixedOutStream@{PrefixedOutStream}}
...
\index{PrefixedOutStream@{PrefixedOutStream}!backtrace@{backtrace}}
\index{backtrace@{backtrace}!PrefixedOutStream@{PrefixedOutStream}}
\doxysubsubsection{backtrace}
{\footnotesize\ttfamily bool backtrace}



If true, on a fatal error, a backtrace will be printed if HAS\+\_\+\+BFD\+\_\+\+DL is defined. 
...
\index{PrefixedOutStream@{PrefixedOutStream}!destination@{destination}}
\index{destination@{destination}!PrefixedOutStream@{PrefixedOutStream}}
\doxysubsubsection{destination}
{\footnotesize\ttfamily std\+::ostream\& destination}



The output stream that all data is to be sent to; example\+: MLPACK\+\_\+\+COUT\+\_\+\+STREAM. 
...
\index{PrefixedOutStream@{PrefixedOutStream}!ignoreInput@{ignoreInput}}
\index{ignoreInput@{ignoreInput}!PrefixedOutStream@{PrefixedOutStream}}
\doxysubsubsection{ignoreInput}
