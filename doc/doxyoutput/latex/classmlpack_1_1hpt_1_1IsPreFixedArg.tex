\doxysection{Is\+Pre\+Fixed\+Arg$<$ T $>$ Class Template Reference}
\label{classmlpack_1_1hpt_1_1IsPreFixedArg}\index{IsPreFixedArg$<$ T $>$@{IsPreFixedArg$<$ T $>$}}
...
\index{IsPreFixedArg$<$ T $>$@{IsPreFixedArg$<$ T $>$}!value@{value}}
\index{value@{value}!IsPreFixedArg$<$ T $>$@{IsPreFixedArg$<$ T $>$}}
