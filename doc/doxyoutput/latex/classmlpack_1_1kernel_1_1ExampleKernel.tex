\doxysection{Example\+Kernel Class Reference}
\label{classmlpack_1_1kernel_1_1ExampleKernel}\index{ExampleKernel@{ExampleKernel}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{GaussianKernel k(5.0);}
\DoxyCodeLine{KernelPCA<GaussianKernel> kpca(dataset, k);}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{KernelPCA<GaussianKernel> kpca(dataset);}
...
\index{ExampleKernel@{ExampleKernel}!ExampleKernel@{ExampleKernel}}
\index{ExampleKernel@{ExampleKernel}!ExampleKernel@{ExampleKernel}}
\doxysubsubsection{ExampleKernel()}
...
\index{ExampleKernel@{ExampleKernel}!ConvolutionIntegral@{ConvolutionIntegral}}
\index{ConvolutionIntegral@{ConvolutionIntegral}!ExampleKernel@{ExampleKernel}}
...
\index{ExampleKernel@{ExampleKernel}!Evaluate@{Evaluate}}
\index{Evaluate@{Evaluate}!ExampleKernel@{ExampleKernel}}
...
\index{ExampleKernel@{ExampleKernel}!Normalizer@{Normalizer}}
\index{Normalizer@{Normalizer}!ExampleKernel@{ExampleKernel}}
...
\index{ExampleKernel@{ExampleKernel}!serialize@{serialize}}
\index{serialize@{serialize}!ExampleKernel@{ExampleKernel}}
