\doxysection{/home/aakash/mlpack/src/mlpack/methods/ann/activation\+\_\+functions/hard\+\_\+swish\+\_\+function.hpp File Reference}
\label{hard__swish__function_8hpp}\index{/home/aakash/mlpack/src/mlpack/methods/ann/activation\_functions/hard\_swish\_function.hpp@{/home/aakash/mlpack/src/mlpack/methods/ann/activation\_functions/hard\_swish\_function.hpp}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{@misc\{}
\DoxyCodeLine{  author = \{Howard A, Sandler M, Chu G, Chen LC, Chen B, Tan M, Wang W,}
\DoxyCodeLine{           Zhu Y, Pang R, Vasudevan V and Le QV\},}
\DoxyCodeLine{  title = \{Searching \textcolor{keywordflow}{for} MobileNetV3\},}
