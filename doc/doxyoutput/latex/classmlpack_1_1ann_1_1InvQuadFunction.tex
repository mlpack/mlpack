\doxysection{Inv\+Quad\+Function Class Reference}
\label{classmlpack_1_1ann_1_1InvQuadFunction}\index{InvQuadFunction@{InvQuadFunction}}
...
\begin{eqnarray*} f(x) = 1 / (1 + x^2) \\ f\textnormal{\textquotesingle}(x) = -2 * x / (1 + x^2)^2 \\ \end{eqnarray*} 
...
\index{InvQuadFunction@{InvQuadFunction}!Deriv@{Deriv}}
\index{Deriv@{Deriv}!InvQuadFunction@{InvQuadFunction}}
...
\index{InvQuadFunction@{InvQuadFunction}!Fn@{Fn}}
\index{Fn@{Fn}!InvQuadFunction@{InvQuadFunction}}
