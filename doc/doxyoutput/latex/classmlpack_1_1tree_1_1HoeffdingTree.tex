\doxysection{Hoeffding\+Tree$<$ Fitness\+Function, Numeric\+Split\+Type, Categorical\+Split\+Type $>$ Class Template Reference}
\label{classmlpack_1_1tree_1_1HoeffdingTree}\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
...
\textbf{ Hoeffding\+Tree} (const \textbf{ data\+::\+Dataset\+Info} \&dataset\+Info, const size\+\_\+t num\+Classes, const double success\+Probability=0.\+95, const size\+\_\+t max\+Samples=0, const size\+\_\+t check\+Interval=100, const size\+\_\+t min\+Samples=100, const Categorical\+Split\+Type$<$ Fitness\+Function $>$ \&categorical\+Split\+In=Categorical\+Split\+Type$<$ Fitness\+Function $>$(0, 0), const Numeric\+Split\+Type$<$ Fitness\+Function $>$ \&numeric\+Split\+In=Numeric\+Split\+Type$<$ Fitness\+Function $>$(0), std\+::unordered\+\_\+map$<$ size\+\_\+t, std\+::pair$<$ size\+\_\+t, size\+\_\+t $>$$>$ $\ast$dimension\+Mappings=NULL, const bool copy\+Dataset\+Info=true)
...
This class is able to train on samples in streaming settings and batch settings, and perform splits based on the Hoeffding bound. The Hoeffding tree (also known as the \char`\"{}very fast decision tree\char`\"{} -- VFDT) is described in the following paper\+:
...
\DoxyCodeLine{    booktitle=\{Proceedings of the Sixth ACM SIGKDD International Conference}
\DoxyCodeLine{        on Knowledge Discovery and Data Mining (KDD \textcolor{stringliteral}{'00)\},}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!CategoricalSplit@{CategoricalSplit}}
\index{CategoricalSplit@{CategoricalSplit}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!NumericSplit@{NumericSplit}}
\index{NumericSplit@{NumericSplit}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!HoeffdingTree@{HoeffdingTree}}
\index{HoeffdingTree@{HoeffdingTree}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{HoeffdingTree()\hspace{0.1cm}{\footnotesize\ttfamily [1/5]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!HoeffdingTree@{HoeffdingTree}}
\index{HoeffdingTree@{HoeffdingTree}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{HoeffdingTree()\hspace{0.1cm}{\footnotesize\ttfamily [2/5]}}
...
{\em min\+Samples} & If the node has seen this many points or fewer, no split will be allowed. \\
\hline
{\em dimension\+Mappings} & Mappings from dimension indices to positions in numeric and categorical split vectors. If left NULL, a new one will be created. \\
\hline
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!HoeffdingTree@{HoeffdingTree}}
\index{HoeffdingTree@{HoeffdingTree}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{HoeffdingTree()\hspace{0.1cm}{\footnotesize\ttfamily [3/5]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!HoeffdingTree@{HoeffdingTree}}
\index{HoeffdingTree@{HoeffdingTree}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{HoeffdingTree()\hspace{0.1cm}{\footnotesize\ttfamily [4/5]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!HoeffdingTree@{HoeffdingTree}}
\index{HoeffdingTree@{HoeffdingTree}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{HoeffdingTree()\hspace{0.1cm}{\footnotesize\ttfamily [5/5]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!````~HoeffdingTree@{$\sim$HoeffdingTree}}
\index{````~HoeffdingTree@{$\sim$HoeffdingTree}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{$\sim$HoeffdingTree()}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!CalculateDirection@{CalculateDirection}}
\index{CalculateDirection@{CalculateDirection}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!CheckInterval@{CheckInterval}}
\index{CheckInterval@{CheckInterval}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{CheckInterval()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!CheckInterval@{CheckInterval}}
\index{CheckInterval@{CheckInterval}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{CheckInterval()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!Child@{Child}}
\index{Child@{Child}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!Classify@{Classify}}
\index{Classify@{Classify}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!CreateChildren@{CreateChildren}}
\index{CreateChildren@{CreateChildren}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{CreateChildren()}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!MajorityClass@{MajorityClass}}
\index{MajorityClass@{MajorityClass}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{MajorityClass()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!MajorityClass@{MajorityClass}}
\index{MajorityClass@{MajorityClass}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{MajorityClass()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!MajorityProbability@{MajorityProbability}}
\index{MajorityProbability@{MajorityProbability}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{MajorityProbability()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!MajorityProbability@{MajorityProbability}}
\index{MajorityProbability@{MajorityProbability}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{MajorityProbability()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!MaxSamples@{MaxSamples}}
\index{MaxSamples@{MaxSamples}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{MaxSamples()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!MaxSamples@{MaxSamples}}
\index{MaxSamples@{MaxSamples}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{MaxSamples()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!MinSamples@{MinSamples}}
\index{MinSamples@{MinSamples}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{MinSamples()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!MinSamples@{MinSamples}}
\index{MinSamples@{MinSamples}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{MinSamples()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!NumChildren@{NumChildren}}
\index{NumChildren@{NumChildren}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!NumDescendants@{NumDescendants}}
\index{NumDescendants@{NumDescendants}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!operator=@{operator=}}
\index{operator=@{operator=}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!serialize@{serialize}}
\index{serialize@{serialize}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!SplitCheck@{SplitCheck}}
\index{SplitCheck@{SplitCheck}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{SplitCheck()}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!SplitDimension@{SplitDimension}}
\index{SplitDimension@{SplitDimension}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!SuccessProbability@{SuccessProbability}}
\index{SuccessProbability@{SuccessProbability}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{SuccessProbability()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!SuccessProbability@{SuccessProbability}}
\index{SuccessProbability@{SuccessProbability}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
\doxysubsubsection{SuccessProbability()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}!Train@{Train}}
\index{Train@{Train}!HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$@{HoeffdingTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType $>$}}
