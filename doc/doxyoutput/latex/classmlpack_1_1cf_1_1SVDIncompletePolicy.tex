\doxysection{SVDIncomplete\+Policy Class Reference}
\label{classmlpack_1_1cf_1_1SVDIncompletePolicy}\index{SVDIncompletePolicy@{SVDIncompletePolicy}}


Implementation of the SVD incomplete incremental to act as a wrapper when accessing SVD incomplete incremental from within \doxyref{CFType}{p.}{classmlpack_1_1cf_1_1CFType}.  
...
\begin{DoxyCompactList}\small\item\em Apply Collaborative Filtering to the provided data set using the SVD incomplete incremental method. \end{DoxyCompactList}\item 
...
An example of how to use \doxyref{SVDIncomplete\+Policy}{p.}{classmlpack_1_1cf_1_1SVDIncompletePolicy} in CF is shown below\+:
...
\DoxyCodeLine{}
\DoxyCodeLine{CFType<SVDIncompletePolicy> cf(data);}
\DoxyCodeLine{}
...
\index{SVDIncompletePolicy@{SVDIncompletePolicy}!Apply@{Apply}}
\index{Apply@{Apply}!SVDIncompletePolicy@{SVDIncompletePolicy}}
...
\index{SVDIncompletePolicy@{SVDIncompletePolicy}!GetNeighborhood@{GetNeighborhood}}
\index{GetNeighborhood@{GetNeighborhood}!SVDIncompletePolicy@{SVDIncompletePolicy}}
...
\index{SVDIncompletePolicy@{SVDIncompletePolicy}!GetRating@{GetRating}}
\index{GetRating@{GetRating}!SVDIncompletePolicy@{SVDIncompletePolicy}}
...
\index{SVDIncompletePolicy@{SVDIncompletePolicy}!GetRatingOfUser@{GetRatingOfUser}}
\index{GetRatingOfUser@{GetRatingOfUser}!SVDIncompletePolicy@{SVDIncompletePolicy}}
...
\index{SVDIncompletePolicy@{SVDIncompletePolicy}!H@{H}}
\index{H@{H}!SVDIncompletePolicy@{SVDIncompletePolicy}}
\doxysubsubsection{H()}
...
\index{SVDIncompletePolicy@{SVDIncompletePolicy}!serialize@{serialize}}
\index{serialize@{serialize}!SVDIncompletePolicy@{SVDIncompletePolicy}}
...
\index{SVDIncompletePolicy@{SVDIncompletePolicy}!W@{W}}
\index{W@{W}!SVDIncompletePolicy@{SVDIncompletePolicy}}
\doxysubsubsection{W()}
