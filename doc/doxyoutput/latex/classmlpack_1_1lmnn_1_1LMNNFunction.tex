\doxysection{LMNNFunction$<$ Metric\+Type $>$ Class Template Reference}
\label{classmlpack_1_1lmnn_1_1LMNNFunction}\index{LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}}
...
\item 
\textbf{ LMNNFunction} (const arma\+::mat \&dataset, const arma\+::\+Row$<$ size\+\_\+t $>$ \&labels, size\+\_\+t k, double regularization, size\+\_\+t range, Metric\+Type metric=Metric\+Type())
\begin{DoxyCompactList}\small\item\em Constructor for \doxyref{LMNNFunction}{p.}{classmlpack_1_1lmnn_1_1LMNNFunction} class. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Evaluate the \doxyref{LMNN}{p.}{classmlpack_1_1lmnn_1_1LMNN} function for the given transformation matrix. \end{DoxyCompactList}\item 
double \textbf{ Evaluate} (const arma\+::mat \&transformation, const size\+\_\+t begin, const size\+\_\+t batch\+Size=1)
\begin{DoxyCompactList}\small\item\em Evaluate the \doxyref{LMNN}{p.}{classmlpack_1_1lmnn_1_1LMNN} objective function for the given transformation matrix on the given batch size from a given inital point of the dataset. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Evaluate the \doxyref{LMNN}{p.}{classmlpack_1_1lmnn_1_1LMNN} objective function together with gradient for the given transformation matrix on the given batch size, from a given initial point of the dataset. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Evaluate the \doxyref{LMNN}{p.}{classmlpack_1_1lmnn_1_1LMNN} objective function together with gradient for the given transformation matrix. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Evaluate the gradient of the \doxyref{LMNN}{p.}{classmlpack_1_1lmnn_1_1LMNN} function for the given transformation matrix on the given batch size, from a given initial point of the dataset. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Grad\+Type $>$ }\\void \textbf{ Gradient} (const arma\+::mat \&transformation, Grad\+Type \&gradient)
\begin{DoxyCompactList}\small\item\em Evaluate the gradient of the \doxyref{LMNN}{p.}{classmlpack_1_1lmnn_1_1LMNN} function for the given transformation matrix. \end{DoxyCompactList}\item 
size\+\_\+t \& \textbf{ K} ()
...
class mlpack\+::lmnn\+::\+LMNNFunction$<$ Metric\+Type $>$}
...
\index{LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}!LMNNFunction@{LMNNFunction}}
\index{LMNNFunction@{LMNNFunction}!LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}}
\doxysubsubsection{LMNNFunction()}
{\footnotesize\ttfamily \textbf{ LMNNFunction} (\begin{DoxyParamCaption}\item[{const arma\+::mat \&}]{dataset,  }\item[{const arma\+::\+Row$<$ size\+\_\+t $>$ \&}]{labels,  }\item[{size\+\_\+t}]{k,  }\item[{double}]{regularization,  }\item[{size\+\_\+t}]{range,  }\item[{Metric\+Type}]{metric = {\ttfamily MetricType()} }\end{DoxyParamCaption})}



Constructor for \doxyref{LMNNFunction}{p.}{classmlpack_1_1lmnn_1_1LMNNFunction} class. 
...
\index{LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}!Dataset@{Dataset}}
\index{Dataset@{Dataset}!LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}}
...
\index{LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}!Evaluate@{Evaluate}}
\index{Evaluate@{Evaluate}!LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}}
...
Evaluate the \doxyref{LMNN}{p.}{classmlpack_1_1lmnn_1_1LMNN} function for the given transformation matrix. 
...
Evaluate the \doxyref{LMNN}{p.}{classmlpack_1_1lmnn_1_1LMNN} objective function for the given transformation matrix on the given batch size from a given inital point of the dataset. 
...
\index{LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}!EvaluateWithGradient@{EvaluateWithGradient}}
\index{EvaluateWithGradient@{EvaluateWithGradient}!LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}}
...
Evaluate the \doxyref{LMNN}{p.}{classmlpack_1_1lmnn_1_1LMNN} objective function together with gradient for the given transformation matrix on the given batch size, from a given initial point of the dataset. 
...
Evaluate the \doxyref{LMNN}{p.}{classmlpack_1_1lmnn_1_1LMNN} objective function together with gradient for the given transformation matrix. 
...
\index{LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}!GetInitialPoint@{GetInitialPoint}}
\index{GetInitialPoint@{GetInitialPoint}!LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}}
...
\index{LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}!Gradient@{Gradient}}
\index{Gradient@{Gradient}!LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}}
...
Evaluate the gradient of the \doxyref{LMNN}{p.}{classmlpack_1_1lmnn_1_1LMNN} function for the given transformation matrix on the given batch size, from a given initial point of the dataset. 
...
Evaluate the gradient of the \doxyref{LMNN}{p.}{classmlpack_1_1lmnn_1_1LMNN} function for the given transformation matrix. 
...
\index{LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}!K@{K}}
\index{K@{K}!LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}}
...
\index{LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}!NumFunctions@{NumFunctions}}
\index{NumFunctions@{NumFunctions}!LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}}
...
\index{LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}!Range@{Range}}
\index{Range@{Range}!LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}}
...
\index{LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}!Regularization@{Regularization}}
\index{Regularization@{Regularization}!LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}}
...
\index{LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}!Shuffle@{Shuffle}}
\index{Shuffle@{Shuffle}!LMNNFunction$<$ MetricType $>$@{LMNNFunction$<$ MetricType $>$}}
