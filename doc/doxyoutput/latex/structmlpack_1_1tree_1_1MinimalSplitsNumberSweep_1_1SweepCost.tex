\doxysection{Minimal\+Splits\+Number\+Sweep$<$ Split\+Policy $>$\+::Sweep\+Cost$<$ typename $>$ Struct Template Reference}
\label{structmlpack_1_1tree_1_1MinimalSplitsNumberSweep_1_1SweepCost}\index{MinimalSplitsNumberSweep$<$ SplitPolicy $>$::SweepCost$<$ typename $>$@{MinimalSplitsNumberSweep$<$ SplitPolicy $>$::SweepCost$<$ typename $>$}}
...
\index{MinimalSplitsNumberSweep$<$ SplitPolicy $>$::SweepCost$<$ typename $>$@{MinimalSplitsNumberSweep$<$ SplitPolicy $>$::SweepCost$<$ typename $>$}!type@{type}}
\index{type@{type}!MinimalSplitsNumberSweep$<$ SplitPolicy $>$::SweepCost$<$ typename $>$@{MinimalSplitsNumberSweep$<$ SplitPolicy $>$::SweepCost$<$ typename $>$}}
