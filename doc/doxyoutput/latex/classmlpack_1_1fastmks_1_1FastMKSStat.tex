\doxysection{Fast\+MKSStat Class Reference}
\label{classmlpack_1_1fastmks_1_1FastMKSStat}\index{FastMKSStat@{FastMKSStat}}


The statistic used in trees with \doxyref{Fast\+MKS}{p.}{classmlpack_1_1fastmks_1_1FastMKS}.  
...
{\footnotesize template$<$typename Tree\+Type $>$ }\\\textbf{ Fast\+MKSStat} (const Tree\+Type \&node)
...
\index{FastMKSStat@{FastMKSStat}!FastMKSStat@{FastMKSStat}}
\index{FastMKSStat@{FastMKSStat}!FastMKSStat@{FastMKSStat}}
\doxysubsubsection{FastMKSStat()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily \textbf{ Fast\+MKSStat} (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\index{FastMKSStat@{FastMKSStat}!FastMKSStat@{FastMKSStat}}
\index{FastMKSStat@{FastMKSStat}!FastMKSStat@{FastMKSStat}}
\doxysubsubsection{FastMKSStat()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily \textbf{ Fast\+MKSStat} (\begin{DoxyParamCaption}\item[{const Tree\+Type \&}]{node }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}



Initialize this statistic for the given tree node. 

The Tree\+Type\textquotesingle{}s metric better be IPMetric with some kernel type (that is, Metric().Kernel() must exist).
...
\index{FastMKSStat@{FastMKSStat}!Bound@{Bound}}
\index{Bound@{Bound}!FastMKSStat@{FastMKSStat}}
...
\index{FastMKSStat@{FastMKSStat}!LastKernel@{LastKernel}}
\index{LastKernel@{LastKernel}!FastMKSStat@{FastMKSStat}}
\doxysubsubsection{LastKernel()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{FastMKSStat@{FastMKSStat}!LastKernel@{LastKernel}}
\index{LastKernel@{LastKernel}!FastMKSStat@{FastMKSStat}}
\doxysubsubsection{LastKernel()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{FastMKSStat@{FastMKSStat}!LastKernelNode@{LastKernelNode}}
\index{LastKernelNode@{LastKernelNode}!FastMKSStat@{FastMKSStat}}
\doxysubsubsection{LastKernelNode()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{FastMKSStat@{FastMKSStat}!LastKernelNode@{LastKernelNode}}
\index{LastKernelNode@{LastKernelNode}!FastMKSStat@{FastMKSStat}}
\doxysubsubsection{LastKernelNode()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{FastMKSStat@{FastMKSStat}!SelfKernel@{SelfKernel}}
\index{SelfKernel@{SelfKernel}!FastMKSStat@{FastMKSStat}}
\doxysubsubsection{SelfKernel()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{FastMKSStat@{FastMKSStat}!SelfKernel@{SelfKernel}}
\index{SelfKernel@{SelfKernel}!FastMKSStat@{FastMKSStat}}
\doxysubsubsection{SelfKernel()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{FastMKSStat@{FastMKSStat}!serialize@{serialize}}
\index{serialize@{serialize}!FastMKSStat@{FastMKSStat}}
