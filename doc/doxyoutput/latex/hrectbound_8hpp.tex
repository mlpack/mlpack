\doxysection{/home/aakash/mlpack/src/mlpack/core/tree/hrectbound.hpp File Reference}
...
\item 
struct \textbf{ Bound\+Traits$<$ HRect\+Bound$<$ Metric\+Type, Elem\+Type $>$ $>$}
\item 
class \textbf{ HRect\+Bound$<$ Metric\+Type, Elem\+Type $>$}
\begin{DoxyCompactList}\small\item\em Hyper-\/rectangle bound for an L-\/metric. \end{DoxyCompactList}\item 
struct \textbf{ Is\+LMetric$<$ Metric\+Type $>$}
...
This file describes the interface for the HRect\+Bound class, which implements a hyperrectangle bound.
