\doxysection{Oivs\+Initialization$<$ Activation\+Function $>$ Class Template Reference}
\label{classmlpack_1_1ann_1_1OivsInitialization}\index{OivsInitialization$<$ ActivationFunction $>$@{OivsInitialization$<$ ActivationFunction $>$}}
...
\begin{DoxyCompactList}\small\item\em Initialize the elements of the specified weight matrix with the oivs method. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\index{OivsInitialization$<$ ActivationFunction $>$@{OivsInitialization$<$ ActivationFunction $>$}!OivsInitialization@{OivsInitialization}}
\index{OivsInitialization@{OivsInitialization}!OivsInitialization$<$ ActivationFunction $>$@{OivsInitialization$<$ ActivationFunction $>$}}
\doxysubsubsection{OivsInitialization()}
...
\index{OivsInitialization$<$ ActivationFunction $>$@{OivsInitialization$<$ ActivationFunction $>$}!Initialize@{Initialize}}
\index{Initialize@{Initialize}!OivsInitialization$<$ ActivationFunction $>$@{OivsInitialization$<$ ActivationFunction $>$}}
