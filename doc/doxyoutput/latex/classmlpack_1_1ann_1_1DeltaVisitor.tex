\doxysection{Delta\+Visitor Class Reference}
\label{classmlpack_1_1ann_1_1DeltaVisitor}\index{DeltaVisitor@{DeltaVisitor}}
...
\begin{center}
\leavevmode
\includegraphics[width=160pt]{classmlpack_1_1ann_1_1DeltaVisitor__inherit__graph}
\end{center}
\end{figure}
...
\index{DeltaVisitor@{DeltaVisitor}!operator()@{operator()}}
\index{operator()@{operator()}!DeltaVisitor@{DeltaVisitor}}
