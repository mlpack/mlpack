\doxysection{Array\+Wrapper$<$ T $>$ Class Template Reference}
\label{classcereal_1_1ArrayWrapper}\index{ArrayWrapper$<$ T $>$@{ArrayWrapper$<$ T $>$}}
...
\index{ArrayWrapper$<$ T $>$@{ArrayWrapper$<$ T $>$}!ArrayWrapper@{ArrayWrapper}}
\index{ArrayWrapper@{ArrayWrapper}!ArrayWrapper$<$ T $>$@{ArrayWrapper$<$ T $>$}}
\doxysubsubsection{ArrayWrapper()}
...
\index{ArrayWrapper$<$ T $>$@{ArrayWrapper$<$ T $>$}!load@{load}}
\index{load@{load}!ArrayWrapper$<$ T $>$@{ArrayWrapper$<$ T $>$}}
...
\index{ArrayWrapper$<$ T $>$@{ArrayWrapper$<$ T $>$}!save@{save}}
\index{save@{save}!ArrayWrapper$<$ T $>$@{ArrayWrapper$<$ T $>$}}
