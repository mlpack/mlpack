\doxysection{Mish\+Function Class Reference}
\label{classmlpack_1_1ann_1_1MishFunction}\index{MishFunction@{MishFunction}}
...
\begin{eqnarray*} f(x) = x * tanh(ln(1+e^x)) f\textnormal{\textquotesingle}(x) = tanh(ln(1+e^x)) + x * ((1 - tanh^2(ln(1+e^x))) * frac{1}{1 + e^{-x}}) \end{eqnarray*} 
...
\index{MishFunction@{MishFunction}!Deriv@{Deriv}}
\index{Deriv@{Deriv}!MishFunction@{MishFunction}}
...
\index{MishFunction@{MishFunction}!Fn@{Fn}}
\index{Fn@{Fn}!MishFunction@{MishFunction}}
