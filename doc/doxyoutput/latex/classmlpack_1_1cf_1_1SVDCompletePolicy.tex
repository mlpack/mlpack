\doxysection{SVDComplete\+Policy Class Reference}
\label{classmlpack_1_1cf_1_1SVDCompletePolicy}\index{SVDCompletePolicy@{SVDCompletePolicy}}


Implementation of the SVD complete incremental policy to act as a wrapper when accessing SVD complete decomposition from within \doxyref{CFType}{p.}{classmlpack_1_1cf_1_1CFType}.  
...
\begin{DoxyCompactList}\small\item\em Apply Collaborative Filtering to the provided data set using the SVD complete incremental policy. \end{DoxyCompactList}\item 
...
An example of how to use \doxyref{SVDComplete\+Policy}{p.}{classmlpack_1_1cf_1_1SVDCompletePolicy} in CF is shown below\+:
...
\DoxyCodeLine{}
\DoxyCodeLine{CFType<SVDCompletePolicy> cf(data);}
\DoxyCodeLine{}
...
\index{SVDCompletePolicy@{SVDCompletePolicy}!Apply@{Apply}}
\index{Apply@{Apply}!SVDCompletePolicy@{SVDCompletePolicy}}
...
\index{SVDCompletePolicy@{SVDCompletePolicy}!GetNeighborhood@{GetNeighborhood}}
\index{GetNeighborhood@{GetNeighborhood}!SVDCompletePolicy@{SVDCompletePolicy}}
...
\index{SVDCompletePolicy@{SVDCompletePolicy}!GetRating@{GetRating}}
\index{GetRating@{GetRating}!SVDCompletePolicy@{SVDCompletePolicy}}
...
\index{SVDCompletePolicy@{SVDCompletePolicy}!GetRatingOfUser@{GetRatingOfUser}}
\index{GetRatingOfUser@{GetRatingOfUser}!SVDCompletePolicy@{SVDCompletePolicy}}
...
\index{SVDCompletePolicy@{SVDCompletePolicy}!H@{H}}
\index{H@{H}!SVDCompletePolicy@{SVDCompletePolicy}}
\doxysubsubsection{H()}
...
\index{SVDCompletePolicy@{SVDCompletePolicy}!serialize@{serialize}}
\index{serialize@{serialize}!SVDCompletePolicy@{SVDCompletePolicy}}
...
\index{SVDCompletePolicy@{SVDCompletePolicy}!W@{W}}
\index{W@{W}!SVDCompletePolicy@{SVDCompletePolicy}}
\doxysubsubsection{W()}
