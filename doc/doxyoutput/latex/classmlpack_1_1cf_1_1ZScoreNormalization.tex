\doxysection{ZScore\+Normalization Class Reference}
\label{classmlpack_1_1cf_1_1ZScoreNormalization}\index{ZScoreNormalization@{ZScoreNormalization}}
...
An example of how to use \doxyref{ZScore\+Normalization}{p.}{classmlpack_1_1cf_1_1ZScoreNormalization} in CF is shown below\+:
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Use ZScoreNormalization as normalization method.}}
\DoxyCodeLine{CFType<NMFPolicy, ZScoreNormalization> cf(data);}
\DoxyCodeLine{}
...
\index{ZScoreNormalization@{ZScoreNormalization}!ZScoreNormalization@{ZScoreNormalization}}
\index{ZScoreNormalization@{ZScoreNormalization}!ZScoreNormalization@{ZScoreNormalization}}
\doxysubsubsection{ZScoreNormalization()}
{\footnotesize\ttfamily \textbf{ ZScore\+Normalization} (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\index{ZScoreNormalization@{ZScoreNormalization}!Denormalize@{Denormalize}}
\index{Denormalize@{Denormalize}!ZScoreNormalization@{ZScoreNormalization}}
...
\index{ZScoreNormalization@{ZScoreNormalization}!Mean@{Mean}}
\index{Mean@{Mean}!ZScoreNormalization@{ZScoreNormalization}}
...
\index{ZScoreNormalization@{ZScoreNormalization}!Normalize@{Normalize}}
\index{Normalize@{Normalize}!ZScoreNormalization@{ZScoreNormalization}}
...
\index{ZScoreNormalization@{ZScoreNormalization}!serialize@{serialize}}
\index{serialize@{serialize}!ZScoreNormalization@{ZScoreNormalization}}
...
\index{ZScoreNormalization@{ZScoreNormalization}!Stddev@{Stddev}}
\index{Stddev@{Stddev}!ZScoreNormalization@{ZScoreNormalization}}
\doxysubsubsection{Stddev()}
