\doxysection{Sparse\+Coding Class Reference}
\label{classmlpack_1_1sparse__coding_1_1SparseCoding}\index{SparseCoding@{SparseCoding}}
...
\begin{DoxyCompactList}\small\item\em Sparse code each point in the given dataset via LARS, using the current dictionary and store the encoded data in the codes matrix. \end{DoxyCompactList}\item 
...
\begin{DoxyCode}{0}
\DoxyCodeLine{@incollection\{lee2007efficient,}
\DoxyCodeLine{  title = \{Efficient sparse coding algorithms\},}
\DoxyCodeLine{  author = \{Honglak Lee and Alexis Battle and Rajat Raina and Andrew Y. Ng\},}
\DoxyCodeLine{  booktitle = \{Advances in Neural Information Processing Systems 19\},}
\DoxyCodeLine{  editor = \{B. Sch\(\backslash\)\textcolor{stringliteral}{"{}\{o\}lkopf and J. Platt and T. Hoffman\},}}
\DoxyCodeLine{\textcolor{stringliteral}{  publisher = \{MIT Press\},}}
\DoxyCodeLine{\textcolor{stringliteral}{  address = \{Cambridge, MA\},}}
\DoxyCodeLine{\textcolor{stringliteral}{  pages = \{801-\/-\/808\},}}
...
Note that the implementation here does not use the feature-\/sign search algorithm from Honglak Lee\textquotesingle{}s paper, but instead the LARS algorithm suggested in that paper.
...
\index{SparseCoding@{SparseCoding}!SparseCoding@{SparseCoding}}
\index{SparseCoding@{SparseCoding}!SparseCoding@{SparseCoding}}
\doxysubsubsection{SparseCoding()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{SparseCoding@{SparseCoding}!SparseCoding@{SparseCoding}}
\index{SparseCoding@{SparseCoding}!SparseCoding@{SparseCoding}}
\doxysubsubsection{SparseCoding()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{SparseCoding@{SparseCoding}!Atoms@{Atoms}}
\index{Atoms@{Atoms}!SparseCoding@{SparseCoding}}
...
\index{SparseCoding@{SparseCoding}!Dictionary@{Dictionary}}
\index{Dictionary@{Dictionary}!SparseCoding@{SparseCoding}}
...
\index{SparseCoding@{SparseCoding}!Encode@{Encode}}
\index{Encode@{Encode}!SparseCoding@{SparseCoding}}
...
\index{SparseCoding@{SparseCoding}!Lambda1@{Lambda1}}
\index{Lambda1@{Lambda1}!SparseCoding@{SparseCoding}}
...
\index{SparseCoding@{SparseCoding}!Lambda2@{Lambda2}}
\index{Lambda2@{Lambda2}!SparseCoding@{SparseCoding}}
...
\index{SparseCoding@{SparseCoding}!MaxIterations@{MaxIterations}}
\index{MaxIterations@{MaxIterations}!SparseCoding@{SparseCoding}}
...
\index{SparseCoding@{SparseCoding}!NewtonTolerance@{NewtonTolerance}}
\index{NewtonTolerance@{NewtonTolerance}!SparseCoding@{SparseCoding}}
\doxysubsubsection{NewtonTolerance()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{SparseCoding@{SparseCoding}!NewtonTolerance@{NewtonTolerance}}
\index{NewtonTolerance@{NewtonTolerance}!SparseCoding@{SparseCoding}}
\doxysubsubsection{NewtonTolerance()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{SparseCoding@{SparseCoding}!Objective@{Objective}}
\index{Objective@{Objective}!SparseCoding@{SparseCoding}}
...
\index{SparseCoding@{SparseCoding}!ObjTolerance@{ObjTolerance}}
\index{ObjTolerance@{ObjTolerance}!SparseCoding@{SparseCoding}}
\doxysubsubsection{ObjTolerance()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{SparseCoding@{SparseCoding}!ObjTolerance@{ObjTolerance}}
\index{ObjTolerance@{ObjTolerance}!SparseCoding@{SparseCoding}}
\doxysubsubsection{ObjTolerance()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{SparseCoding@{SparseCoding}!OptimizeDictionary@{OptimizeDictionary}}
\index{OptimizeDictionary@{OptimizeDictionary}!SparseCoding@{SparseCoding}}
...
\index{SparseCoding@{SparseCoding}!ProjectDictionary@{ProjectDictionary}}
\index{ProjectDictionary@{ProjectDictionary}!SparseCoding@{SparseCoding}}
\doxysubsubsection{ProjectDictionary()}
...
\index{SparseCoding@{SparseCoding}!serialize@{serialize}}
\index{serialize@{serialize}!SparseCoding@{SparseCoding}}
...
\index{SparseCoding@{SparseCoding}!Train@{Train}}
\index{Train@{Train}!SparseCoding@{SparseCoding}}
