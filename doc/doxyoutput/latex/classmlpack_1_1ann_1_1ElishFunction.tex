\doxysection{Elish\+Function Class Reference}
\label{classmlpack_1_1ann_1_1ElishFunction}\index{ElishFunction@{ElishFunction}}


The ELi\+SH function, defined by.  
...
\begin{DoxyCompactList}\small\item\em Computes the first derivatives of ELi\+SH function. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Computes the first derivatives of the ELi\+SH function. \end{DoxyCompactList}\item 
static double \textbf{ Fn} (const double x)
\begin{DoxyCompactList}\small\item\em Computes the ELi\+SH function. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Computes the ELi\+SH function. \end{DoxyCompactList}\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
The ELi\+SH function, defined by. 

\begin{eqnarray*} f(x) &=& \begin{cases} x / (1 + e^{-x}) & x \geq 0\\ (e^{x} - 1) / (1 + e^{-x}) & x < 0.\\ \end{cases} \\ f\textnormal{\textquotesingle}(x) &=& \begin{cases} 1 / (1 + e^{-y}) + y * e^{-y} / (1 + e^{-y})^2 & x \geq 0\\ e^y - 2 / (1 + e^y) + 2 / (1 + e^y)^2 & x < 0.\\ \end{cases} \end{eqnarray*} 
...
\index{ElishFunction@{ElishFunction}!Deriv@{Deriv}}
\index{Deriv@{Deriv}!ElishFunction@{ElishFunction}}
...
Computes the first derivatives of ELi\+SH function. 
...
Computes the first derivatives of the ELi\+SH function. 
...
\index{ElishFunction@{ElishFunction}!Fn@{Fn}}
\index{Fn@{Fn}!ElishFunction@{ElishFunction}}
