\doxysection{Elliot\+Function Class Reference}
\label{classmlpack_1_1ann_1_1ElliotFunction}\index{ElliotFunction@{ElliotFunction}}
...
\begin{eqnarray*} f(x) &=& \frac{x}{1 + |x|} \\ f\textnormal{\textquotesingle}(x) &=& \frac{1}{(1 + |x|)^2} \end{eqnarray*} 
...
\index{ElliotFunction@{ElliotFunction}!Deriv@{Deriv}}
\index{Deriv@{Deriv}!ElliotFunction@{ElliotFunction}}
...
\index{ElliotFunction@{ElliotFunction}!Fn@{Fn}}
\index{Fn@{Fn}!ElliotFunction@{ElliotFunction}}
