\doxysection{KDEModel Class Reference}
\label{classmlpack_1_1kde_1_1KDEModel}\index{KDEModel@{KDEModel}}


The \doxyref{KDEModel}{p.}{classmlpack_1_1kde_1_1KDEModel} provides an abstraction for the \doxyref{KDE}{p.}{classmlpack_1_1kde_1_1KDE} class, abstracting away the Kernel\+Type and Tree\+Type parameters and allowing those to be specified at runtime.  
...
, \newline
\textbf{ LAPLACIAN\+\_\+\+KERNEL}
, \newline
\textbf{ SPHERICAL\+\_\+\+KERNEL}
, \newline
...
\begin{DoxyCompactItemize}
\item 
\textbf{ KDEModel} (const double bandwidth=1.\+0, const double rel\+Error=\textbf{ KDEDefault\+Params\+::rel\+Error}, const double abs\+Error=\textbf{ KDEDefault\+Params\+::abs\+Error}, const \textbf{ Kernel\+Types} kernel\+Type=Kernel\+Types\+::\+GAUSSIAN\+\_\+\+KERNEL, const \textbf{ Tree\+Types} tree\+Type=Tree\+Types\+::\+KD\+\_\+\+TREE, const bool monte\+Carlo=\textbf{ KDEDefault\+Params\+::mode}, const double mc\+Prob=\textbf{ KDEDefault\+Params\+::mc\+Prob}, const size\+\_\+t initial\+Sample\+Size=\textbf{ KDEDefault\+Params\+::initial\+Sample\+Size}, const double mc\+Entry\+Coef=\textbf{ KDEDefault\+Params\+::mc\+Entry\+Coef}, const double mc\+Break\+Coef=\textbf{ KDEDefault\+Params\+::mc\+Break\+Coef})
\begin{DoxyCompactList}\small\item\em Initialize \doxyref{KDEModel}{p.}{classmlpack_1_1kde_1_1KDEModel}. \end{DoxyCompactList}\item 
\textbf{ KDEModel} (const \textbf{ KDEModel} \&other)
\begin{DoxyCompactList}\small\item\em Copy constructor of the given model. \end{DoxyCompactList}\item 
\textbf{ KDEModel} (\textbf{ KDEModel} \&\&other)
...
\textbf{ $\sim$\+KDEModel} ()
\begin{DoxyCompactList}\small\item\em Destroy the \doxyref{KDEModel}{p.}{classmlpack_1_1kde_1_1KDEModel} object. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Build the \doxyref{KDE}{p.}{classmlpack_1_1kde_1_1KDE} model with the given parameters and then trains it with the given reference data. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Initialize the \doxyref{KDE}{p.}{classmlpack_1_1kde_1_1KDE} model. \end{DoxyCompactList}\item 
...
void \textbf{ MCProbability} (const double new\+MCProb)
...
\textbf{ KDEModel} \& \textbf{ operator=} (const \textbf{ KDEModel} \&other)
\begin{DoxyCompactList}\small\item\em Copy the given model. \end{DoxyCompactList}\item 
\textbf{ KDEModel} \& \textbf{ operator=} (\textbf{ KDEModel} \&\&other)
...
\begin{DoxyCompactList}\small\item\em Modify the tree type of the model. \end{DoxyCompactList}\item 
\textbf{ Tree\+Types} \textbf{ Tree\+Type} () const
\begin{DoxyCompactList}\small\item\em Get the tree type of the model. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\index{KDEModel@{KDEModel}!KernelTypes@{KernelTypes}}
\index{KernelTypes@{KernelTypes}!KDEModel@{KDEModel}}
\doxysubsubsection{KernelTypes}
{\footnotesize\ttfamily enum \textbf{ Kernel\+Types}}

\begin{DoxyEnumFields}{Enumerator}
\raisebox{\heightof{T}}[0pt][0pt]{\index{GAUSSIAN\_KERNEL@{GAUSSIAN\_KERNEL}!KDEModel@{KDEModel}}\index{KDEModel@{KDEModel}!GAUSSIAN\_KERNEL@{GAUSSIAN\_KERNEL}}}\mbox{\label{classmlpack_1_1kde_1_1KDEModel_a0d0c6dc6893ad3824d5d31d87e69fb61af52665cc69ef62c8ad00a49c8e259c13}} 
GAUSSIAN\+\_\+\+KERNEL&\\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{EPANECHNIKOV\_KERNEL@{EPANECHNIKOV\_KERNEL}!KDEModel@{KDEModel}}\index{KDEModel@{KDEModel}!EPANECHNIKOV\_KERNEL@{EPANECHNIKOV\_KERNEL}}}\mbox{\label{classmlpack_1_1kde_1_1KDEModel_a0d0c6dc6893ad3824d5d31d87e69fb61af0f03a73eb0dce407b0b027dc8f98cdc}} 
EPANECHNIKOV\+\_\+\+KERNEL&\\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{LAPLACIAN\_KERNEL@{LAPLACIAN\_KERNEL}!KDEModel@{KDEModel}}\index{KDEModel@{KDEModel}!LAPLACIAN\_KERNEL@{LAPLACIAN\_KERNEL}}}\mbox{\label{classmlpack_1_1kde_1_1KDEModel_a0d0c6dc6893ad3824d5d31d87e69fb61ac188c6a7e514f7ccf2fc1ac5160e30c6}} 
LAPLACIAN\+\_\+\+KERNEL&\\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{SPHERICAL\_KERNEL@{SPHERICAL\_KERNEL}!KDEModel@{KDEModel}}\index{KDEModel@{KDEModel}!SPHERICAL\_KERNEL@{SPHERICAL\_KERNEL}}}\mbox{\label{classmlpack_1_1kde_1_1KDEModel_a0d0c6dc6893ad3824d5d31d87e69fb61aa2896ec0bb1099c97a137e4ca80bdc9b}} 
SPHERICAL\+\_\+\+KERNEL&\\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{TRIANGULAR\_KERNEL@{TRIANGULAR\_KERNEL}!KDEModel@{KDEModel}}\index{KDEModel@{KDEModel}!TRIANGULAR\_KERNEL@{TRIANGULAR\_KERNEL}}}\mbox{\label{classmlpack_1_1kde_1_1KDEModel_a0d0c6dc6893ad3824d5d31d87e69fb61a54d012af1c18f0d33fc7b76ee3d164fe}} 
TRIANGULAR\+\_\+\+KERNEL&\\
\hline
...
\index{KDEModel@{KDEModel}!TreeTypes@{TreeTypes}}
\index{TreeTypes@{TreeTypes}!KDEModel@{KDEModel}}
\doxysubsubsection{TreeTypes}
{\footnotesize\ttfamily enum \textbf{ Tree\+Types}}

\begin{DoxyEnumFields}{Enumerator}
\raisebox{\heightof{T}}[0pt][0pt]{\index{KD\_TREE@{KD\_TREE}!KDEModel@{KDEModel}}\index{KDEModel@{KDEModel}!KD\_TREE@{KD\_TREE}}}\mbox{\label{classmlpack_1_1kde_1_1KDEModel_a6597b8539c6114170dc185d332ba4c8daa688e9cd1158916bc183aa517724568c}} 
KD\+\_\+\+TREE&\\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{BALL\_TREE@{BALL\_TREE}!KDEModel@{KDEModel}}\index{KDEModel@{KDEModel}!BALL\_TREE@{BALL\_TREE}}}\mbox{\label{classmlpack_1_1kde_1_1KDEModel_a6597b8539c6114170dc185d332ba4c8da994ef1bcca8841d5b7d1431b99fcb10d}} 
BALL\+\_\+\+TREE&\\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{COVER\_TREE@{COVER\_TREE}!KDEModel@{KDEModel}}\index{KDEModel@{KDEModel}!COVER\_TREE@{COVER\_TREE}}}\mbox{\label{classmlpack_1_1kde_1_1KDEModel_a6597b8539c6114170dc185d332ba4c8da92f172b47c8ae18ed401f8bf9f5ecad3}} 
COVER\+\_\+\+TREE&\\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{OCTREE@{OCTREE}!KDEModel@{KDEModel}}\index{KDEModel@{KDEModel}!OCTREE@{OCTREE}}}\mbox{\label{classmlpack_1_1kde_1_1KDEModel_a6597b8539c6114170dc185d332ba4c8daabefbb1ea7a801b1b00c9b0709dcec50}} 
OCTREE&\\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{R\_TREE@{R\_TREE}!KDEModel@{KDEModel}}\index{KDEModel@{KDEModel}!R\_TREE@{R\_TREE}}}\mbox{\label{classmlpack_1_1kde_1_1KDEModel_a6597b8539c6114170dc185d332ba4c8da2a93dc779a94d5f09b72ffbdc5ac9cd9}} 
R\+\_\+\+TREE&\\
\hline
...
\index{KDEModel@{KDEModel}!KDEModel@{KDEModel}}
\index{KDEModel@{KDEModel}!KDEModel@{KDEModel}}
\doxysubsubsection{KDEModel()\hspace{0.1cm}{\footnotesize\ttfamily [1/3]}}
{\footnotesize\ttfamily \textbf{ KDEModel} (\begin{DoxyParamCaption}\item[{const double}]{bandwidth = {\ttfamily 1.0},  }\item[{const double}]{rel\+Error = {\ttfamily \textbf{ KDEDefault\+Params\+::rel\+Error}},  }\item[{const double}]{abs\+Error = {\ttfamily \textbf{ KDEDefault\+Params\+::abs\+Error}},  }\item[{const \textbf{ Kernel\+Types}}]{kernel\+Type = {\ttfamily KernelTypes\+:\+:GAUSSIAN\+\_\+KERNEL},  }\item[{const \textbf{ Tree\+Types}}]{tree\+Type = {\ttfamily TreeTypes\+:\+:KD\+\_\+TREE},  }\item[{const bool}]{monte\+Carlo = {\ttfamily \textbf{ KDEDefault\+Params\+::mode}},  }\item[{const double}]{mc\+Prob = {\ttfamily \textbf{ KDEDefault\+Params\+::mc\+Prob}},  }\item[{const size\+\_\+t}]{initial\+Sample\+Size = {\ttfamily \textbf{ KDEDefault\+Params\+::initial\+Sample\+Size}},  }\item[{const double}]{mc\+Entry\+Coef = {\ttfamily \textbf{ KDEDefault\+Params\+::mc\+Entry\+Coef}},  }\item[{const double}]{mc\+Break\+Coef = {\ttfamily \textbf{ KDEDefault\+Params\+::mc\+Break\+Coef}} }\end{DoxyParamCaption})}



Initialize \doxyref{KDEModel}{p.}{classmlpack_1_1kde_1_1KDEModel}. 


\begin{DoxyParams}{Parameters}
{\em bandwidth} & Bandwidth to use for the kernel. \\
\hline
{\em rel\+Error} & Maximum relative error tolerance for each point in the model. For example, 0.\+05 means that each value must be within 5\% of the true \doxyref{KDE}{p.}{classmlpack_1_1kde_1_1KDE} value. \\
\hline
...
\index{KDEModel@{KDEModel}!KDEModel@{KDEModel}}
\index{KDEModel@{KDEModel}!KDEModel@{KDEModel}}
\doxysubsubsection{KDEModel()\hspace{0.1cm}{\footnotesize\ttfamily [2/3]}}
{\footnotesize\ttfamily \textbf{ KDEModel} (\begin{DoxyParamCaption}\item[{const \textbf{ KDEModel} \&}]{other }\end{DoxyParamCaption})}
...
\index{KDEModel@{KDEModel}!KDEModel@{KDEModel}}
\index{KDEModel@{KDEModel}!KDEModel@{KDEModel}}
\doxysubsubsection{KDEModel()\hspace{0.1cm}{\footnotesize\ttfamily [3/3]}}
{\footnotesize\ttfamily \textbf{ KDEModel} (\begin{DoxyParamCaption}\item[{\textbf{ KDEModel} \&\&}]{other }\end{DoxyParamCaption})}
...
\index{KDEModel@{KDEModel}!````~KDEModel@{$\sim$KDEModel}}
\index{````~KDEModel@{$\sim$KDEModel}!KDEModel@{KDEModel}}
\doxysubsubsection{$\sim$KDEModel()}
{\footnotesize\ttfamily $\sim$\textbf{ KDEModel} (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}



Destroy the \doxyref{KDEModel}{p.}{classmlpack_1_1kde_1_1KDEModel} object. 



\doxysubsection{Member Function Documentation}
\mbox{\label{classmlpack_1_1kde_1_1KDEModel_aca74512f13027b15d913461e55df3da2}} 
\index{KDEModel@{KDEModel}!AbsoluteError@{AbsoluteError}}
\index{AbsoluteError@{AbsoluteError}!KDEModel@{KDEModel}}
...
\index{KDEModel@{KDEModel}!Bandwidth@{Bandwidth}}
\index{Bandwidth@{Bandwidth}!KDEModel@{KDEModel}}
...
\index{KDEModel@{KDEModel}!BuildModel@{BuildModel}}
\index{BuildModel@{BuildModel}!KDEModel@{KDEModel}}
...
Build the \doxyref{KDE}{p.}{classmlpack_1_1kde_1_1KDE} model with the given parameters and then trains it with the given reference data. 
...
\index{KDEModel@{KDEModel}!Evaluate@{Evaluate}}
\index{Evaluate@{Evaluate}!KDEModel@{KDEModel}}
...
\index{KDEModel@{KDEModel}!InitializeModel@{InitializeModel}}
\index{InitializeModel@{InitializeModel}!KDEModel@{KDEModel}}
\doxysubsubsection{InitializeModel()}
{\footnotesize\ttfamily void Initialize\+Model (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}



Initialize the \doxyref{KDE}{p.}{classmlpack_1_1kde_1_1KDE} model. 

\mbox{\label{classmlpack_1_1kde_1_1KDEModel_ad94d196c8fc2a42899de31332737dbf9}} 
\index{KDEModel@{KDEModel}!KernelType@{KernelType}}
\index{KernelType@{KernelType}!KDEModel@{KDEModel}}
...
\index{KDEModel@{KDEModel}!MCBreakCoefficient@{MCBreakCoefficient}}
\index{MCBreakCoefficient@{MCBreakCoefficient}!KDEModel@{KDEModel}}
\doxysubsubsection{MCBreakCoefficient()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily double MCBreak\+Coefficient (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
\index{KDEModel@{KDEModel}!MCBreakCoefficient@{MCBreakCoefficient}}
\index{MCBreakCoefficient@{MCBreakCoefficient}!KDEModel@{KDEModel}}
\doxysubsubsection{MCBreakCoefficient()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily void MCBreak\+Coefficient (\begin{DoxyParamCaption}\item[{const double}]{new\+Break\+Coef }\end{DoxyParamCaption})}
...
\index{KDEModel@{KDEModel}!MCEntryCoefficient@{MCEntryCoefficient}}
\index{MCEntryCoefficient@{MCEntryCoefficient}!KDEModel@{KDEModel}}
\doxysubsubsection{MCEntryCoefficient()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily double MCEntry\+Coefficient (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
\index{KDEModel@{KDEModel}!MCEntryCoefficient@{MCEntryCoefficient}}
\index{MCEntryCoefficient@{MCEntryCoefficient}!KDEModel@{KDEModel}}
\doxysubsubsection{MCEntryCoefficient()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily void MCEntry\+Coefficient (\begin{DoxyParamCaption}\item[{const double}]{new\+Entry\+Coef }\end{DoxyParamCaption})}
...
\index{KDEModel@{KDEModel}!MCInitialSampleSize@{MCInitialSampleSize}}
\index{MCInitialSampleSize@{MCInitialSampleSize}!KDEModel@{KDEModel}}
...
{\footnotesize\ttfamily void MCInitial\+Sample\+Size (\begin{DoxyParamCaption}\item[{const size\+\_\+t}]{new\+Sample\+Size }\end{DoxyParamCaption})}
...
\index{KDEModel@{KDEModel}!MCProbability@{MCProbability}}
\index{MCProbability@{MCProbability}!KDEModel@{KDEModel}}
\doxysubsubsection{MCProbability()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily double MCProbability (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
\index{KDEModel@{KDEModel}!MCProbability@{MCProbability}}
\index{MCProbability@{MCProbability}!KDEModel@{KDEModel}}
\doxysubsubsection{MCProbability()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily void MCProbability (\begin{DoxyParamCaption}\item[{const double}]{new\+MCProb }\end{DoxyParamCaption})}
...
\index{KDEModel@{KDEModel}!Mode@{Mode}}
\index{Mode@{Mode}!KDEModel@{KDEModel}}
...
References KDEWrapper\+Base\+::\+Mode().
...
\index{KDEModel@{KDEModel}!MonteCarlo@{MonteCarlo}}
\index{MonteCarlo@{MonteCarlo}!KDEModel@{KDEModel}}
...
\index{KDEModel@{KDEModel}!operator=@{operator=}}
\index{operator=@{operator=}!KDEModel@{KDEModel}}
\doxysubsubsection{operator=()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily \textbf{ KDEModel}\& operator= (\begin{DoxyParamCaption}\item[{const \textbf{ KDEModel} \&}]{other }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em other} & \doxyref{KDEModel}{p.}{classmlpack_1_1kde_1_1KDEModel} to copy. \\
\hline
\end{DoxyParams}
...
{\footnotesize\ttfamily \textbf{ KDEModel}\& operator= (\begin{DoxyParamCaption}\item[{\textbf{ KDEModel} \&\&}]{other }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em other} & \doxyref{KDEModel}{p.}{classmlpack_1_1kde_1_1KDEModel} to take ownership of. \\
\hline
\end{DoxyParams}
\mbox{\label{classmlpack_1_1kde_1_1KDEModel_a2cd3d49a6dcafe980d0734421d296828}} 
\index{KDEModel@{KDEModel}!RelativeError@{RelativeError}}
\index{RelativeError@{RelativeError}!KDEModel@{KDEModel}}
...
\index{KDEModel@{KDEModel}!serialize@{serialize}}
\index{serialize@{serialize}!KDEModel@{KDEModel}}
...
\index{KDEModel@{KDEModel}!TreeType@{TreeType}}
\index{TreeType@{TreeType}!KDEModel@{KDEModel}}
