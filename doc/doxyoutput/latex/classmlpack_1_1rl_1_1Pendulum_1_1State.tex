\doxysection{Pendulum\+::State Class Reference}
...
double \& \textbf{ Theta} ()
\begin{DoxyCompactList}\small\item\em Modify the value of theta. \end{DoxyCompactList}\item 
...
\index{Pendulum::State@{Pendulum::State}!State@{State}}
\index{State@{State}!Pendulum::State@{Pendulum::State}}
...
\index{Pendulum::State@{Pendulum::State}!AngularVelocity@{AngularVelocity}}
\index{AngularVelocity@{AngularVelocity}!Pendulum::State@{Pendulum::State}}
...
\index{Pendulum::State@{Pendulum::State}!Data@{Data}}
\index{Data@{Data}!Pendulum::State@{Pendulum::State}}
...
\index{Pendulum::State@{Pendulum::State}!Encode@{Encode}}
\index{Encode@{Encode}!Pendulum::State@{Pendulum::State}}
...
\index{Pendulum::State@{Pendulum::State}!SetState@{SetState}}
\index{SetState@{SetState}!Pendulum::State@{Pendulum::State}}
...
\index{Pendulum::State@{Pendulum::State}!Theta@{Theta}}
\index{Theta@{Theta}!Pendulum::State@{Pendulum::State}}
\doxysubsubsection{Theta()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{Pendulum::State@{Pendulum::State}!Theta@{Theta}}
\index{Theta@{Theta}!Pendulum::State@{Pendulum::State}}
\doxysubsubsection{Theta()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{Pendulum::State@{Pendulum::State}!dimension@{dimension}}
\index{dimension@{dimension}!Pendulum::State@{Pendulum::State}}
\doxysubsubsection{dimension}
{\footnotesize\ttfamily constexpr size\+\_\+t dimension = 3\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [constexpr]}}
