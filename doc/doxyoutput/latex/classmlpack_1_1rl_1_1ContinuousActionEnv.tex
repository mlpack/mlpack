\doxysection{Continuous\+Action\+Env Class Reference}
\label{classmlpack_1_1rl_1_1ContinuousActionEnv}\index{ContinuousActionEnv@{ContinuousActionEnv}}
...
Eg\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{ContinuousActionEnv::State::dimension = 3;}
\DoxyCodeLine{ContinuousActionEnv::Action::size = 1;}
...
\index{ContinuousActionEnv@{ContinuousActionEnv}!InitialSample@{InitialSample}}
\index{InitialSample@{InitialSample}!ContinuousActionEnv@{ContinuousActionEnv}}
...
\index{ContinuousActionEnv@{ContinuousActionEnv}!IsTerminal@{IsTerminal}}
\index{IsTerminal@{IsTerminal}!ContinuousActionEnv@{ContinuousActionEnv}}
...
\index{ContinuousActionEnv@{ContinuousActionEnv}!Sample@{Sample}}
\index{Sample@{Sample}!ContinuousActionEnv@{ContinuousActionEnv}}
