\doxysection{Swish\+Function Class Reference}
\label{classmlpack_1_1ann_1_1SwishFunction}\index{SwishFunction@{SwishFunction}}
...
\begin{eqnarray*} f(x) &=& x \cdot \sigma(x) \\ f\textnormal{\textquotesingle}(x) &=& f(x) + \sigma(x) (1 - f(x)) \\ \sigma(x) &=& frac{1}{1 + e^{-x}} \end{eqnarray*} 
...
\index{SwishFunction@{SwishFunction}!Deriv@{Deriv}}
\index{Deriv@{Deriv}!SwishFunction@{SwishFunction}}
...
\index{SwishFunction@{SwishFunction}!Fn@{Fn}}
\index{Fn@{Fn}!SwishFunction@{SwishFunction}}
