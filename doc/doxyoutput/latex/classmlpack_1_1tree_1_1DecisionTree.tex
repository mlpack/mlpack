\doxysection{Decision\+Tree$<$ Fitness\+Function, Numeric\+Split\+Type, Categorical\+Split\+Type, Dimension\+Selection\+Type, No\+Recursion $>$ Class Template Reference}
\label{classmlpack_1_1tree_1_1DecisionTree}\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
...
\begin{center}
\leavevmode
\includegraphics[width=288pt]{classmlpack_1_1tree_1_1DecisionTree__inherit__graph}
\end{center}
\end{figure}
...
{\footnotesize template$<$typename Mat\+Type , typename Labels\+Type , typename Weights\+Type $>$ }\\\textbf{ Decision\+Tree} (const \textbf{ Decision\+Tree} \&other, Mat\+Type data, const \textbf{ data\+::\+Dataset\+Info} \&dataset\+Info, Labels\+Type labels, const size\+\_\+t num\+Classes, Weights\+Type weights, const size\+\_\+t minimum\+Leaf\+Size=10, const double minimum\+Gain\+Split=1e-\/7, const \textbf{ std\+::enable\+\_\+if\+\_\+t}$<$ arma\+::is\+\_\+arma\+\_\+type$<$ typename std\+::remove\+\_\+reference$<$ Weights\+Type $>$\+::type $>$\+::value $>$ $\ast$=0)
...
{\footnotesize template$<$typename Mat\+Type , typename Labels\+Type , typename Weights\+Type $>$ }\\\textbf{ Decision\+Tree} (const \textbf{ Decision\+Tree} \&other, Mat\+Type data, Labels\+Type labels, const size\+\_\+t num\+Classes, Weights\+Type weights, const size\+\_\+t minimum\+Leaf\+Size=10, const double minimum\+Gain\+Split=1e-\/7, const size\+\_\+t maximum\+Depth=0, Dimension\+Selection\+Type dimension\+Selector=Dimension\+Selection\+Type(), const \textbf{ std\+::enable\+\_\+if\+\_\+t}$<$ arma\+::is\+\_\+arma\+\_\+type$<$ typename std\+::remove\+\_\+reference$<$ Weights\+Type $>$\+::type $>$\+::value $>$ $\ast$=0)
...
{\footnotesize template$<$typename Mat\+Type , typename Labels\+Type , typename Weights\+Type $>$ }\\\textbf{ Decision\+Tree} (Mat\+Type data, const \textbf{ data\+::\+Dataset\+Info} \&dataset\+Info, Labels\+Type labels, const size\+\_\+t num\+Classes, Weights\+Type weights, const size\+\_\+t minimum\+Leaf\+Size=10, const double minimum\+Gain\+Split=1e-\/7, const size\+\_\+t maximum\+Depth=0, Dimension\+Selection\+Type dimension\+Selector=Dimension\+Selection\+Type(), const \textbf{ std\+::enable\+\_\+if\+\_\+t}$<$ arma\+::is\+\_\+arma\+\_\+type$<$ typename std\+::remove\+\_\+reference$<$ Weights\+Type $>$\+::type $>$\+::value $>$ $\ast$=0)
...
{\footnotesize template$<$typename Mat\+Type , typename Labels\+Type , typename Weights\+Type $>$ }\\\textbf{ Decision\+Tree} (Mat\+Type data, Labels\+Type labels, const size\+\_\+t num\+Classes, Weights\+Type weights, const size\+\_\+t minimum\+Leaf\+Size=10, const double minimum\+Gain\+Split=1e-\/7, const size\+\_\+t maximum\+Depth=0, Dimension\+Selection\+Type dimension\+Selector=Dimension\+Selection\+Type(), const \textbf{ std\+::enable\+\_\+if\+\_\+t}$<$ arma\+::is\+\_\+arma\+\_\+type$<$ typename std\+::remove\+\_\+reference$<$ Weights\+Type $>$\+::type $>$\+::value $>$ $\ast$=0)
...
{\footnotesize template$<$typename Mat\+Type , typename Labels\+Type , typename Weights\+Type $>$ }\\double \textbf{ Train} (Mat\+Type data, const \textbf{ data\+::\+Dataset\+Info} \&dataset\+Info, Labels\+Type labels, const size\+\_\+t num\+Classes, Weights\+Type weights, const size\+\_\+t minimum\+Leaf\+Size=10, const double minimum\+Gain\+Split=1e-\/7, const size\+\_\+t maximum\+Depth=0, Dimension\+Selection\+Type dimension\+Selector=Dimension\+Selection\+Type(), const \textbf{ std\+::enable\+\_\+if\+\_\+t}$<$ arma\+::is\+\_\+arma\+\_\+type$<$ typename std\+::remove\+\_\+reference$<$ Weights\+Type $>$\+::type $>$\+::value $>$ $\ast$=0)
...
{\footnotesize template$<$typename Mat\+Type , typename Labels\+Type , typename Weights\+Type $>$ }\\double \textbf{ Train} (Mat\+Type data, Labels\+Type labels, const size\+\_\+t num\+Classes, Weights\+Type weights, const size\+\_\+t minimum\+Leaf\+Size=10, const double minimum\+Gain\+Split=1e-\/7, const size\+\_\+t maximum\+Depth=0, Dimension\+Selection\+Type dimension\+Selector=Dimension\+Selection\+Type(), const \textbf{ std\+::enable\+\_\+if\+\_\+t}$<$ arma\+::is\+\_\+arma\+\_\+type$<$ typename std\+::remove\+\_\+reference$<$ Weights\+Type $>$\+::type $>$\+::value $>$ $\ast$=0)
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!CategoricalSplit@{CategoricalSplit}}
\index{CategoricalSplit@{CategoricalSplit}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
\doxysubsubsection{CategoricalSplit}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!DimensionSelection@{DimensionSelection}}
\index{DimensionSelection@{DimensionSelection}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
\doxysubsubsection{DimensionSelection}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!NumericSplit@{NumericSplit}}
\index{NumericSplit@{NumericSplit}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
\doxysubsubsection{NumericSplit}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!DecisionTree@{DecisionTree}}
\index{DecisionTree@{DecisionTree}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
\doxysubsubsection{DecisionTree()\hspace{0.1cm}{\footnotesize\ttfamily [1/9]}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!DecisionTree@{DecisionTree}}
\index{DecisionTree@{DecisionTree}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
\doxysubsubsection{DecisionTree()\hspace{0.1cm}{\footnotesize\ttfamily [2/9]}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!DecisionTree@{DecisionTree}}
\index{DecisionTree@{DecisionTree}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
\doxysubsubsection{DecisionTree()\hspace{0.1cm}{\footnotesize\ttfamily [3/9]}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!DecisionTree@{DecisionTree}}
\index{DecisionTree@{DecisionTree}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
\doxysubsubsection{DecisionTree()\hspace{0.1cm}{\footnotesize\ttfamily [4/9]}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!DecisionTree@{DecisionTree}}
\index{DecisionTree@{DecisionTree}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
\doxysubsubsection{DecisionTree()\hspace{0.1cm}{\footnotesize\ttfamily [5/9]}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!DecisionTree@{DecisionTree}}
\index{DecisionTree@{DecisionTree}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
\doxysubsubsection{DecisionTree()\hspace{0.1cm}{\footnotesize\ttfamily [6/9]}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!DecisionTree@{DecisionTree}}
\index{DecisionTree@{DecisionTree}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
\doxysubsubsection{DecisionTree()\hspace{0.1cm}{\footnotesize\ttfamily [7/9]}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!DecisionTree@{DecisionTree}}
\index{DecisionTree@{DecisionTree}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
\doxysubsubsection{DecisionTree()\hspace{0.1cm}{\footnotesize\ttfamily [8/9]}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!DecisionTree@{DecisionTree}}
\index{DecisionTree@{DecisionTree}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
\doxysubsubsection{DecisionTree()\hspace{0.1cm}{\footnotesize\ttfamily [9/9]}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!````~DecisionTree@{$\sim$DecisionTree}}
\index{````~DecisionTree@{$\sim$DecisionTree}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
\doxysubsubsection{$\sim$DecisionTree()}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!CalculateDirection@{CalculateDirection}}
\index{CalculateDirection@{CalculateDirection}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!Child@{Child}}
\index{Child@{Child}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!Classify@{Classify}}
\index{Classify@{Classify}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!NumChildren@{NumChildren}}
\index{NumChildren@{NumChildren}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!NumClasses@{NumClasses}}
\index{NumClasses@{NumClasses}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!operator=@{operator=}}
\index{operator=@{operator=}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!serialize@{serialize}}
\index{serialize@{serialize}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!SplitDimension@{SplitDimension}}
\index{SplitDimension@{SplitDimension}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
...
\index{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}!Train@{Train}}
\index{Train@{Train}!DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$@{DecisionTree$<$ FitnessFunction, NumericSplitType, CategoricalSplitType, DimensionSelectionType, NoRecursion $>$}}
