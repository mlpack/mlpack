\doxysection{Max\+Iteration\+Termination Class Reference}
\label{classmlpack_1_1amf_1_1MaxIterationTermination}\index{MaxIterationTermination@{MaxIterationTermination}}
...
\begin{DoxyCompactList}\small\item\em Get the maximum number of iterations. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\index{MaxIterationTermination@{MaxIterationTermination}!MaxIterationTermination@{MaxIterationTermination}}
\index{MaxIterationTermination@{MaxIterationTermination}!MaxIterationTermination@{MaxIterationTermination}}
\doxysubsubsection{MaxIterationTermination()}
...
\index{MaxIterationTermination@{MaxIterationTermination}!Index@{Index}}
\index{Index@{Index}!MaxIterationTermination@{MaxIterationTermination}}
...
\index{MaxIterationTermination@{MaxIterationTermination}!Initialize@{Initialize}}
\index{Initialize@{Initialize}!MaxIterationTermination@{MaxIterationTermination}}
...
\index{MaxIterationTermination@{MaxIterationTermination}!IsConverged@{IsConverged}}
\index{IsConverged@{IsConverged}!MaxIterationTermination@{MaxIterationTermination}}
...
\index{MaxIterationTermination@{MaxIterationTermination}!Iteration@{Iteration}}
\index{Iteration@{Iteration}!MaxIterationTermination@{MaxIterationTermination}}
\doxysubsubsection{Iteration()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{MaxIterationTermination@{MaxIterationTermination}!Iteration@{Iteration}}
\index{Iteration@{Iteration}!MaxIterationTermination@{MaxIterationTermination}}
\doxysubsubsection{Iteration()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{MaxIterationTermination@{MaxIterationTermination}!MaxIterations@{MaxIterations}}
\index{MaxIterations@{MaxIterations}!MaxIterationTermination@{MaxIterationTermination}}
