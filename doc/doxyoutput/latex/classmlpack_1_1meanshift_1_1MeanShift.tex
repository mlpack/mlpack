\doxysection{Mean\+Shift$<$ Use\+Kernel, Kernel\+Type, Mat\+Type $>$ Class Template Reference}
\label{classmlpack_1_1meanshift_1_1MeanShift}\index{MeanShift$<$ UseKernel, KernelType, MatType $>$@{MeanShift$<$ UseKernel, KernelType, MatType $>$}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{extern} arma::mat data; \textcolor{comment}{// Dataset we want to run mean shift on.}}
...
\DoxyCodeLine{\textcolor{keywordtype}{bool} forceConvergence = \textcolor{keyword}{true}; \textcolor{comment}{// Flag whether to force each centroid seed}}
\DoxyCodeLine{to converge regardless of maxIterations.}
\DoxyCodeLine{}
\DoxyCodeLine{MeanShift<> meanShift();}
\DoxyCodeLine{meanShift.Cluster(dataset, assignments, centroids, forceConvergence);}
...
\index{MeanShift$<$ UseKernel, KernelType, MatType $>$@{MeanShift$<$ UseKernel, KernelType, MatType $>$}!MeanShift@{MeanShift}}
\index{MeanShift@{MeanShift}!MeanShift$<$ UseKernel, KernelType, MatType $>$@{MeanShift$<$ UseKernel, KernelType, MatType $>$}}
\doxysubsubsection{MeanShift()}
...
\index{MeanShift$<$ UseKernel, KernelType, MatType $>$@{MeanShift$<$ UseKernel, KernelType, MatType $>$}!Cluster@{Cluster}}
\index{Cluster@{Cluster}!MeanShift$<$ UseKernel, KernelType, MatType $>$@{MeanShift$<$ UseKernel, KernelType, MatType $>$}}
...
\index{MeanShift$<$ UseKernel, KernelType, MatType $>$@{MeanShift$<$ UseKernel, KernelType, MatType $>$}!EstimateRadius@{EstimateRadius}}
\index{EstimateRadius@{EstimateRadius}!MeanShift$<$ UseKernel, KernelType, MatType $>$@{MeanShift$<$ UseKernel, KernelType, MatType $>$}}
\doxysubsubsection{EstimateRadius()}
...
\index{MeanShift$<$ UseKernel, KernelType, MatType $>$@{MeanShift$<$ UseKernel, KernelType, MatType $>$}!Kernel@{Kernel}}
\index{Kernel@{Kernel}!MeanShift$<$ UseKernel, KernelType, MatType $>$@{MeanShift$<$ UseKernel, KernelType, MatType $>$}}
...
\index{MeanShift$<$ UseKernel, KernelType, MatType $>$@{MeanShift$<$ UseKernel, KernelType, MatType $>$}!MaxIterations@{MaxIterations}}
\index{MaxIterations@{MaxIterations}!MeanShift$<$ UseKernel, KernelType, MatType $>$@{MeanShift$<$ UseKernel, KernelType, MatType $>$}}
...
\index{MeanShift$<$ UseKernel, KernelType, MatType $>$@{MeanShift$<$ UseKernel, KernelType, MatType $>$}!Radius@{Radius}}
\index{Radius@{Radius}!MeanShift$<$ UseKernel, KernelType, MatType $>$@{MeanShift$<$ UseKernel, KernelType, MatType $>$}}
