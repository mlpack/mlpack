\doxysection{Identity\+Function Class Reference}
\label{classmlpack_1_1ann_1_1IdentityFunction}\index{IdentityFunction@{IdentityFunction}}
...
\begin{eqnarray*} f(x) &=& x \\ f\textnormal{\textquotesingle}(x) &=& 1 \end{eqnarray*} 
...
\index{IdentityFunction@{IdentityFunction}!Deriv@{Deriv}}
\index{Deriv@{Deriv}!IdentityFunction@{IdentityFunction}}
\doxysubsubsection{Deriv()\hspace{0.1cm}{\footnotesize\ttfamily [1/3]}}
...
\index{IdentityFunction@{IdentityFunction}!Deriv@{Deriv}}
\index{Deriv@{Deriv}!IdentityFunction@{IdentityFunction}}
\doxysubsubsection{Deriv()\hspace{0.1cm}{\footnotesize\ttfamily [2/3]}}
...
\index{IdentityFunction@{IdentityFunction}!Deriv@{Deriv}}
\index{Deriv@{Deriv}!IdentityFunction@{IdentityFunction}}
\doxysubsubsection{Deriv()\hspace{0.1cm}{\footnotesize\ttfamily [3/3]}}
...
\index{IdentityFunction@{IdentityFunction}!Fn@{Fn}}
\index{Fn@{Fn}!IdentityFunction@{IdentityFunction}}
