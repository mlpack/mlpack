\doxysection{Output\+Height\+Visitor Class Reference}
\label{classmlpack_1_1ann_1_1OutputHeightVisitor}\index{OutputHeightVisitor@{OutputHeightVisitor}}
...
\begin{center}
\leavevmode
\includegraphics[width=175pt]{classmlpack_1_1ann_1_1OutputHeightVisitor__inherit__graph}
\end{center}
\end{figure}
...
\index{OutputHeightVisitor@{OutputHeightVisitor}!operator()@{operator()}}
\index{operator()@{operator()}!OutputHeightVisitor@{OutputHeightVisitor}}
