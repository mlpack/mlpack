\doxysection{Triplet\+Margin\+Loss$<$ Input\+Data\+Type, Output\+Data\+Type $>$ Class Template Reference}
\label{classmlpack_1_1ann_1_1TripletMarginLoss}\index{TripletMarginLoss$<$ InputDataType, OutputDataType $>$@{TripletMarginLoss$<$ InputDataType, OutputDataType $>$}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{@article\{Schroff2015,}
\DoxyCodeLine{  author  = \{Florian Schroff, Dmitry Kalenichenko, James Philbin\},}
\DoxyCodeLine{  title   = \{FaceNet: A Unified Embedding \textcolor{keywordflow}{for} Face Recognition and Clustering\},}
\DoxyCodeLine{  year    = \{2015\},}
\DoxyCodeLine{  url     = \{https:\textcolor{comment}{//arxiv.org/abs/1503.03832\},}}
\DoxyCodeLine{\}}
...
\index{TripletMarginLoss$<$ InputDataType, OutputDataType $>$@{TripletMarginLoss$<$ InputDataType, OutputDataType $>$}!TripletMarginLoss@{TripletMarginLoss}}
\index{TripletMarginLoss@{TripletMarginLoss}!TripletMarginLoss$<$ InputDataType, OutputDataType $>$@{TripletMarginLoss$<$ InputDataType, OutputDataType $>$}}
\doxysubsubsection{TripletMarginLoss()}
...
\index{TripletMarginLoss$<$ InputDataType, OutputDataType $>$@{TripletMarginLoss$<$ InputDataType, OutputDataType $>$}!Backward@{Backward}}
\index{Backward@{Backward}!TripletMarginLoss$<$ InputDataType, OutputDataType $>$@{TripletMarginLoss$<$ InputDataType, OutputDataType $>$}}
...
\index{TripletMarginLoss$<$ InputDataType, OutputDataType $>$@{TripletMarginLoss$<$ InputDataType, OutputDataType $>$}!Forward@{Forward}}
\index{Forward@{Forward}!TripletMarginLoss$<$ InputDataType, OutputDataType $>$@{TripletMarginLoss$<$ InputDataType, OutputDataType $>$}}
...
\index{TripletMarginLoss$<$ InputDataType, OutputDataType $>$@{TripletMarginLoss$<$ InputDataType, OutputDataType $>$}!Margin@{Margin}}
\index{Margin@{Margin}!TripletMarginLoss$<$ InputDataType, OutputDataType $>$@{TripletMarginLoss$<$ InputDataType, OutputDataType $>$}}
...
\index{TripletMarginLoss$<$ InputDataType, OutputDataType $>$@{TripletMarginLoss$<$ InputDataType, OutputDataType $>$}!OutputParameter@{OutputParameter}}
\index{OutputParameter@{OutputParameter}!TripletMarginLoss$<$ InputDataType, OutputDataType $>$@{TripletMarginLoss$<$ InputDataType, OutputDataType $>$}}
...
\index{TripletMarginLoss$<$ InputDataType, OutputDataType $>$@{TripletMarginLoss$<$ InputDataType, OutputDataType $>$}!serialize@{serialize}}
\index{serialize@{serialize}!TripletMarginLoss$<$ InputDataType, OutputDataType $>$@{TripletMarginLoss$<$ InputDataType, OutputDataType $>$}}
