\doxysection{Output\+Parameter\+Visitor Class Reference}
\label{classmlpack_1_1ann_1_1OutputParameterVisitor}\index{OutputParameterVisitor@{OutputParameterVisitor}}
...
\begin{center}
\leavevmode
\includegraphics[width=176pt]{classmlpack_1_1ann_1_1OutputParameterVisitor__inherit__graph}
\end{center}
\end{figure}
...
\index{OutputParameterVisitor@{OutputParameterVisitor}!operator()@{operator()}}
\index{operator()@{operator()}!OutputParameterVisitor@{OutputParameterVisitor}}
