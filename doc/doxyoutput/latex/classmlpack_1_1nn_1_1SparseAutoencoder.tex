\doxysection{Sparse\+Autoencoder Class Reference}
\label{classmlpack_1_1nn_1_1SparseAutoencoder}\index{SparseAutoencoder@{SparseAutoencoder}}
...
{\footnotesize template$<$typename Optimizer\+Type  = ens\+::\+L\+\_\+\+BFGS$>$ }\\\textbf{ Sparse\+Autoencoder} (const arma\+::mat \&data, const size\+\_\+t visible\+Size, const size\+\_\+t hidden\+Size, const double lambda=0.\+0001, const double beta=3, const double rho=0.\+01, Optimizer\+Type optimizer=Optimizer\+Type())
\begin{DoxyCompactList}\small\item\em Construct the sparse autoencoder model with the given training data. \end{DoxyCompactList}\item 
...
{\texttt{ http\+://deeplearning.\+stanford.\+edu/wiki/index.\+php/\+UFLDL\+\_\+\+Tutorial}}
...
\DoxyCodeLine{SparseAutoencoder encoder1(data, vSize, hSize);}
\DoxyCodeLine{}
...
\DoxyCodeLine{SparseAutoencoderFunction saf(data, vSize, hSize);}
\DoxyCodeLine{L\_BFGS<SparseAutoencoderFunction> optimizer(saf, numBasis, numIterations);}
\DoxyCodeLine{SparseAutoencoder<L\_BFGS> encoder2(optimizer);}
\DoxyCodeLine{}
\DoxyCodeLine{arma::mat features1, features2; \textcolor{comment}{// Matrices for storing new representations.}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Get new representations from the trained models.}}
\DoxyCodeLine{encoder1.GetNewFeatures(data, features1);}
\DoxyCodeLine{encoder2.GetNewFeatures(data, features2);}
...
\index{SparseAutoencoder@{SparseAutoencoder}!SparseAutoencoder@{SparseAutoencoder}}
\index{SparseAutoencoder@{SparseAutoencoder}!SparseAutoencoder@{SparseAutoencoder}}
\doxysubsubsection{SparseAutoencoder()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{SparseAutoencoder@{SparseAutoencoder}!SparseAutoencoder@{SparseAutoencoder}}
\index{SparseAutoencoder@{SparseAutoencoder}!SparseAutoencoder@{SparseAutoencoder}}
\doxysubsubsection{SparseAutoencoder()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{SparseAutoencoder@{SparseAutoencoder}!Beta@{Beta}}
\index{Beta@{Beta}!SparseAutoencoder@{SparseAutoencoder}}
...
\index{SparseAutoencoder@{SparseAutoencoder}!GetNewFeatures@{GetNewFeatures}}
\index{GetNewFeatures@{GetNewFeatures}!SparseAutoencoder@{SparseAutoencoder}}
\doxysubsubsection{GetNewFeatures()}
...
\index{SparseAutoencoder@{SparseAutoencoder}!HiddenSize@{HiddenSize}}
\index{HiddenSize@{HiddenSize}!SparseAutoencoder@{SparseAutoencoder}}
...
\index{SparseAutoencoder@{SparseAutoencoder}!Lambda@{Lambda}}
\index{Lambda@{Lambda}!SparseAutoencoder@{SparseAutoencoder}}
...
\index{SparseAutoencoder@{SparseAutoencoder}!Rho@{Rho}}
\index{Rho@{Rho}!SparseAutoencoder@{SparseAutoencoder}}
...
\index{SparseAutoencoder@{SparseAutoencoder}!Sigmoid@{Sigmoid}}
\index{Sigmoid@{Sigmoid}!SparseAutoencoder@{SparseAutoencoder}}
...
\index{SparseAutoencoder@{SparseAutoencoder}!VisibleSize@{VisibleSize}}
\index{VisibleSize@{VisibleSize}!SparseAutoencoder@{SparseAutoencoder}}
