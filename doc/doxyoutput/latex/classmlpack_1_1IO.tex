...
\begin{DoxyCompactList}\small\item\em Adds a parameter to the hierarchy; use the PARAM\+\_\+$\ast$() macros instead of this (i.\+e. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Get the program name as set by the \doxyref{BINDING\+\_\+\+NAME()}{p.}{param_8hpp_a3610abda0a69dc19a08c50e713f615b7} macro. \end{DoxyCompactList}\item 
...
The \doxyref{IO}{p.}{classmlpack_1_1IO} class is a subsystem by which parameters for machine learning methods can be specified and accessed. In conjunction with the macros PARAM\+\_\+\+DOUBLE, PARAM\+\_\+\+INT, PARAM\+\_\+\+STRING, PARAM\+\_\+\+FLAG, and others, this class aims to make user configurability of mlpack methods very easy. There are only three methods in \doxyref{IO}{p.}{classmlpack_1_1IO} that a user should need\+: \doxyref{IO\+::\+Parse\+Command\+Line()}{p.}{namespacemlpack_1_1bindings_1_1cli_a9f4d336f3d999569328497d0b8f37b35}, \doxyref{IO\+::\+Get\+Param()}{p.}{classmlpack_1_1IO_a6c641e7bd5291c24b787f379f25cb9b8}, and \doxyref{IO\+::\+Has\+Param()}{p.}{classmlpack_1_1IO_a39eda1093ba2453f2b66d37153ac542c} (in addition to the PARAM\+\_\+$\ast$() macros).\doxysubsection{Adding parameters to a program}\label{classmlpack_1_1IO_addparam}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ ./executable -\/-\/bar=5}
...
\begin{DoxyItemize}
\item \doxyref{PARAM\+\_\+\+FLAG(\+ID, DESC, ALIAS)}{p.}{param_8hpp_a59a38dfe16c56a278bd89817216a3739}
\item PARAM\+\_\+\+DOUBLE(\+ID, DESC, ALIAS, DEF)
\item PARAM\+\_\+\+INT(\+ID, DESC, ALIAS, DEF)
\item PARAM\+\_\+\+STRING(\+ID, DESC, ALIAS, DEF)
\end{DoxyItemize}
...
\hline
{\em DESC} & Short description of the parameter (one/two sentences). \\
\hline
{\em ALIAS} & An alias for the parameter. \\
\hline
...
Here is an example of a few parameters being defined; this is for the KNN binding (methods/neighbor\+\_\+search/knn\+\_\+main.\+cpp)\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{PARAM\_STRING\_REQ(\textcolor{stringliteral}{"{}reference\_file"{}}, \textcolor{stringliteral}{"{}File containing the reference dataset."{}},}
\DoxyCodeLine{    \textcolor{stringliteral}{"{}r"{}});}
\DoxyCodeLine{PARAM\_STRING\_REQ(\textcolor{stringliteral}{"{}distances\_file"{}}, \textcolor{stringliteral}{"{}File to output distances into."{}}, \textcolor{stringliteral}{"{}d"{}});}
\DoxyCodeLine{PARAM\_STRING\_REQ(\textcolor{stringliteral}{"{}neighbors\_file"{}}, \textcolor{stringliteral}{"{}File to output neighbors into."{}}, \textcolor{stringliteral}{"{}n"{}});}
\DoxyCodeLine{PARAM\_INT\_REQ(\textcolor{stringliteral}{"{}k"{}}, \textcolor{stringliteral}{"{}Number of furthest neighbors to find."{}}, \textcolor{stringliteral}{"{}k"{}});}
\DoxyCodeLine{PARAM\_STRING(\textcolor{stringliteral}{"{}query\_file"{}}, \textcolor{stringliteral}{"{}File containing query points (optional)."{}}, \textcolor{stringliteral}{"{}q"{}},}
\DoxyCodeLine{    \textcolor{stringliteral}{"{}"{}});}
\DoxyCodeLine{PARAM\_INT(\textcolor{stringliteral}{"{}leaf\_size"{}}, \textcolor{stringliteral}{"{}Leaf size for tree building."{}}, \textcolor{stringliteral}{"{}l"{}}, 20);}
\DoxyCodeLine{PARAM\_FLAG(\textcolor{stringliteral}{"{}naive"{}}, \textcolor{stringliteral}{"{}If true, O(n\string^2) naive mode is used for computation."{}},}
\DoxyCodeLine{    \textcolor{stringliteral}{"{}N"{}});}
\DoxyCodeLine{PARAM\_FLAG(\textcolor{stringliteral}{"{}single\_mode"{}}, \textcolor{stringliteral}{"{}If true, single-\/tree search is used (as opposed "{}}}
\DoxyCodeLine{    \textcolor{stringliteral}{"{}to dual-\/tree search."{}}, \textcolor{stringliteral}{"{}s"{}});}

\end{DoxyCode}


More documentation is available on the PARAM\+\_\+$\ast$() macros in the documentation for core/io/io.\+hpp.\doxysubsection{Documenting the program itself}\label{classmlpack_1_1IO_programinfo}
In addition to allowing documentation for each individual parameter and module, the \doxyref{BINDING\+\_\+\+NAME()}{p.}{param_8hpp_a3610abda0a69dc19a08c50e713f615b7} macro provides support for documenting the program\+Name, \doxyref{BINDING\+\_\+\+SHORT\+\_\+\+DESC()}{p.}{param_8hpp_a013f7f337d6139c7f6de3a4f0fa7b019} macro provides support for documenting the short\+Description, \doxyref{BINDING\+\_\+\+LONG\+\_\+\+DESC()}{p.}{param_8hpp_a7f7cbd16d4fecab7136b5ca1cbcbb0a7} macro provides support for documenting the long\+Description, the \doxyref{BINDING\+\_\+\+EXAMPLE()}{p.}{param_8hpp_a9ffe1d6d254b3e50a5611f77ee381838} macro provides support for documenting the example and the \doxyref{BINDING\+\_\+\+SEE\+\_\+\+ALSO()}{p.}{param_8hpp_add4a79815b7f3972699cc414bfc9fe57} macro provides support for documenting the see\+Also. There should only be one instance of the \doxyref{BINDING\+\_\+\+NAME()}{p.}{param_8hpp_a3610abda0a69dc19a08c50e713f615b7}, \doxyref{BINDING\+\_\+\+SHORT\+\_\+\+DESC()}{p.}{param_8hpp_a013f7f337d6139c7f6de3a4f0fa7b019} and \doxyref{BINDING\+\_\+\+LONG\+\_\+\+DESC()}{p.}{param_8hpp_a7f7cbd16d4fecab7136b5ca1cbcbb0a7} macros and there can be multiple instance of \doxyref{BINDING\+\_\+\+EXAMPLE()}{p.}{param_8hpp_a9ffe1d6d254b3e50a5611f77ee381838} and \doxyref{BINDING\+\_\+\+SEE\+\_\+\+ALSO()}{p.}{param_8hpp_add4a79815b7f3972699cc414bfc9fe57} macro. Below is an example\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{BINDING\_NAME(\textcolor{stringliteral}{"{}Maximum Variance Unfolding"{}});}
\DoxyCodeLine{BINDING\_SHORT\_DESC(\textcolor{stringliteral}{"{}An implementation of Maximum Variance Unfolding"{}});}
\DoxyCodeLine{BINDING\_LONG\_DESC( \textcolor{stringliteral}{"{}This program performs maximum "{}}}
\DoxyCodeLine{   \textcolor{stringliteral}{"{}variance unfolding on the given dataset, writing a lower-\/dimensional "{}}}
\DoxyCodeLine{   \textcolor{stringliteral}{"{}unfolded dataset to the given output file."{}});}
\DoxyCodeLine{BINDING\_EXAMPLE(\textcolor{stringliteral}{"{}mvu"{}}, \textcolor{stringliteral}{"{}input"{}}, \textcolor{stringliteral}{"{}dataset"{}}, \textcolor{stringliteral}{"{}new\_dim"{}}, 5, \textcolor{stringliteral}{"{}output"{}}, \textcolor{stringliteral}{"{}output"{}});}
\DoxyCodeLine{BINDING\_SEE\_ALSO(\textcolor{stringliteral}{"{}Perceptron"{}}, \textcolor{stringliteral}{"{}\#perceptron"{}});}

\end{DoxyCode}


This description should be verbose, and explain to a non-\/expert user what the program does and how to use it. If relevant, paper citations should be included.\doxysubsection{Parsing the command line with IO}\label{classmlpack_1_1IO_parseio}
To have \doxyref{IO}{p.}{classmlpack_1_1IO} parse the command line at the beginning of code execution, only a call to \doxyref{Parse\+Command\+Line()}{p.}{namespacemlpack_1_1bindings_1_1cli_a9f4d336f3d999569328497d0b8f37b35} is necessary\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}** argv)}
\DoxyCodeLine{\{}
\DoxyCodeLine{  IO::ParseCommandLine(argc, argv);}
\DoxyCodeLine{}
\DoxyCodeLine{  ...}
\DoxyCodeLine{\}}
...
\doxyref{IO}{p.}{classmlpack_1_1IO} provides --help and --info options which give nicely formatted documentation of each option; the documentation is generated from the DESC arguments in the PARAM\+\_\+$\ast$() macros.\doxysubsection{Getting parameters with IO}\label{classmlpack_1_1IO_getparam}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordflow}{if} (IO::HasParam(\textcolor{stringliteral}{"{}naive"{}}))}
\DoxyCodeLine{\{}
\DoxyCodeLine{  Log::Info << \textcolor{stringliteral}{"{}Naive has been passed!"{}} << std::endl;}
\DoxyCodeLine{\}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{const} std::string filename = IO::GetParam<std::string>(\textcolor{stringliteral}{"{}filename"{}});}
...
\index{IO@{IO}!FunctionMapType@{FunctionMapType}}
\index{FunctionMapType@{FunctionMapType}!IO@{IO}}
\doxysubsubsection{FunctionMapType}
...
Adds a parameter to the hierarchy; use the PARAM\+\_\+$\ast$() macros instead of this (i.\+e. 
...
\index{IO@{IO}!Aliases@{Aliases}}
\index{Aliases@{Aliases}!IO@{IO}}
...
\index{IO@{IO}!CheckInputMatrices@{CheckInputMatrices}}
\index{CheckInputMatrices@{CheckInputMatrices}!IO@{IO}}
\doxysubsubsection{CheckInputMatrices()}
...
\index{IO@{IO}!CheckInputMatrix@{CheckInputMatrix}}
\index{CheckInputMatrix@{CheckInputMatrix}!IO@{IO}}
\doxysubsubsection{CheckInputMatrix()}
...
\index{IO@{IO}!ClearSettings@{ClearSettings}}
\index{ClearSettings@{ClearSettings}!IO@{IO}}
\doxysubsubsection{ClearSettings()}
...
Referenced by Go\+Option$<$ T $>$\+::\+Go\+Option(), Julia\+Option$<$ T $>$\+::\+Julia\+Option(), MDOption$<$ T $>$\+::\+MDOption(), Py\+Option$<$ T $>$\+::\+Py\+Option(), ROption$<$ T $>$\+::\+ROption(), and Test\+Option$<$ N $>$\+::\+Test\+Option().

\mbox{\label{classmlpack_1_1IO_a6c641e7bd5291c24b787f379f25cb9b8}} 
\index{IO@{IO}!GetParam@{GetParam}}
\index{GetParam@{GetParam}!IO@{IO}}
...
\index{IO@{IO}!GetPrintableParam@{GetPrintableParam}}
\index{GetPrintableParam@{GetPrintableParam}!IO@{IO}}
\doxysubsubsection{GetPrintableParam()}
...
\index{IO@{IO}!GetRawParam@{GetRawParam}}
\index{GetRawParam@{GetRawParam}!IO@{IO}}
\doxysubsubsection{GetRawParam()}
...
\index{IO@{IO}!GetSingleton@{GetSingleton}}
\index{GetSingleton@{GetSingleton}!IO@{IO}}
...
Referenced by CLIOption$<$ N $>$\+::\+CLIOption(), Go\+Option$<$ T $>$\+::\+Go\+Option(), Julia\+Option$<$ T $>$\+::\+Julia\+Option(), MDOption$<$ T $>$\+::\+MDOption(), Py\+Option$<$ T $>$\+::\+Py\+Option(), ROption$<$ T $>$\+::\+ROption(), Test\+Option$<$ N $>$\+::\+Test\+Option(), mlpack\+::bindings\+::cli\+::\+End\+Program(), mlpack\+::bindings\+::cli\+::\+Parse\+Command\+Line(), and mlpack\+::util\+::\+Reset\+Timers().

\mbox{\label{classmlpack_1_1IO_a39eda1093ba2453f2b66d37153ac542c}} 
\index{IO@{IO}!HasParam@{HasParam}}
\index{HasParam@{HasParam}!IO@{IO}}
...
\index{IO@{IO}!MakeInPlaceCopy@{MakeInPlaceCopy}}
\index{MakeInPlaceCopy@{MakeInPlaceCopy}!IO@{IO}}
\doxysubsubsection{MakeInPlaceCopy()}
...
\index{IO@{IO}!Parameters@{Parameters}}
\index{Parameters@{Parameters}!IO@{IO}}
...
Referenced by CLIOption$<$ N $>$\+::\+CLIOption(), mlpack\+::bindings\+::cli\+::\+End\+Program(), mlpack\+::bindings\+::cli\+::\+Parse\+Command\+Line(), and mlpack\+::bindings\+::python\+::\+Print\+Output\+Processing().

\mbox{\label{classmlpack_1_1IO_a1025ff079f4aa3baecf036ab0bc32be5}} 
\index{IO@{IO}!ProgramName@{ProgramName}}
\index{ProgramName@{ProgramName}!IO@{IO}}
...
Get the program name as set by the \doxyref{BINDING\+\_\+\+NAME()}{p.}{param_8hpp_a3610abda0a69dc19a08c50e713f615b7} macro. 



Referenced by ROption$<$ T $>$\+::\+ROption(), and mlpack\+::bindings\+::cli\+::\+Parse\+Command\+Line().

\mbox{\label{classmlpack_1_1IO_a6de90cea213fa99eaa5d5f354fabfaa0}} 
\index{IO@{IO}!RestoreSettings@{RestoreSettings}}
\index{RestoreSettings@{RestoreSettings}!IO@{IO}}
\doxysubsubsection{RestoreSettings()}
...
\index{IO@{IO}!SetPassed@{SetPassed}}
\index{SetPassed@{SetPassed}!IO@{IO}}
\doxysubsubsection{SetPassed()}
...
Referenced by Test\+Option$<$ N $>$\+::\+Test\+Option(), and mlpack\+::util\+::\+Set\+Input\+Param().

\mbox{\label{classmlpack_1_1IO_ad30747ed34d1dcf57dad194ff8d09138}} 
\index{IO@{IO}!StoreSettings@{StoreSettings}}
\index{StoreSettings@{StoreSettings}!IO@{IO}}
\doxysubsubsection{StoreSettings()}
...
\index{IO@{IO}!didParse@{didParse}}
\index{didParse@{didParse}!IO@{IO}}
\doxysubsubsection{didParse}
...
\index{IO@{IO}!functionMap@{functionMap}}
\index{functionMap@{functionMap}!IO@{IO}}
\doxysubsubsection{functionMap}
...
\index{IO@{IO}!timer@{timer}}
\index{timer@{timer}!IO@{IO}}
