\doxysection{Hard\+Swish\+Function Class Reference}
\label{classmlpack_1_1ann_1_1HardSwishFunction}\index{HardSwishFunction@{HardSwishFunction}}
...
\begin{eqnarray*} f(x) &=& \begin{cases} 0 & x \leq -3\\ x & x \geq +3\\ \frac{x * (x + 3)}{6} & otherwise\\ \end{cases} \\ f\textnormal{\textquotesingle}(x) &=& \begin{cases} 0 & x \leq -3\\ 1 & x \geq +3\\ \frac{2x + 3}{6} & otherwise\\ \end{cases} \end{eqnarray*} 
...
\index{HardSwishFunction@{HardSwishFunction}!Deriv@{Deriv}}
\index{Deriv@{Deriv}!HardSwishFunction@{HardSwishFunction}}
...
\index{HardSwishFunction@{HardSwishFunction}!Fn@{Fn}}
\index{Fn@{Fn}!HardSwishFunction@{HardSwishFunction}}
