\doxysection{Fast\+LSTM$<$ Input\+Data\+Type, Output\+Data\+Type $>$ Class Template Reference}
\label{classmlpack_1_1ann_1_1FastLSTM}\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}


An implementation of a faster version of the Fast \doxyref{LSTM}{p.}{classmlpack_1_1ann_1_1LSTM} network layer.  
...
\item 
\textbf{ Fast\+LSTM} ()
\begin{DoxyCompactList}\small\item\em Create the Fast \doxyref{LSTM}{p.}{classmlpack_1_1ann_1_1LSTM} object. \end{DoxyCompactList}\item 
\textbf{ Fast\+LSTM} (const \textbf{ Fast\+LSTM} \&layer)
\begin{DoxyCompactList}\small\item\em Copy Constructor. \end{DoxyCompactList}\item 
\textbf{ Fast\+LSTM} (const size\+\_\+t in\+Size, const size\+\_\+t out\+Size, const size\+\_\+t rho=std\+::numeric\+\_\+limits$<$ size\+\_\+t $>$\+::max())
\begin{DoxyCompactList}\small\item\em Create the Fast \doxyref{LSTM}{p.}{classmlpack_1_1ann_1_1LSTM} layer object using the specified parameters. \end{DoxyCompactList}\item 
\textbf{ Fast\+LSTM} (\textbf{ Fast\+LSTM} \&\&layer)
...
\textbf{ Fast\+LSTM} \& \textbf{ operator=} (const \textbf{ Fast\+LSTM} \&layer)
\begin{DoxyCompactList}\small\item\em Copy assignment operator. \end{DoxyCompactList}\item 
\textbf{ Fast\+LSTM} \& \textbf{ operator=} (\textbf{ Fast\+LSTM} \&\&layer)
...
class mlpack\+::ann\+::\+Fast\+LSTM$<$ Input\+Data\+Type, Output\+Data\+Type $>$}
...
Note that \doxyref{Fast\+LSTM}{p.}{classmlpack_1_1ann_1_1FastLSTM} network layer does not use peephole connections between the cell and gates.

Note also that if a \doxyref{Fast\+LSTM}{p.}{classmlpack_1_1ann_1_1FastLSTM} layer is desired as the first layer of a neural network, an Identity\+Layer should be added to the network as the first layer, and then the \doxyref{Fast\+LSTM}{p.}{classmlpack_1_1ann_1_1FastLSTM} layer should be added.

For more information, see the following.


\begin{DoxyCode}{0}
\DoxyCodeLine{@article\{Hochreiter1997,}
\DoxyCodeLine{  author  = \{Hochreiter, Sepp and Schmidhuber, J\(\backslash\)\textcolor{stringliteral}{"{}\{u\}rgen\},}}
\DoxyCodeLine{\textcolor{stringliteral}{  title   = \{Long Short-\/term Memory\},}}
\DoxyCodeLine{\textcolor{stringliteral}{  journal = \{Neural Comput.\},}}
\DoxyCodeLine{\textcolor{stringliteral}{  year    = \{1997\},}}
\DoxyCodeLine{\textcolor{stringliteral}{  url     = \{https://www.bioinf.jku.at/publications/older/2604.pdf\}}}
...
\doxyref{LSTM}{p.}{classmlpack_1_1ann_1_1LSTM} for a standard implementation of the \doxyref{LSTM}{p.}{classmlpack_1_1ann_1_1LSTM} layer.
\end{DoxySeeAlso}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!ElemType@{ElemType}}
\index{ElemType@{ElemType}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!InputElemType@{InputElemType}}
\index{InputElemType@{InputElemType}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
\doxysubsubsection{InputElemType}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!FastLSTM@{FastLSTM}}
\index{FastLSTM@{FastLSTM}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
\doxysubsubsection{FastLSTM()\hspace{0.1cm}{\footnotesize\ttfamily [1/4]}}
{\footnotesize\ttfamily \textbf{ Fast\+LSTM} (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}



Create the Fast \doxyref{LSTM}{p.}{classmlpack_1_1ann_1_1LSTM} object. 

\mbox{\label{classmlpack_1_1ann_1_1FastLSTM_a3a669a68e846624a995e734630c3863f}} 
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!FastLSTM@{FastLSTM}}
\index{FastLSTM@{FastLSTM}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
\doxysubsubsection{FastLSTM()\hspace{0.1cm}{\footnotesize\ttfamily [2/4]}}
{\footnotesize\ttfamily \textbf{ Fast\+LSTM} (\begin{DoxyParamCaption}\item[{const \textbf{ Fast\+LSTM}$<$ Input\+Data\+Type, Output\+Data\+Type $>$ \&}]{layer }\end{DoxyParamCaption})}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!FastLSTM@{FastLSTM}}
\index{FastLSTM@{FastLSTM}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
\doxysubsubsection{FastLSTM()\hspace{0.1cm}{\footnotesize\ttfamily [3/4]}}
{\footnotesize\ttfamily \textbf{ Fast\+LSTM} (\begin{DoxyParamCaption}\item[{\textbf{ Fast\+LSTM}$<$ Input\+Data\+Type, Output\+Data\+Type $>$ \&\&}]{layer }\end{DoxyParamCaption})}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!FastLSTM@{FastLSTM}}
\index{FastLSTM@{FastLSTM}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
\doxysubsubsection{FastLSTM()\hspace{0.1cm}{\footnotesize\ttfamily [4/4]}}
{\footnotesize\ttfamily \textbf{ Fast\+LSTM} (\begin{DoxyParamCaption}\item[{const size\+\_\+t}]{in\+Size,  }\item[{const size\+\_\+t}]{out\+Size,  }\item[{const size\+\_\+t}]{rho = {\ttfamily std\+:\+:numeric\+\_\+limits$<$~size\+\_\+t~$>$\+:\+:max()} }\end{DoxyParamCaption})}



Create the Fast \doxyref{LSTM}{p.}{classmlpack_1_1ann_1_1LSTM} layer object using the specified parameters. 
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!Backward@{Backward}}
\index{Backward@{Backward}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!Delta@{Delta}}
\index{Delta@{Delta}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!Forward@{Forward}}
\index{Forward@{Forward}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!Gradient@{Gradient}}
\index{Gradient@{Gradient}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!InputShape@{InputShape}}
\index{InputShape@{InputShape}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!InSize@{InSize}}
\index{InSize@{InSize}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!operator=@{operator=}}
\index{operator=@{operator=}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
\doxysubsubsection{operator=()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily \textbf{ Fast\+LSTM}\& operator= (\begin{DoxyParamCaption}\item[{const \textbf{ Fast\+LSTM}$<$ Input\+Data\+Type, Output\+Data\+Type $>$ \&}]{layer }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \textbf{ Fast\+LSTM}\& operator= (\begin{DoxyParamCaption}\item[{\textbf{ Fast\+LSTM}$<$ Input\+Data\+Type, Output\+Data\+Type $>$ \&\&}]{layer }\end{DoxyParamCaption})}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!OutputParameter@{OutputParameter}}
\index{OutputParameter@{OutputParameter}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!OutSize@{OutSize}}
\index{OutSize@{OutSize}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!Parameters@{Parameters}}
\index{Parameters@{Parameters}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!Reset@{Reset}}
\index{Reset@{Reset}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!ResetCell@{ResetCell}}
\index{ResetCell@{ResetCell}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!Rho@{Rho}}
\index{Rho@{Rho}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!serialize@{serialize}}
\index{serialize@{serialize}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
...
\index{FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}!WeightSize@{WeightSize}}
\index{WeightSize@{WeightSize}!FastLSTM$<$ InputDataType, OutputDataType $>$@{FastLSTM$<$ InputDataType, OutputDataType $>$}}
