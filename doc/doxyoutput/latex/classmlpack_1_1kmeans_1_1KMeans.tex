\doxysection{KMeans$<$ Metric\+Type, Initial\+Partition\+Policy, Empty\+Cluster\+Policy, Lloyd\+Step\+Type, Mat\+Type $>$ Class Template Reference}
\label{classmlpack_1_1kmeans_1_1KMeans}\index{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}}
...
\item 
\textbf{ KMeans} (const size\+\_\+t max\+Iterations=1000, const Metric\+Type metric=Metric\+Type(), const Initial\+Partition\+Policy partitioner=Initial\+Partition\+Policy(), const Empty\+Cluster\+Policy empty\+Cluster\+Action=Empty\+Cluster\+Policy())
...
\subsubsection*{template$<$typename Metric\+Type = metric\+::\+Euclidean\+Distance, typename Initial\+Partition\+Policy = Sample\+Initialization, typename Empty\+Cluster\+Policy = Max\+Variance\+New\+Cluster, template$<$ class, class $>$ class Lloyd\+Step\+Type = Naive\+KMeans, typename Mat\+Type = arma\+::mat$>$\newline
class mlpack\+::kmeans\+::\+KMeans$<$ Metric\+Type, Initial\+Partition\+Policy, Empty\+Cluster\+Policy, Lloyd\+Step\+Type, Mat\+Type $>$}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{extern} arma::mat data; \textcolor{comment}{// Dataset we want to run K-\/Means on.}}
\DoxyCodeLine{arma::Row<size\_t> assignments; \textcolor{comment}{// Cluster assignments.}}
\DoxyCodeLine{arma::mat centroids; \textcolor{comment}{// Cluster centroids.}}
\DoxyCodeLine{}
\DoxyCodeLine{KMeans<> k; \textcolor{comment}{// Default options.}}
\DoxyCodeLine{k.Cluster(data, 3, assignments, centroids); \textcolor{comment}{// 3 clusters.}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Cluster using the Manhattan distance, 100 iterations maximum, saving only}}
\DoxyCodeLine{\textcolor{comment}{// the centroids.}}
\DoxyCodeLine{KMeans<metric::ManhattanDistance> k(100);}
\DoxyCodeLine{k.Cluster(data, 6, centroids); \textcolor{comment}{// 6 clusters.}}
...
{\em Metric\+Type} & The distance metric to use for this \doxyref{KMeans}{p.}{classmlpack_1_1kmeans_1_1KMeans}; see \doxyref{metric\+::\+LMetric}{p.}{classmlpack_1_1metric_1_1LMetric} for an example. \\
\hline
...
\index{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}!KMeans@{KMeans}}
\index{KMeans@{KMeans}!KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}}
\doxysubsubsection{KMeans()}
{\footnotesize\ttfamily \textbf{ KMeans} (\begin{DoxyParamCaption}\item[{const size\+\_\+t}]{max\+Iterations = {\ttfamily 1000},  }\item[{const Metric\+Type}]{metric = {\ttfamily MetricType()},  }\item[{const Initial\+Partition\+Policy}]{partitioner = {\ttfamily InitialPartitionPolicy()},  }\item[{const Empty\+Cluster\+Policy}]{empty\+Cluster\+Action = {\ttfamily EmptyClusterPolicy()} }\end{DoxyParamCaption})}
...
\index{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}!Cluster@{Cluster}}
\index{Cluster@{Cluster}!KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}}
...
\index{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}!EmptyClusterAction@{EmptyClusterAction}}
\index{EmptyClusterAction@{EmptyClusterAction}!KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}}
\doxysubsubsection{EmptyClusterAction()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}!EmptyClusterAction@{EmptyClusterAction}}
\index{EmptyClusterAction@{EmptyClusterAction}!KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}}
\doxysubsubsection{EmptyClusterAction()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}!MaxIterations@{MaxIterations}}
\index{MaxIterations@{MaxIterations}!KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}}
...
\index{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}!Metric@{Metric}}
\index{Metric@{Metric}!KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}}
...
\index{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}!Partitioner@{Partitioner}}
\index{Partitioner@{Partitioner}!KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}}
\doxysubsubsection{Partitioner()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}!Partitioner@{Partitioner}}
\index{Partitioner@{Partitioner}!KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}}
\doxysubsubsection{Partitioner()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}!serialize@{serialize}}
\index{serialize@{serialize}!KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$@{KMeans$<$ MetricType, InitialPartitionPolicy, EmptyClusterPolicy, LloydStepType, MatType $>$}}
