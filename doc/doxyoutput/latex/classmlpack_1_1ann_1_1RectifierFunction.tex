\doxysection{Rectifier\+Function Class Reference}
\label{classmlpack_1_1ann_1_1RectifierFunction}\index{RectifierFunction@{RectifierFunction}}
...
\begin{DoxyCompactList}\small\item\em Computes the rectifier function using a 3rd-\/order tensor as input. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Computes the rectifier function. \end{DoxyCompactList}\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
The rectifier function, defined by. 

\begin{eqnarray*} f(x) &=& \max(0, x) \\ f\textnormal{\textquotesingle}(x) &=& \left\{ \begin{array}{lr} 1 & : x > 0 \\ 0 & : x \le 0 \end{array} \right. \end{eqnarray*} 
...
\index{RectifierFunction@{RectifierFunction}!Deriv@{Deriv}}
\index{Deriv@{Deriv}!RectifierFunction@{RectifierFunction}}
...
\index{RectifierFunction@{RectifierFunction}!Fn@{Fn}}
\index{Fn@{Fn}!RectifierFunction@{RectifierFunction}}
\doxysubsubsection{Fn()\hspace{0.1cm}{\footnotesize\ttfamily [1/3]}}
...
\index{RectifierFunction@{RectifierFunction}!Fn@{Fn}}
\index{Fn@{Fn}!RectifierFunction@{RectifierFunction}}
\doxysubsubsection{Fn()\hspace{0.1cm}{\footnotesize\ttfamily [2/3]}}
...
\index{RectifierFunction@{RectifierFunction}!Fn@{Fn}}
\index{Fn@{Fn}!RectifierFunction@{RectifierFunction}}
\doxysubsubsection{Fn()\hspace{0.1cm}{\footnotesize\ttfamily [3/3]}}
