\doxysection{Train\+Form$<$ Mat\+Type, Predictions\+Type, Weights\+Type, Dataset\+Info, Num\+Classes $>$ Struct Template Reference}
\label{structmlpack_1_1cv_1_1TrainForm}\index{TrainForm$<$ MatType, PredictionsType, WeightsType, DatasetInfo, NumClasses $>$@{TrainForm$<$ MatType, PredictionsType, WeightsType, DatasetInfo, NumClasses $>$}}
