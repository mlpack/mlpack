\doxysection{RASearch\+Rules$<$ Sort\+Policy, Metric\+Type, Tree\+Type $>$ Class Template Reference}
\label{classmlpack_1_1neighbor_1_1RASearchRules}\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}


The \doxyref{RASearch\+Rules}{p.}{classmlpack_1_1neighbor_1_1RASearchRules} class is a template helper class used by \doxyref{RASearch}{p.}{classmlpack_1_1neighbor_1_1RASearch} class when performing rank-\/approximate search via random-\/sampling.  
...
\begin{DoxyCompactItemize}
\item 
\textbf{ RASearch\+Rules} (const arma\+::mat \&reference\+Set, const arma\+::mat \&query\+Set, const size\+\_\+t k, Metric\+Type \&metric, const double tau=5, const double \textbf{ alpha}=0.\+95, const bool naive=false, const bool sample\+At\+Leaves=false, const bool first\+Leaf\+Exact=false, const size\+\_\+t single\+Sample\+Limit=20, const bool same\+Set=false)
\begin{DoxyCompactList}\small\item\em Construct the \doxyref{RASearch\+Rules}{p.}{classmlpack_1_1neighbor_1_1RASearchRules} object. \end{DoxyCompactList}\item 
...
class mlpack\+::neighbor\+::\+RASearch\+Rules$<$ Sort\+Policy, Metric\+Type, Tree\+Type $>$}
...
\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}!TraversalInfoType@{TraversalInfoType}}
\index{TraversalInfoType@{TraversalInfoType}!RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}
...
\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}!RASearchRules@{RASearchRules}}
\index{RASearchRules@{RASearchRules}!RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}
\doxysubsubsection{RASearchRules()}
{\footnotesize\ttfamily \textbf{ RASearch\+Rules} (\begin{DoxyParamCaption}\item[{const arma\+::mat \&}]{reference\+Set,  }\item[{const arma\+::mat \&}]{query\+Set,  }\item[{const size\+\_\+t}]{k,  }\item[{Metric\+Type \&}]{metric,  }\item[{const double}]{tau = {\ttfamily 5},  }\item[{const double}]{alpha = {\ttfamily 0.95},  }\item[{const bool}]{naive = {\ttfamily false},  }\item[{const bool}]{sample\+At\+Leaves = {\ttfamily false},  }\item[{const bool}]{first\+Leaf\+Exact = {\ttfamily false},  }\item[{const size\+\_\+t}]{single\+Sample\+Limit = {\ttfamily 20},  }\item[{const bool}]{same\+Set = {\ttfamily false} }\end{DoxyParamCaption})}



Construct the \doxyref{RASearch\+Rules}{p.}{classmlpack_1_1neighbor_1_1RASearchRules} object. 

This is usually done from within the \doxyref{RASearch}{p.}{classmlpack_1_1neighbor_1_1RASearch} class at search time.
...
\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}!BaseCase@{BaseCase}}
\index{BaseCase@{BaseCase}!RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}
...
\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}!GetResults@{GetResults}}
\index{GetResults@{GetResults}!RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}
...
\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}!MinimumBaseCases@{MinimumBaseCases}}
\index{MinimumBaseCases@{MinimumBaseCases}!RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}
...
\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}!NumDistComputations@{NumDistComputations}}
\index{NumDistComputations@{NumDistComputations}!RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}
\doxysubsubsection{NumDistComputations()}
...
\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}!NumEffectiveSamples@{NumEffectiveSamples}}
\index{NumEffectiveSamples@{NumEffectiveSamples}!RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}
\doxysubsubsection{NumEffectiveSamples()}
...
\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}!Rescore@{Rescore}}
\index{Rescore@{Rescore}!RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}
...
For rank-\/approximation, it also checks if the number of samples left for a query to satisfy the rank constraint is small enough at this point of the algorithm, then this node is approximated by sampling and given a new score of \textquotesingle{}DBL\+\_\+\+MAX\textquotesingle{}.
...
\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}!Score@{Score}}
\index{Score@{Score}!RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}
\doxysubsubsection{Score()\hspace{0.1cm}{\footnotesize\ttfamily [1/4]}}
...
For rank-\/approximation, the scoring function first checks if pruning by distance is possible. If yes, then the node is given the score of \textquotesingle{}DBL\+\_\+\+MAX\textquotesingle{} and the expected number of samples from that node are added to the number of samples made for the query.

If no, then the function tries to see if the node can be pruned by approximation. If number of samples required from this node is small enough, then that number of samples are acquired from this node and the score is set to be \textquotesingle{}DBL\+\_\+\+MAX\textquotesingle{}.
...
\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}!Score@{Score}}
\index{Score@{Score}!RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}
\doxysubsubsection{Score()\hspace{0.1cm}{\footnotesize\ttfamily [2/4]}}
...
\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}!Score@{Score}}
\index{Score@{Score}!RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}
\doxysubsubsection{Score()\hspace{0.1cm}{\footnotesize\ttfamily [3/4]}}
...
\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}!Score@{Score}}
\index{Score@{Score}!RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}
\doxysubsubsection{Score()\hspace{0.1cm}{\footnotesize\ttfamily [4/4]}}
...
\index{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}!TraversalInfo@{TraversalInfo}}
\index{TraversalInfo@{TraversalInfo}!RASearchRules$<$ SortPolicy, MetricType, TreeType $>$@{RASearchRules$<$ SortPolicy, MetricType, TreeType $>$}}
