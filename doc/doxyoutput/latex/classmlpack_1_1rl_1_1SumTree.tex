\doxysection{Sum\+Tree$<$ T $>$ Class Template Reference}
\label{classmlpack_1_1rl_1_1SumTree}\index{SumTree$<$ T $>$@{SumTree$<$ T $>$}}
...
\begin{center}
\leavevmode
\includegraphics[width=160pt]{classmlpack_1_1rl_1_1SumTree__inherit__graph}
\end{center}
\end{figure}
...
Build a Segment Tree like data structure. {\texttt{ https\+://en.\+wikipedia.\+org/wiki/\+Segment\+\_\+tree}}
...
\index{SumTree$<$ T $>$@{SumTree$<$ T $>$}!SumTree@{SumTree}}
\index{SumTree@{SumTree}!SumTree$<$ T $>$@{SumTree$<$ T $>$}}
\doxysubsubsection{SumTree()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{SumTree$<$ T $>$@{SumTree$<$ T $>$}!SumTree@{SumTree}}
\index{SumTree@{SumTree}!SumTree$<$ T $>$@{SumTree$<$ T $>$}}
\doxysubsubsection{SumTree()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\index{SumTree$<$ T $>$@{SumTree$<$ T $>$}!BatchUpdate@{BatchUpdate}}
\index{BatchUpdate@{BatchUpdate}!SumTree$<$ T $>$@{SumTree$<$ T $>$}}
\doxysubsubsection{BatchUpdate()}
...
\index{SumTree$<$ T $>$@{SumTree$<$ T $>$}!FindPrefixSum@{FindPrefixSum}}
\index{FindPrefixSum@{FindPrefixSum}!SumTree$<$ T $>$@{SumTree$<$ T $>$}}
\doxysubsubsection{FindPrefixSum()}
...
\index{SumTree$<$ T $>$@{SumTree$<$ T $>$}!Get@{Get}}
\index{Get@{Get}!SumTree$<$ T $>$@{SumTree$<$ T $>$}}
...
\index{SumTree$<$ T $>$@{SumTree$<$ T $>$}!Set@{Set}}
\index{Set@{Set}!SumTree$<$ T $>$@{SumTree$<$ T $>$}}
...
\index{SumTree$<$ T $>$@{SumTree$<$ T $>$}!Sum@{Sum}}
\index{Sum@{Sum}!SumTree$<$ T $>$@{SumTree$<$ T $>$}}
\doxysubsubsection{Sum()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{SumTree$<$ T $>$@{SumTree$<$ T $>$}!Sum@{Sum}}
\index{Sum@{Sum}!SumTree$<$ T $>$@{SumTree$<$ T $>$}}
\doxysubsubsection{Sum()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
References Sum\+Tree$<$ T $>$\+::\+Sum\+Helper().
...
\index{SumTree$<$ T $>$@{SumTree$<$ T $>$}!SumHelper@{SumHelper}}
\index{SumHelper@{SumHelper}!SumTree$<$ T $>$@{SumTree$<$ T $>$}}
\doxysubsubsection{SumHelper()}
