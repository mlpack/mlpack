\doxysection{Precision$<$ AS, Positive\+Class $>$ Class Template Reference}
\label{classmlpack_1_1cv_1_1Precision}\index{Precision$<$ AS, PositiveClass $>$@{Precision$<$ AS, PositiveClass $>$}}
...
class mlpack\+::cv\+::\+Precision$<$ AS, Positive\+Class $>$}
...
\index{Precision$<$ AS, PositiveClass $>$@{Precision$<$ AS, PositiveClass $>$}!Evaluate@{Evaluate}}
\index{Evaluate@{Evaluate}!Precision$<$ AS, PositiveClass $>$@{Precision$<$ AS, PositiveClass $>$}}
...
\index{Precision$<$ AS, PositiveClass $>$@{Precision$<$ AS, PositiveClass $>$}!NeedsMinimization@{NeedsMinimization}}
\index{NeedsMinimization@{NeedsMinimization}!Precision$<$ AS, PositiveClass $>$@{Precision$<$ AS, PositiveClass $>$}}
