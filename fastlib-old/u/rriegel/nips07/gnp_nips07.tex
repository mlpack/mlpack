...
analysis (or nonparametric Bayes classification) \cite{nbc-compstat}, and $n$-point correlation functions \cite{nips2000paper, moore-npt}.  These algorithms have been demonstrated on
...
%\noindent We now exploit the properties of the generalized $N$-body problems
%and the pruning thus afforded to derive novel dual-tree algorithms that
%demonstrate empirical asymptotic speedup.

%It is clear that partitioning data in this manner will be
...
%We demonstrate the value of the generalized $N$-body approach for deriving new efficient algorithms that display orders of magnitude speedup for a wide range of practical problems.
