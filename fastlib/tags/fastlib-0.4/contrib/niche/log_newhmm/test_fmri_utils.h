...
void LoadOneFMRIHMMAndSequences(HMM<DiagGaussian>* p_hmm,
...
void LoadKFoldFMRIHMMAndSequences(int n_folds,
...
void LoadKFoldFMRIHMMPairAndSequences(int n_folds,
  ...
  for(int fold_num = 0; fold_num < n_folds; fold_num++) {
    ...
    sprintf(class1_hmm_filename, "../../../../frozen/frozen_fmri_one_hmm_topo%d_model_class1_fold%dof%d", n_states_class1, fold_num, n_folds);
    sprintf(class0_hmm_filename, "../../../../frozen/frozen_fmri_one_hmm_topo%d_model_class0_fold%dof%d", n_states_class0, fold_num, n_folds);
