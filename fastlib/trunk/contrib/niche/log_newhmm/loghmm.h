...
class HMM {
 ...
 public:
  ...
  void ExpectationStep(const GenMatrix<T> &sequence,
    ...
    //state_distributions[1].PrintDebug("2nd state distribution");
    ...
    //forward_vars.PrintDebug("forward_vars");
  ...
  void ForwardAlgorithm(const Matrix &p_x_given_q,
    ...
    //p_initial.PrintDebug("p_initial");
    //p_x0_given_q.PrintDebug("p_x0_given_q");
