 ...
 *
 *  The prototype header for performing a distributed three-tuple
 *  GNPs.
 *
...
/** @brief The triple tree distributed algorithm generator.
 */
...
class DistributedTripletreeDfs {
  ...
  public:
     ...
     *         computation.
     */
    typedef typename core::gnp::TripletreeDfs<ProblemType>::FrontierObjectType
    FrontierObjectType;
  ...
  private:
     ...
     *         possible).
     */
    std::map<int, int> points_serialized_underneath_;

    /** @brief The list of unpruned triples of nodes.
     */
    std::vector < FrontierObjectType > unpruned_triple_nodes_;
