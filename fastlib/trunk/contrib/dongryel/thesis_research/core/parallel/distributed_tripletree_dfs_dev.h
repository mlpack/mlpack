/** @file distributed_tripletree_dfs_dev.h
 *
 *  The generic algorithm template for distributed triple-tree
 *  computation.
 *
 *  @author Dongryeol Lee (dongryel@cc.gatech.edu)
 */

#ifndef CORE_GNP_DISTRIBUTED_TRIPLETREE_DFS_DEV_H
#define CORE_GNP_DISTRIBUTED_TRIPLETREE_DFS_DEV_H
