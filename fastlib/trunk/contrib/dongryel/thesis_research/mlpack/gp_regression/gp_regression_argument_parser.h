/** @file gp_regression_argument_parser.h
 *
 *  The argument parsing for Gaussian process regression is handled
 *  here.
 *
 *  @author Dongryeol Lee (dongryel@cc.gatech.edu)
 */

#ifndef MLPACK_GP_REGRESSION_GP_REGRESSION_ARGUMENT_PARSER_H
#define MLPACK_GP_REGRESSION_GP_REGRESSION_ARGUMENT_PARSER_H
 ...
 */
class GpRegressionArgumentParser {
  public:
    static bool ConstructBoostVariableMap(
      ...
      desc.add_options()(
        ...
        "Metric type used by Gaussian process regression.  One of:\n"
        ...
        "Relative error for the approximation of Gaussian process regression."
      )(
