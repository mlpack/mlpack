...
#ifndef MLPACK_GP_REGRESSION_GP_REGRESSION_ARGUMENTS_H
#define MLPACK_GP_REGRESSION_GP_REGRESSION_ARGUMENTS_H
...
/** @brief The argument list for the Gaussian process regression.
 */
