...
class LocalRegressionPostponed {
  ...
  public:
     ...
     *         left hand side.
     */
    core::table::DenseMatrix left_hand_side_l_;

    /** @brief The finite-difference postponed quantities for the left
     *         hand side.
     */
    core::table::DenseMatrix left_hand_side_e_;

    /** @brief The upper bound on the postponed quantities for the
     *         left hand side.
     */
    core::table::DenseMatrix left_hand_side_u_;

    /** @brief The lower bound on the postponed quantities for the
     *         right hand side.
     */
    core::table::DensePoint right_hand_side_l_;

    /** @brief The finite-difference postponed quantities for the left
     *         right side.
     */
    core::table::DensePoint right_hand_side_e_;

    /** @brief The upper bound on the postponed quantities for the
     *         right hand side.
     */
    core::table::DensePoint right_hand_side_u_;
