/** @file distributed_allknn_arguments.h
 *
 *  @author Dongryeol Lee (dongryel@cc.gatech.edu)
 */

#ifndef MLPACK_DISTRIBUTED_ALLKNN_DISTRIBUTED_ALLKNN_ARGUMENTS_H
#define MLPACK_DISTRIBUTED_ALLKNN_DISTRIBUTED_ALLKNN_ARGUMENTS_H
...
class DistributedAllknnArguments {
  public:
  ...
  public:
    ...
    ~DistributedAllknnArguments() {
      ...
      // Assumes that distributed allknn argument is the last argument
