...
#ifndef MLPACK_GNP_DUALTREE_DFS_DEV_H
#define MLPACK_GNP_DUALTREE_DFS_DEV_H

#include "dualtree_dfs.h"
#include "dualtree_dfs_iterator_dev.h"

template<typename ProblemType>
ProblemType *ml::DualtreeDfs<ProblemType>::problem() {
  return problem_;
}

template<typename ProblemType>
typename ProblemType::TableType *ml::DualtreeDfs<ProblemType>::query_table() {
  return query_table_;
}

template<typename ProblemType>
typename ProblemType::TableType *
ml::DualtreeDfs<ProblemType>::reference_table() {
  return reference_table_;
}

template<typename ProblemType>
void ml::DualtreeDfs<ProblemType>::ResetStatistic() {
  ResetStatisticRecursion_(query_table_->get_tree(), query_table_);
}

template<typename ProblemType>
void ml::DualtreeDfs<ProblemType>::Init(ProblemType &problem_in) {
  problem_ = &problem_in;
...
void ml::DualtreeDfs<ProblemType>::Compute(
...
template<typename ProblemType>
void ml::DualtreeDfs<ProblemType>::ResetStatisticRecursion_(
...
template<typename ProblemType>
void ml::DualtreeDfs<ProblemType>::PreProcessReferenceTree_(
...
template<typename ProblemType>
void ml::DualtreeDfs<ProblemType>::PreProcess_(
...
template<typename ProblemType>
template<typename MetricType>
void ml::DualtreeDfs<ProblemType>::DualtreeBase_(
  MetricType &metric,
  typename ProblemType::TableType::TreeType *qnode,
  typename ProblemType::TableType::TreeType *rnode,
  typename ProblemType::ResultType *query_results) {
...
template<typename ProblemType>
template<typename MetricType>
bool ml::DualtreeDfs<ProblemType>::CanProbabilisticSummarize_(
  const MetricType &metric,
  typename ProblemType::TableType::TreeType *qnode,
  typename ProblemType::TableType::TreeType *rnode,
...
template<typename ProblemType>
bool ml::DualtreeDfs<ProblemType>::CanSummarize_(
  typename ProblemType::TableType::TreeType *qnode,
  typename ProblemType::TableType::TreeType *rnode,
...
void ml::DualtreeDfs<ProblemType>::ProbabilisticSummarize_(
...
template<typename ProblemType>
void ml::DualtreeDfs<ProblemType>::Summarize_(
  typename ProblemType::TableType::TreeType *qnode,
  const typename ProblemType::DeltaType &delta,
  typename ProblemType::ResultType *query_results) {
...
template<typename ProblemType>
template<typename MetricType>
void ml::DualtreeDfs<ProblemType>::Heuristic_(
  const MetricType &metric,
  typename ProblemType::TableType::TreeType *node,
...
template<typename ProblemType>
template<typename MetricType>
bool ml::DualtreeDfs<ProblemType>::DualtreeCanonical_(
  MetricType &metric,
  typename ProblemType::TableType::TreeType *qnode,
  typename ProblemType::TableType::TreeType *rnode,
  double failure_probability,
...
template<typename ProblemType>
template<typename MetricType>
void ml::DualtreeDfs<ProblemType>::PostProcess_(
  const MetricType &metric,
  typename ProblemType::TableType::TreeType *qnode,
  typename ProblemType::ResultType *query_results) {
