...
Nearly two million people in the US alone suffer from severe motor disabilities that render them incapable of communicating with the outside world \cite{ficke1992ddp, NABMRR1992, murray1997gmd, carter1997rmn}. Direct brain interfaces (DBIs) measure neural activation to provide a communication and control channel that is independent of muscle movement. To date, the best performance for a DBI communication system is 68 bits per minute (just over 8 characters per minute) \cite{gao2003bbe}, a rate attained using the Steady-State Visual Evoked Potential (SSVEP). While the progress made so far is notable, it pales in comparison to the transmission rates attained by signers and speakers (175-200 words per minute).
...
\section{Most Relevant Results from Prior NSF Support and Relation to Longer-term Goals of PI}

Starner's NSF Telesign grant developed the Segmentally Boosted
HMM-based sign language recognizer that will be adapted for this work.
This work extends Moore-Jackson's current DBI efforts in a new
direction and provides a new database for Starner's pattern
recognition and discovery.

\section{Plan of Work}

{\bf Month 1:} Choose signs and practice the experimental procedure.

\noindent {\bf Month 2-4:} Collect and analyze first fMRI dataset.

\noindent {\bf Month 5-11:} Iterate 2 more times on the experiment and analysis.

\noindent {\bf Month 12:} Report results and prepare for full proposal.
