...
\begin{proof}
  ...
  with
  \begin{eqnarray*}
    l & = & \ocpos{1}(\ocpos{1}(\simhrectmax(\sigma(Q),\sigma(R)) + \falphamin(\sigma(Q))) - \frhomax(\sigma(Q))) - \simhrectmax(\sigma(Q),\sigma(R)), \\
    u & = & \ocpos{1}(\ocpos{1}(\simhrectmin(\sigma(Q),\sigma(R)) + \falphamax(\sigma(Q))) - \frhomin(\sigma(Q))) - \simhrectmin(\sigma(Q),\sigma(R)).
  \end{eqnarray*}
