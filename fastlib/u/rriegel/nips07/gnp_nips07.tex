...
\begin{exampletheorem}[The Two-point Correlation Algorithm]
  The two-point correlation algorithm in Figure~\ref{fig:allnntpc} is
  derived from the GNA and intrinsicly prunes when considering regions
  shown to be completely inside or outside radius $r$ of one another.
\end{exampletheorem}
\killspace
\killspace
\begin{proof}
  ...
  Lemma~\ref{lem:intrinsic}, we may prune in these cases.  In order to
  use the GNA, we may trivially define $\otimeshat$ and $\odothat$ to
