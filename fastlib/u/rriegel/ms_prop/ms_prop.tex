...
\begin{figure}[tb]
  ...
  \begin{displaymath}
    \begin{array}{l}
      ...
      \push(\kdroot{Q},\kdroot{R}) \\
      \xwhile \pop(Q,R) \quad \text{// Main loop of } \kda
      ...
      \x \push(\kdleft{Q},\kdleft{R});\:\push(\kdleft{Q},\kdright{R})
      \x \push(\kdright{Q},\kdleft{R});\:\push(\kdright{Q},\kdright{R})
      \\ \\
