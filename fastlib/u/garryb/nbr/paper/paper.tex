...
under the model\footnote{In practice for Equation \ref{eqn:mu}, rules 1 and 3 are most accurate but only used in depth-first expansions, rule 5 is used only when no other information is available, and rule 4 is used primarily in breadth-first expansions.}:
\begin{itemize}
