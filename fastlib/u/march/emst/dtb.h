...
public:
   ...
   */
  void compute_neighbors_recursion(DTBTree *query_node, DTBTree *reference_node,
    ...
    // Other recursive calls
      ...
      if (left_dist < right_dist) {
        compute_neighbors_recursion(query_node, 
     ...
     //recurse on query_node only
      ...
      compute_neighbors_recursion(query_node->left(), 
                                  reference_node, left_dist);
      compute_neighbors_recursion(query_node->right(), 
  ...
  void ComputeNeighbors() {
    if (do_naive_) {
      ...
      compute_neighbors_recursion(tree_, tree_, DBL_MAX);
    }
   ...
   */
  void Cleanup_helper(DTBTree* tree) {
