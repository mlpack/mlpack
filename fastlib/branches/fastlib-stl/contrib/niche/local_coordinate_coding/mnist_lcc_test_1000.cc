...
void LearnWAndGetD(u32 digit_1, u32 digit_2,
  ...
  sprintf(dictionary_fullpath, 
	  "/scratch/niche/fastlib-stl/contrib/niche/local_coordinate_coding/fx/mnist_lcc/mnist/digit1_%d__digit2_%d__n_iterations_1000__n_atoms_%d__lambda_%g/D.dat",
