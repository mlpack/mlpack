...
void MLSampling::Init(fx_module *module, int *num_of_people, 
...
void MLSampling::Init2(fx_module *module, int *num_of_people, 
											double *initial_percent_sample,
											Vector *initial_parameter) {
	module_=module;
	const char *data_file1=fx_param_str_req(module_, "data1");
...
void MLSampling::Init3(fx_module *module, int *num_of_people, 
											double *initial_percent_sample,
...
void MLSampling::ExpandSubset(double percent_added_sample, ArrayList<Matrix> *added_first_stage_x,  
