...
class OriginalIFGT {
 ...
 public:
  ...
  void Init(Matrix &queries, Matrix &references, struct datanode *module_in) {
    ...
    printf("Automatic parameter selection phase...\n");
    ...
    printf("Chose %d clusters...\n", num_cluster_desired_);
    printf("Tentatively chose %d truncation order...\n", pterms_);
    ...
    printf("Now computing Taylor coefficients...\n");
    TaylorExpansion();
    printf("Taylor coefficient computation finished...\n");
