...
class HKInteriorPointPredictorCorrector{
 ...
 public:
  ...
  //calculate densities
  void ComputeDensitiesOfTestPoints_(){
	...
	total_contrib+=contrib_due_to_x_i;
      ...
      computed_test_densities_[test_pt]=total_contrib/num_train_points_;
    }
