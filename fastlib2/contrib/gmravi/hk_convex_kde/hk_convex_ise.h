...
class HkConvexIse{
  ...
  **/
  void FormQuadraticPartOfObjective_(){
    ...
    printf("Will form the quadratic part of the objective...\n");
    
    IChol ichol;
    ichol.Init(train_set_,sigma_h_,sigma_,lambda_);

    printf("Succesfully initalized all the stuff.....\n");
    ...
    printf("Back to the quad function...\n");
    ...
    printf("The eigen vectors are...\n");
    eigen_vectors_.PrintDebug();
    ...
    printf("The scaled eigen vectors are...\n");
    eigen_vectors_.PrintDebug(); 
  }
  ...
  void FormLinearPartOfObjective_(){
    ...
    printf("LInear part of the objective is...\n");
    At_linear_objective_.PrintDebug();
  }
  ...
  void FormLinearConstraint_(){
    ...
    for(index_t p=0;p<num_train_points_;p++){ ///THIS HAS TO CHANGE........................
      ...
      printf("Copying all entries into a matrix...\n");
      for(index_t q=p;q<num_train_points_;q++){
    ...
    printf("After All dual tree evaluations I have....\n");
    At_linear_constraint_.PrintDebug();
  }
  ...
  void FormLinearConstraintNaively_(){
	...
	double diff=fabs(At_linear_constraint_[row_num]-temp.get(p,q))/temp.get(p,q);
  ...
  void PerformSeDuMiOptimization_(){
    ...
    printf("Appended eigen vectors are...\n");
    appended_eigen_vectors.PrintDebug();
    ...
    Matrix temp3;
    if(special_la::StackMatrixMatrixInit(temp2,appended_eigen_vectors,&temp3)==FAILURE){

      printf("Matrices to be stacked have different number of columns...\n");
      exit(0);
    }

    printf("Having stacked all things I have....\n");
    temp3.PrintDebug();
    ...
    printf("The matrix to be dumped is...\n");
    temp5_print.PrintDebug();
...
//This function computes the optimal kernel from the hyper-kernel
  void ComputeOptimalKernel(){
    ...
    //FormLinearConstraintNaively_(); //THIS FUNCTION SHOULD GO......
