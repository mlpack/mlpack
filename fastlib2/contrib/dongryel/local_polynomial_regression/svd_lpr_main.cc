...
int main(int argc, char *argv[]) {
  ...
  // "--lpr/...=...".
  struct datanode *svd_lpr_module = fx_submodule(NULL, "lpr");
  ...
  // Declare local linear svd object.
  Vector fast_lpr_results;
  SvdLpr<EpanKernel> fast_lpr;
  fast_lpr.Init(references, reference_targets, svd_lpr_module);
