...
'Position',[9.8 39.4615384615385 20.2 3.92307692307692],...
...
'Position',[39.8 39.4615384615385 21.8 3.92307692307692],...
...
'Position',[79.8 39.4615384615385 20.2 3.92307692307692],...
...
'Units','characters',...
'ListboxTop',0,...
'Position',[9.8 43.3076923076923 20.2 1.46153846153846],...
...
'Units','characters',...
'ListboxTop',0,...
'Position',[39.8 43.3076923076923 20.2 1.46153846153846],...
'String','Neighbors',...
'Style','text',...
'Tag','neighbors');
...
'Units','characters',...
'ListboxTop',0,...
'Position',[79.8 43.3076923076923 20.2 1.46153846153846],...
'String','Algorithms',...
'Style','text',...
'Tag','algorithms');
...
%'Parent',h1,...
%'Units','characters',...
%'Callback','demo(''plot_Callback'',gcbo,[],guidata(gcbo))',...
%'ListboxTop',0,...
%'Position',[149.8 16.3846153846154 15.6 3],...
%'String','plot',...
%'Tag','plot');
...
'ListboxTop',0,...
'Position',[9.8 37.7692307692308 13.2 1.76923076923077],...
'String','go',...
'Tag','go1');
...
'ListboxTop',0,...
'Position',[39.8 37.7692307692308 13.2 1.76923076923077],...
'String','go',...
'Tag','go2');
...
'ListboxTop',0,...
'Position',[79.8 37.7692307692308 13.2 1.76923076923077],...
'String','go',...
'Tag','go3');
...
'ListboxTop',0,...
'Position',[61.8 42.0769230769231 8.2 1.30769230769231],...
'String','knn',...
'Style','edit',...
...
'Units','characters',...
'ListboxTop',0,...
'Position',[59.8 43.2307692307692 10.2 1.15384615384615],...
'String','knn',...
'Style','text',...
'Tag','knn');
...
'ListboxTop',0,...
'Position',[103 42.071 10.833 1.571],...
'String','bandwidth',...
'Style','edit',...
...
'Units','characters',...
'ListboxTop',0,...
'Position',[102.33 43.571 11.667 1.143],...
'String','bandwidth',...
'Style','text',...
'Tag','bandwidth');
