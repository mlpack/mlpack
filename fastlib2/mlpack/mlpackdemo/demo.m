...
'ListboxTop',0,...
'Position',[0.466 0.851 0.072 0.025],...
'String','store_range',...
'Tag','store_range');
...
'ListboxTop',0,...
'Position',[0.289 0.925 0.041 0.02],...
'String','knn',...
'Style','edit',...
...
'ListboxTop',0,...
'Position',[0.289 0.866 0.054 0.024],...
'String','bandwidth',...
'Style','edit',...
...
'ListboxTop',0,...
'Position',[0.467 0.921 0.054 0.024],...
'String','',...
'Style','edit',...
...
'ListboxTop',0,...
'Position',[0.537 0.921 0.054 0.024],...
'String','',...
'Style','edit',...
...
'ListboxTop',0,...
'Position',[0.469 0.889 0.054 0.024],...
'String','',...
'Style','edit',...
...
'ListboxTop',0,...
'Position',[0.537 0.889 0.054 0.024],...
'String','',...
'Style','edit',...
