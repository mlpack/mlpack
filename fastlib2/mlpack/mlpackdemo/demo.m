...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
tmp_lower_vector = [handles.range11 ; handles.range21];
tmp_upper_vector = [handles.range12 ; handles.range22];
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
ComputeAlgorithms(handles.data_file1, handles.dim_reduction,...
    hObject, handles);
...
handles.knn1 = str2num(get(hObject, 'String'));
guidata(hObject, handles);
...
handles.bandwidth1 = str2num(get(hObject, 'String'));
guidata(hObject, handles);
...
% Hints: get(hObject,'String') returns contents of bandwidth1 as text
%        str2double(get(hObject,'String')) returns contents of bandwidth1 as a double
handles.range11 = str2num(get(hObject, 'String'));
...
% Hints: get(hObject,'String') returns contents of bandwidth1 as text
%        str2double(get(hObject,'String')) returns contents of bandwidth1 as a double
handles.range12 = str2num(get(hObject, 'String'));
if isfield(handles, 'lower_ranges') == 0
    handles.lower_ranges = [];
end;
if isfield(handles, 'upper_ranges') == 0
...
% Hints: get(hObject,'String') returns contents of bandwidth1 as text
%        str2double(get(hObject,'String')) returns contents of bandwidth1 as a double
handles.range21 = str2num(get(hObject, 'String'));
if isfield(handles, 'lower_ranges') == 0
    handles.lower_ranges = [];
end;
if isfield(handles, 'upper_ranges') == 0
...
% Hints: get(hObject,'String') returns contents of bandwidth1 as text
%        str2double(get(hObject,'String')) returns contents of bandwidth1 as a double
handles.range22 = str2num(get(hObject, 'String'));
if isfield(handles, 'lower_ranges') == 0
    handles.lower_ranges = [];
end;
if isfield(handles, 'upper_ranges') == 0
...
'Position',[128.6 7 168.4 47.3076923076923],...
...
'Position',[8.167 39.714 20.167 3.929],...
...
'Position',[33.167 39.714 21.833 3.929],...
...
'Position',[71.5 39.714 20.167 3.929],...
...
'Units','characters',...
'ListboxTop',0,...
'Position',[9.8 34.0769230769231 20.2 2.46153846153846],...
'String','Data file',...
'Style','text',...
'Tag','data_file');
...
'Position',[9.8 31.7692307692308 100.2 3.38461538461538],...
'String',GetDataFiles(),...
'Style','listbox',...
...
'Units','characters',...
'ListboxTop',0,...
'Position',[8.167 43.571 20.167 1.429],...
...
'Units','characters',...
'ListboxTop',0,...
'Position',[33.167 43.571 20.167 1.429],...
'String','Neighbors',...
'Style','text',...
'Tag','neighbors');
...
'Units','characters',...
'ListboxTop',0,...
'Position',[71.5 43.571 20.167 1.429],...
'String','Algorithms',...
'Style','text',...
'Tag','algorithms');
...
'ListboxTop',0,...
'Position',[93.833 37.5 14.5 1.643],...
'String','store_range',...
'Tag','store_range');
...
'ListboxTop',0,...
'Position',[8.167 37.357 13.167 1.786],...
'String','go',...
'Tag','go1');
...
'ListboxTop',0,...
'Position',[33.167 37.429 13.167 1.786],...
'String','go',...
'Tag','go2');
...
'ListboxTop',0,...
'Position',[71.833 37.357 13.167 1.786],...
'String','go',...
'Tag','go3');
...
'ListboxTop',0,...
'Position',[58.167 42.357 8.167 1.286],...
'String','knn',...
'Style','edit',...
...
'Units','characters',...
'ListboxTop',0,...
'Position',[58.167 43.571 10.167 1.143],...
'String','knn',...
'Style','text',...
'Tag','knn');
...
'ListboxTop',0,...
'Position',[58.167 38.5 10.833 1.571],...
'String','bandwidth',...
'Style','edit',...
...
'Units','characters',...
'ListboxTop',0,...
'Position',[58.167 40 11.667 1.143],...
'String','bandwidth',...
'Style','text',...
'Tag','bandwidth');
...
'Units','characters',...
'ListboxTop',0,...
'Position',[94.167 43.571 11.667 1.143],...
'String','range',...
'Style','text',...
'Tag','range');
...
'ListboxTop',0,...
'Position',[94.167 42.071 10.833 1.571],...
'String','',...
'Style','edit',...
...
'ListboxTop',0,...
'Position',[108.167 42.071 10.833 1.571],...
'String','',...
'Style','edit',...
...
'ListboxTop',0,...
'Position',[108.167 40 10.833 1.571],...
'String','',...
'Style','edit',...
...
'Units','characters',...
'ListboxTop',0,...
'Position',[8.167 27.429 100.167 1.929],...
'String','current data file: unselected',...
'Style','text',...
'Tag','current_dataset');
