...
% Last Modified by GUIDE v2.5 30-Nov-2008 17:19:34
...
handles.dim_reduction=get(hObject,'Value');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
DimRedution(handles.data_file, handles.dimensionality_reduction);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
Neighbors(handles.data_file, handles.neighbors, handles.knns);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
Algoritms(handles.data_file,handles.algorithm);
...
handles.knns=str2double(get(hObject,'String')) ;
...
'String',{ 'Exact knn' 'Approximate knn' },...
'Style','listbox',...
'Value',1,...
...
'String',{ 'KPCA' 'KDE' 'Range search' 'NBC' 'Decision Trees' },...
'Style','listbox',...
'Value',1,...
...
h7 = uimenu(...
'Parent',h1,...
'Callback','demo_export(''FileMenu_Callback'',gcbo,[],guidata(gcbo))',...
'Label','File',...
'Tag','FileMenu');

h8 = uimenu(...
'Parent',h7,...
'Callback','demo_export(''OpenMenuItem_Callback'',gcbo,[],guidata(gcbo))',...
'Label','Open ...',...
'Tag','OpenMenuItem');

h9 = uimenu(...
'Parent',h7,...
'Callback','demo_export(''PrintMenuItem_Callback'',gcbo,[],guidata(gcbo))',...
'Label','Print ...',...
'Tag','PrintMenuItem');

h10 = uimenu(...
'Parent',h7,...
'Callback','demo_export(''CloseMenuItem_Callback'',gcbo,[],guidata(gcbo))',...
'Label','Close',...
'Separator','on',...
'Tag','CloseMenuItem');
...
'Parent',h1,...
'Units','characters',...
'Callback','demo_export(''dim_reduction_Callback'',gcbo,[],guidata(gcbo))',...
'Position',[9.8 39.4615384615385 20.2 3.92307692307692],...
'String',{ 'PCA' 'MVU' },...
'Style','listbox',...
'Value',1,...
'CreateFcn','demo_export(''dim_reduction_CreateFcn'',gcbo,[],guidata(gcbo))',...
'Tag','dim_reduction');
...
'Parent',h1,...
'Units','characters',...
'Callback','demo_export(''neighbors_Callback'',gcbo,[],guidata(gcbo))',...
'Position',[39.8 39.4615384615385 21.8 3.92307692307692],...
'String',{ 'Exact knn' 'Approximate knn' },...
'Style','listbox',...
'Value',1,...
'CreateFcn','demo_export(''neighbors_CreateFcn'',gcbo,[],guidata(gcbo))',...
'Tag','neighbors');
...
'Parent',h1,...
'Units','characters',...
'Callback','demo_export(''algorithms_Callback'',gcbo,[],guidata(gcbo))',...
'Position',[79.8 39.4615384615385 20.2 3.92307692307692],...
'String',{ 'KPCA' 'KDE' 'Range search' 'NBC' 'Decision Trees' },...
'Style','listbox',...
'Value',1,...
'CreateFcn','demo_export(''algorithms_CreateFcn'',gcbo,[],guidata(gcbo))',...
'Tag','algorithms');
...
'Units','characters',...
'BackgroundColor',[1 1 1],...
'Callback','demo_export(''data_file1_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
'Position',[9.8 31.7692307692308 20.2 1.38461538461538],...
'String','Data file',...
'Style','edit',...
'CreateFcn','demo_export(''data_file1_CreateFcn'',gcbo,[],guidata(gcbo))',...
'Tag','data_file1');
...
'Parent',h1,...
'Units','characters',...
'Callback','demo_export(''plot_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
'Position',[149.8 16.3846153846154 15.6 3],...
'String','plot',...
'Tag','plot');
...
'Parent',h1,...
'Units','characters',...
'Callback','demo_export(''go1_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
'Position',[9.8 37.7692307692308 13.2 1.76923076923077],...
'String','go',...
'Tag','go1');
...
'Parent',h1,...
'Units','characters',...
'Callback','demo_export(''go2_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
'Position',[39.8 37.7692307692308 13.2 1.76923076923077],...
'String','go',...
'Tag','go2');
...
'Parent',h1,...
'Units','characters',...
'Callback','demo_export(''go3_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
'Position',[79.8 37.7692307692308 13.2 1.76923076923077],...
'String','go',...
'Tag','go3');
...
'Units','characters',...
'BackgroundColor',[1 1 1],...
'Callback','demo_export(''knn1_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
'Position',[61.8 42.0769230769231 8.2 1.30769230769231],...
'String','knn',...
'Style','edit',...
'CreateFcn','demo_export(''knn1_CreateFcn'',gcbo,[],guidata(gcbo))',...
'Tag','knn1');
