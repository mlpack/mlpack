...
class VariableNNKDE{
 ...
 void ComputeTestDensities(){
  ...
  void PerformLSCV(){
    ...
    for(index_t k=2;k<=max_number_of_neighbours_;k++){
  ...
  void Init(struct datanode *module_in){
    ...
    max_number_of_neighbours_=fx_param_int(module_,"max_number_of_neighbours",num_train_points_/4);
    number_of_global_smoothing_values_=fx_param_int(module_,"number_of_global_smoothing_values",500);
