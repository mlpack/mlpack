...
private:
  ...
  size_t knns_;
  size_t leaf_size_;
  size_t num_of_labeled_;
  size_t num_of_unlabeled_;
  size_t labeled_offset_;
  size_t unlabeled_offset_;
...
public:
  ...
  void GiveInitMatrix(Matrix *init_matrix);
 size_t num_of_points();
 void anchors(ArrayList<size_t> *anch);
