...
macro(search_openblas version)
  ...
  if (NOT BLAS_FOUND OR (NOT BLAS_LIBRARIES))
    ...
    if (NOT MSVC)
      if (NOT EXISTS "${MLPACK_BINARY_DIR}/deps/OpenBLAS-${version}/libopenblas.a")
        ...
        execute_process(COMMAND make TARGET=${OPENBLAS_TARGET} BINARY=${OPENBLAS_BINARY} HOSTCC=gcc CC=${CMAKE_C_COMPILER} FC=${CMAKE_FORTRAN_COMPILER} NO_SHARED=1
                        WORKING_DIRECTORY ${MLPACK_BINARY_DIR}/deps/OpenBLAS-${version})
      endif()
      file(GLOB OPENBLAS_LIBRARIES "${MLPACK_BINARY_DIR}/deps/OpenBLAS-${version}/libopenblas.a")
