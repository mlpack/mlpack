...
message(STATUS "SHow me the wrapper: ${_ARMA_USE_WRAPPER}")
...
if(NOT _ARMA_USE_WRAPPER OR MSVC)
  ...
  if(_ARMA_USE_BLAS)
    if(ARMADILLO_FIND_QUIETLY OR NOT ARMADILLO_FIND_REQUIRED)
      ...
      message(STATUS "EXECUTED 1")
    else()
      message(STATUS "EXECUTED 2")
      find_package(BLAS REQUIRED)
    endif()
    message(STATUS "PRINT BLAS STATUS: ${BLAS_FOUND}")
    message(STATUS "PRINT BLAS LIBRARIES STATUS: ${BLAS_LIBRARIES}")
    if(BLAS_FOUND)
      set(_ARMA_SUPPORT_LIBRARIES "${_ARMA_SUPPORT_LIBRARIES}" "${BLAS_LIBRARIES}")
      message(STATUS "EXECUTED 3")
      message(STATUS "BLAS LIBRARIES 123: ${BLAS_LIBRARIES}")
    endif()
  endif()
  if(_ARMA_USE_ARPACK)
    if(ARMADILLO_FIND_QUIETLY OR NOT ARMADILLO_FIND_REQUIRED)
