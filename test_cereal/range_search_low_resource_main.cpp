...
int main()
{
  ...
  // if (CMD::HasParam("min") || CMD::HasParam("max"))
  // {
  ...
  //     (CMD::HasParam("min") || CMD::HasParam("max")))
  // {
  ...
  // int lsInt = CMD::GetParam<int>("leaf_size");
  ...
  // const bool singleMode = CMD::HasParam("single_mode");
  ...
  //   const bool randomBasis = CMD::HasParam("random_basis");
  ...
  //   arma::mat referenceSet = std::move(CMD::GetParam<arma::mat>("reference"));
  ...
  // {
  //   // Load the model from file.
  //   rs = CMD::GetParam<RSModel*>("input_model");

  //   Log::Info << "Using range search model from '"
  //       << CMD::GetPrintableParam<RSModel*>("input_model") << "' ("
  //       << "trained on " << rs->Dataset().n_rows << "x" << rs->Dataset().n_cols
  //       << " dataset)." << endl;

  //   // Adjust singleMode and naive if necessary.
  //   rs->SingleMode() = CMD::HasParam("single_mode");
  //   rs->Naive() = CMD::HasParam("naive");
  ...
  // if (CMD::HasParam("min") || CMD::HasParam("max"))
  // {
  //   const double min = CMD::GetParam<double>("min");
  //   const double max = CMD::HasParam("max") ? CMD::GetParam<double>("max") :
  //       DBL_MAX;
  ...
  //   if (CMD::HasParam("distances_file"))
  //   {
  //     const string distancesFile = CMD::GetParam<string>("distances_file");
  ...
  //   if (CMD::HasParam("neighbors_file"))
  //   {
  //     const string neighborsFile = CMD::GetParam<string>("neighbors_file");
  ...
  // CMD::GetParam<RSModel*>("output_model") = rs;
}
