...
/**
 * Loads a matrix with image. It also supports loading image from an entire directory.
...
public:
	 ...
	 */
	void Load(std::string fileName, arma::Mat<unsigned char>&& outputMatrix);
	 ...
	 * @param outputMatrix Matrix to load into.
	 */
	void LoadDir(std::string dirPath, arma::Mat<unsigned char>&& outputMatrix);
