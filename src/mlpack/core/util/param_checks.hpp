 ...
 * passed to the CMD object; otherwise, issue a warning or fatal error,
 * optionally with the given custom error message.
 *
 * This uses the correct binding type name for each parameter (i.e.
 * '--parameter' for CMD bindings, 'parameter' for Python bindings).
 *
 ...
 * set were passed to the CMD object; otherwise, issue a warning or fatal error,
 * optionally with the given custom error message.
 *
 * This uses the correct binding type name for each parameter (i.e.
 * '--parameter' for CMD bindings, 'parameter' for Python bindings).
