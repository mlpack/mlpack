 ...
 */
#ifndef MLPACK_CORE_UTILITIES_TIMERS_IMPL_HPP
#define MLPACK_CORE_UTILITIES_TIMERS_IMPL_HPP
...
inline std::string Timers::Print(const std::chrono::microseconds& totalDuration)
{
  ...
  std::chrono::hours h = 
      std::chrono::duration_cast<std::chrono::hours>(totalDuration % days(1));
