 ...
 *
 * Defines the DualTreeTraverser for the VantagePointTree tree type.  This is a
 * nested class of VantagePointTree which traverses two trees in a depth-first
 * manner with a given set of rules which indicate the branches which can be
 * pruned and the order in which to recurse.
 */
#ifndef MLPACK_CORE_TREE_VANTAGE_POINT_TREE_DUAL_TREE_TRAVERSER_HPP
                      ...
                      SplitType>::DualTreeTraverser
{
 public:
   ...
   */
  void Traverse(VantagePointTree& queryNode,
...
#endif // MLPACK_CORE_TREE_VANTAGE_POINT_TREE_DUAL_TREE_TRAVERSER_HPP
