 ...
 * updates learning rate dynamically by adapting to the data.
 *
...
/**
 * Adagrad is an optimizer that updates learning rate dynamically by adapting to
 * the data.
 *
 ...
 * For Adagrad to work, a DecomposableFunctionType template parameter is required.
...
class AdaGrad
{
 public:
  /**
   * Construct the AdaGrad optimizer with the given function and parameters.  The
