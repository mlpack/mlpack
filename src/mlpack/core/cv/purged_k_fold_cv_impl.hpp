...
template<typename MLAlgorithm,
  ...
  typename PredictionsType,
  typename WeightsType>
size_t PurgedKFoldCV<MLAlgorithm,
  Metric,
  MatType,
  PredictionsType,
...
arma::Mat<ElementType> PurgedKFoldCV<MLAlgorithm,
  Metric,
  MatType,
  PredictionsType,
...
template<typename MLAlgorithm,
  ...
  typename WeightsType>
template<typename ElementType>
arma::Row<ElementType> PurgedKFoldCV<MLAlgorithm,
  Metric,
  MatType,
  PredictionsType,
...
template<typename MLAlgorithm,
  ...
  typename PredictionsType,
  typename WeightsType>
void PurgedKFoldCV<MLAlgorithm,
  Metric,
  MatType,
  PredictionsType,
...
template<typename MLAlgorithm,
  ...
  typename PredictionsType,
  typename WeightsType>
arma::span PurgedKFoldCV<MLAlgorithm,
  Metric,
  MatType,
  PredictionsType,
  WeightsType>::GetValidationSubsetCols(size_t i) const
{
  ...
  return arma::span(firstCol,
    std::min(firstCol + binSize, (k - 1) * binSize + lastBinSize) - 1);
}
...
template<typename MLAlgorithm,
  ...
  typename PredictionsType,
  typename WeightsType>
arma::uvec PurgedKFoldCV<MLAlgorithm,
  Metric,
  MatType,
  PredictionsType,
  WeightsType>::GetTrainingSubsetCols(size_t i) const
{
  ...
  const arma::uword datasetSize((k - 1) * binSize + lastBinSize);
  ...
  if (trainingSubsetFirstCol < datasetSize) {
    ...
    trainingSubset.rows(trainingSubsetSize, trainingSubsetSize + n - 1) =
      arma::linspace<arma::uvec>(trainingSubsetFirstCol,
                                 datasetSize - 1,
                                 n);
