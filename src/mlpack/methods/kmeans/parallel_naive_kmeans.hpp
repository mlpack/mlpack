/**
 * @file parallel_naive_kmeans.hpp
 * @author Ryan Curtin
 ...
 */
#ifndef MLPACK_METHODS_KMEANS_PARALLEL_NAIVE_KMEANS_HPP
#define MLPACK_METHODS_KMEANS_PARALLEL_NAIVE_KMEANS_HPP
 ...
 * can be used by KMeans as the actual implementation of the Lloyd iteration.
 *
