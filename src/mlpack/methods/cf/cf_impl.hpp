...
CF<DecompositionPolicy>::CF(const size_t numUsersForSimilarity,
       const size_t rank) :
...
CF<DecompositionPolicy>::CF(mat_type const& data,
...
template<typename DecompositionPolicy>
template<typename mat_type>
void CF<DecompositionPolicy>::Apply(mat_type const& data,
...
template<typename DecompositionPolicy>
void CF<DecompositionPolicy>::GetRecommendations(const size_t numRecs,
...
template<typename DecompositionPolicy>
void CF<DecompositionPolicy>::Predict(const arma::Mat<size_t>& combinations,
