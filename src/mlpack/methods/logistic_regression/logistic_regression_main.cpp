...
BINDING_LONG_DESC(
    ...
    PRINT_PARAM_STRING("input_model") + " parameter) "
                                        ...
                                        "with the " +
    PRINT_PARAM_STRING("training") + " parameter), or both "
    ...
    PRINT_PARAM_STRING("step_size") + " parameter controls the step size taken "
                                      ...
                                      "with the " +
    PRINT_PARAM_STRING("batch_size") + " parameter. If the "
    ...
    PRINT_PARAM_STRING("test") + " is "
                                 "specified.  The " +
    PRINT_PARAM_STRING("test") + " parameter can be "
    ...
    "either " +
    STRINGIFY(BINDING_MIN_LABEL) + " or " +
...
void BINDING_FUNCTION(util::Params &params, util::Timers &timers)
{
  ...
  RequireAtLeastOnePassed(params, {"output_model", "predictions", "probabilities"}, false, "no output will be saved");
