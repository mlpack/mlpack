...
template<typename InputDataType, typename OutputDataType>
MeanPooling<InputDataType, OutputDataType>::MeanPooling(const size_t kW,
                                                        const size_t kH,
                                                        const size_t dW,
                                                        const size_t dH,
                                                        const bool floor)
  : kW(kW), kH(kH), dW(dW), dH(dH), inputWidth(0), inputHeight(0),
    outputWidth(0), outputHeight(0), reset(false), floor(floor),
