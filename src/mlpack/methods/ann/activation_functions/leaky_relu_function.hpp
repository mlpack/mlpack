 ...
 */
#ifndef __MLPACK_METHODS_ANN_ACTIVATION_FUNCTIONS_LEAKYRELU_FUNCTION_HPP
#define __MLPACK_METHODS_ANN_ACTIVATION_FUNCTIONS_LEAKYRELU_FUNCTION_HPP
...
class LeakyReLUFunction
{
 public:
  ...
  LeakyReLUFunction(const double a = 0.03) : alpha(a)
  {
     // Nothing to do here.
  }
