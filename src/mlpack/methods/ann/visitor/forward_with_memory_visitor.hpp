 ...
 */
#ifndef MLPACK_METHODS_ANN_VISITOR_FORWARD_WITH_MEMORY_VISITOR_HPP
#define MLPACK_METHODS_ANN_VISITOR_FORWARD_WITH_MEMORY_VISITOR_HPP
...
#include "forward_with_memory_visitor_impl.hpp"
