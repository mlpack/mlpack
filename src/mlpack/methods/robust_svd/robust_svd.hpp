 ...
 * @author Charan Reddy
 *
 * An implementation of the robust method
 *
...
#ifndef MLPACK_METHODS_ROBUST_SVD_ROBUST_SVD_HPP
#define MLPACK_METHODS_ROBUST_SVD_ROBUST_SVD_HPP
...
/**
 * Robust SVD is a matrix factorization that is based on robust matrix
 ...
 *   title   = {An implementation of a robust algorithm for principal
                component analysis},
 *   journal = {CoRR},
...
class RobustSVD
{
 public:
  /**
   * Create object for the robust SVD method.
   *
   ...
   *        stability).
   */
  RobustSVD(const size_t iteratedPower = 0,
                const size_t maxIterations = 2,
                const double eps = 1e-7);
