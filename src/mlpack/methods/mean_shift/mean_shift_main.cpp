...
PROGRAM_INFO(
    ...
    "This program performs mean shift "
    ...
    "The input dataset should be specified with the "
        ...
        + " parameter, and the radius used for search"
          " can be specified with the "
        + PRINT_PARAM_STRING("radius")
        + " "
          "parameter.  The maximum number of iterations before algorithm "
          "termination "
        ...
        + " "
          "parameter."
          "\n\n"
          "The output labels may be saved with the "
        + PRINT_PARAM_STRING("output")
        + " output parameter and the centroids of each cluster may be saved "
          "with the"
          " "
        + PRINT_PARAM_STRING("centroid")
        + " output parameter."
          "\n\n"
          "For example, to run mean shift clustering on the dataset "
        + PRINT_DATASET("data")
        + " and store the centroids to "
...
PARAM_MATRIX_OUT("centroid",
                 ...
                 "be written to the given matrix.",
                 "C");
...
PARAM_DOUBLE_IN(
    "radius",
    "If the distance between two centroids is less than "
    "the given radius, one will be removed.  A radius of 0 or less means an "
    "estimate will be calculated and used for the radius.",
    "r",
    0);
