/**
 * @file methods/hoeffding_trees/hoeffding_tree_classify_main.cpp
 * @author Ryan Curtin
 * @author Dirk Eddelbuettel
 *
 * Given a trained Hoeffding trees model, predict from the model on new data.
 *
...
#undef BINDING_NAME
#define BINDING_NAME hoeffding_tree_classify
...
// Program Name.
BINDING_USER_NAME("Hoeffding trees Classification");

// Short description.
BINDING_SHORT_DESC("Class predictions from Hoeffding trees model.");
