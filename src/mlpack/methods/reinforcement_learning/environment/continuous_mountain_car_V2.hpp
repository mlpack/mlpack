/**
 * @file continuous_mountain_car_V2.hpp
 * @author Abhinav Sagar
 *
 * This file is an implementation of Continous Mountain CarV2 task:
...
/**
 * Implementation of Continuous Mountain Car task V2.
 */
class ContinuousMountainCarV2
{
 public:
  ...
  /**
   * Implementation of action of Continuous Mountain CarV2.
  ...
  /**
   * Construct a Continuous Mountain Car V2 instance using the given constant.
   *
   ...
   */
  ContinuousMountainCarV2(const double positionMin = -1.2,
  ...
  /**
   * Dynamics of Continuous Mountain CarV2. Get reward and next state based
  ...
  /**
   * Dynamics of Continuous Mountain Car V2. Get reward based on current state and current
   * action.
   *
   * @param state The current state.
   * @param action The current action.
  ...
  {
    ContinuousMountainCarV2 ob = new ContinuousMountainCarV2(positionMin,
                                                           positionMax,
                                                           positionGoal,
                                                           velocityMin,
                                                           velocityMax,
