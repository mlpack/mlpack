/**
 * @file methods/linear_svm/kernel_svm_function.hpp
 * @author Himanshu Pathak
 *
 * Implementation of the hinge loss function for training a kernel SVM.
 *
 ...
 */
#ifndef MLPACK_METHODS_KERNEL_SVM_KERNEL_SVM_FUNCTION_HPP
#define MLPACK_METHODS_KERNEL_SVM_KERNEL_SVM_FUNCTION_HPP
...
/**
 * The kernel SVM objective function.
...
class KernelSVMFunction
{
 public:
  /**
   * Construct the Kernel SVM objective function with given parameters.
   *
   ...
   */
  KernelSVMFunction(const MatType& dataset,
  ...
  /**
   * Initialize Kernel SVM weights (trainable parameters) with the given
   * parameters.
   *
   ...
   * KernelFunctionType requirements on the Gradient function.
   *
   ...
   * the KernelFunctionType requirements on the Gradient function.
   *
   * @tparam GradType Type of the gradient matrix.
   * @param parameters The parameters of the SVM.
...
#endif // MLPACK_METHODS_KERNEL_SVM_KERNEL_SVM_FUNCTION_HPP
