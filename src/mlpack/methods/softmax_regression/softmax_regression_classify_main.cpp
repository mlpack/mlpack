/**
 * @file methods/softmax_regression/softmax_regression_classify_main.cpp
 *
...
#undef BINDING_NAME
#define BINDING_NAME softmax_regression_classify
...
void BINDING_FUNCTION(util::Params& params, util::Timers& timers)
{
  ...
  RunPredictionStep(params, timers, sm->NumClasses(), *sm, true, false);
}
