...
BOOST_AUTO_TEST_CASE(SVDBatchMomentumTest)
{
  ...
  AMF<ValidationRMSETermination<sp_mat>,
      ...
      SVDBatchLearning>
      amf1(vrt, sri, SVDBatchLearning(0.0009, 0, 0, 0));
  ...
  AMF<ValidationRMSETermination<sp_mat>,
      SpecificRandomInitialization,
      SVDBatchLearning>
      amf2(vrt, sri, SVDBatchLearning(0.0009, 0, 0, 0.8));
...
BOOST_AUTO_TEST_CASE(SVDBatchRegularizationTest)
{
  ...
  AMF<ValidationRMSETermination<sp_mat>,
      SpecificRandomInitialization,
      SVDBatchLearning>
      amf2(vrt, sri, SVDBatchLearning(0.0009, 0.5, 0.5, 0.8));
...
BOOST_AUTO_TEST_CASE(SVDBatchNegativeElementTest)
{
  ...
  AMF<SimpleToleranceTermination<mat>, RandomInitialization, SVDBatchLearning>
