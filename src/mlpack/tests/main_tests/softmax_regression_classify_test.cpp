/**
 * @file tests/main_tests/softmax_regression_classify_test.cpp
 * @author Manish Kumar
 * @author Dirk Eddelbuettel
 *
 * Test RUN_BINDING() of softmax_regression_classify_main.cpp.
 *
...
#include <mlpack/methods/softmax_regression/softmax_regression_classify_main.cpp>
...
BINDING_TEST_FIXTURE(SoftmaxRegressionClassifyTestFixture);

/**
  * Ensuring that absence of input model is checked.
 **/
TEST_CASE_METHOD(SoftmaxRegressionClassifyTestFixture,
                 "SoftmaxRegressionClassifyNoModel",
                 "[SoftmaxRegressionClassifyMainTest][BindingTests]")
{
  constexpr int D = 3;
  constexpr int M = 15;
 ...
 **/
TEST_CASE_METHOD(SoftmaxRegressionClassifyTestFixture,
                 "SoftmaxRegressionClassifyEmptyModel",
                 "[SoftmaxRegressionClassifyMainTest][BindingTests]")
{
  constexpr int D = 3;
  constexpr int M = 15;
 ...
 **/
TEST_CASE_METHOD(SoftmaxRegressionClassifyTestFixture,
                 "SoftmaxRegressionClassifyNoData",
                 "[SoftmaxRegressionClassifyMainTest][BindingTests]")
{
  constexpr int N = 10;
  constexpr int D = 3;
 ...
 **/
TEST_CASE_METHOD(SoftmaxRegressionClassifyTestFixture,
                 "SoftmaxRegressionClassifyWrongSizeData",
                 "[SoftmaxRegressionClassifyMainTest][BindingTests]")
{
  constexpr int N = 10;
  constexpr int D = 3;
 ...
 **/
TEST_CASE_METHOD(SoftmaxRegressionClassifyTestFixture,
                 "SoftmaxRegressionClassifyPredictionSize",
                 "[SoftmaxRegressionClassifyMainTest][BindingTests]")
{
  constexpr int N = 10;
  constexpr int D = 3;
