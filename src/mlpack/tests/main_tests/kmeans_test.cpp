...
BOOST_AUTO_TEST_CASE(KmClusteringSizeCheck)
{
  ...
  BOOST_REQUIRE_EQUAL(CMD::GetParam<arma::mat>("output").n_rows, row+1);
  BOOST_REQUIRE_EQUAL(CMD::GetParam<arma::mat>("output").n_cols, col);
  BOOST_REQUIRE_EQUAL(CMD::GetParam<arma::mat>("centroid").n_rows, row);
  BOOST_REQUIRE_EQUAL(CMD::GetParam<arma::mat>("centroid").n_cols, c);
}
...
BOOST_AUTO_TEST_CASE(KmClusteringEmptyClustersCheck)
{
  ...
  normalOutput = std::move(CMD::GetParam<arma::mat>("centroid"));
  ...
  allowEmptyOutput = std::move(CMD::GetParam<arma::mat>("centroid"));
  ...
  killEmptyOutput = std::move(CMD::GetParam<arma::mat>("centroid"));
...
BOOST_AUTO_TEST_CASE(KmClusteringResultSizeCheck)
{
  ...
  mlpackMain();
  arma::mat processedInput = CMD::GetParam<arma::mat>("output");
...
BOOST_AUTO_TEST_CASE(AlgorithmsSimilarTest)
{
  ...
  naiveOutput = std::move(CMD::GetParam<arma::mat>("output"));
  naiveCentroid = std::move(CMD::GetParam<arma::mat>("centroid"));
  ...
  elkanOutput = std::move(CMD::GetParam<arma::mat>("output"));
  elkanCentroid = std::move(CMD::GetParam<arma::mat>("centroid"));
  ...
  hamerlyOutput = std::move(CMD::GetParam<arma::mat>("output"));
  hamerlyCentroid = std::move(CMD::GetParam<arma::mat>("centroid"));
  ...
  dualTreeOutput = std::move(CMD::GetParam<arma::mat>("output"));
  dualTreeCentroid = std::move(CMD::GetParam<arma::mat>("centroid"));
  ...
  dualCoverTreeOutput = std::move(CMD::GetParam<arma::mat>("output"));
  dualCoverTreeCentroid = std::move(CMD::GetParam<arma::mat>("centroid"));
