...
BOOST_AUTO_TEST_CASE(RandomForestModelReuseTest)
{
  ...
  SetInputParam("input_model",
                CMD::GetParam<RandomForestModel*>("output_model"));
...
BOOST_AUTO_TEST_CASE(RandomForestDiffMinLeafSizeTest)
{
  ...
  RandomForestModel* rf1 =
      std::move(CMD::GetParam<RandomForestModel*>("output_model"));
  CMD::GetParam<RandomForestModel*>("output_model") = NULL;
...
BOOST_AUTO_TEST_CASE(RandomForestDiffNumTreeTest)
{
  ...
  const size_t numTrees1 =
      CMD::GetParam<RandomForestModel*>("output_model")->rf.NumTrees();
