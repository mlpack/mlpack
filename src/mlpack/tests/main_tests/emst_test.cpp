...
BOOST_AUTO_TEST_CASE(EMSTOutputDimensionTest)
{
  ...
  BOOST_REQUIRE_EQUAL(CLI::GetParam<arma::mat>("predictions").n_cols, 999);
}
...
BOOST_AUTO_TEST_CASE(EMSTFirstTwoOutputRowsIntegerTest)
{
  ...
  for (size_t i = 0; i < CLI::GetParam<arma::mat>("predictions").n_cols; i++)
  {
    BOOST_REQUIRE_CLOSE(CLI::GetParam<arma::mat>("predictions")(0, i),
        boost::math::iround(CLI::GetParam<arma::mat>("predictions")(0, i)), 1e-5);
    BOOST_REQUIRE_CLOSE(CLI::GetParam<arma::mat>("predictions")(1, i),
        boost::math::iround(CLI::GetParam<arma::mat>("predictions")(1, i)), 1e-5);
  }
}
