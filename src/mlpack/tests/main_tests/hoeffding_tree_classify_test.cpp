/**
 * @file tests/main_tests/hoeffding_tree_classify_test.cpp
 * @author Dirk Eddelbuettel
 *
 * Test RUN_BINDING() of hoeffding_tree_classify_main.cpp.
 *
...
#include <mlpack/methods/hoeffding_trees/hoeffding_tree_classify_main.cpp>
...
BINDING_TEST_FIXTURE(HoeffdingTreeClassifyTestFixture);

/**
 * Check that absence of model throws error.
 */
TEST_CASE_METHOD(HoeffdingTreeClassifyTestFixture,
                 "HoeffdingTreeClassifyNoModelTest",
                 "[HoeffdingTreeClassifyMainTest][BindingTests]")
{
  constexpr int N = 10;
  constexpr int D = 2;
 ...
 */
TEST_CASE_METHOD(HoeffdingTreeClassifyTestFixture,
                 "HoeffdingTreeClassifyNoDataTest",
                 "[HoeffdingTreeClassifyMainTest][BindingTests]")
{
  // Initial model.
 ...
 */
TEST_CASE_METHOD(HoeffdingTreeClassifyTestFixture,
                 "HoeffdingTreeClassifyPredictionSizeTest",
                 "[HoeffdingTreeClassifyMainTest][BindingTests]")
{
  constexpr int N = 10;
  constexpr int D = 2;
