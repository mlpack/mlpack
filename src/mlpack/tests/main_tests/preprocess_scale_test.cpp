...
BOOST_AUTO_TEST_CASE(TwoScalerTest)
{
  ...
  mlpackMain();
  arma::mat maxAbsScalerOutput = CMD::GetParam<arma::mat>("output");
  ...
  mlpackMain();
  arma::mat standardScalerOutput = CMD::GetParam<arma::mat>("output");
...
BOOST_AUTO_TEST_CASE(TwoOptionTest)
{
  ...
  mlpackMain();
  arma::mat output_with_param = CMD::GetParam<arma::mat>("output");
...
BOOST_AUTO_TEST_CASE(UnrelatedOptionTest)
{
  ...
  mlpackMain();
  arma::mat scaled = CMD::GetParam<arma::mat>("output");
...
BOOST_AUTO_TEST_CASE(InverseScalingTest)
{
  ...
  SetInputParam("input_model",
                CMD::GetParam<ScalingModel*>("output_model"));
