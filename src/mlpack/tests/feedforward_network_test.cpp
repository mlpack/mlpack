...
/**
 * Check whether copying and moving of Max Pooling network is working or not.
 */
TEST_CASE("CheckCopyMovingMaxPoolingNetworkTest", "[FeedForwardNetworkTest]")
{
  // Load the dataset.
  arma::mat trainData;
  data::Load("thyroid_train.csv", trainData, true);
...
/**
 * Check whether copying and moving of Mean Pooling network is working or not.
 */
TEST_CASE("CheckCopyMovingMeanPoolingNetworkTest", "[FeedForwardNetworkTest]")
{
  // Load the dataset.
  arma::mat trainData;
  data::Load("thyroid_train.csv", trainData, true);
...
/**
 * Check whether copying and moving of Adaptive Max Pooling network is working or not.
 */
TEST_CASE("CheckCopyMovingAdaptiveMaxPoolingNetworkTest", "[FeedForwardNetworkTest]")
{
  ...
  model->Add<Linear<> >(trainData.n_rows, 8);
  model->Add<SigmoidLayer<> >();
  model->Add<AdaptiveMaxPooling<> >();
  model->Add<LogSoftMax<> >();

  FFN<NegativeLogLikelihood<> > *model1 = new FFN<NegativeLogLikelihood<> >;
  model1->Add<Linear<> >(trainData.n_rows, 8);
  model1->Add<SigmoidLayer<> >();
  model1->Add<AdaptiveMaxPooling<> >();
  model1->Add<LogSoftMax<> >();
...
/**
 * Check whether copying and moving of Adaptive Mean Pooling network is working or not.
 */
TEST_CASE("CheckCopyMovingAdaptiveMeanPoolingNetworkTest", "[FeedForwardNetworkTest]")
{
  // Load the dataset.
  arma::mat trainData;
  data::Load("thyroid_train.csv", trainData, true);
  ...
  model->Add<Linear<> >(trainData.n_rows, 8);
  model->Add<SigmoidLayer<> >();
  model->Add<AdaptiveMeanPooling<> >();
  model->Add<LogSoftMax<> >();

  FFN<NegativeLogLikelihood<> > *model1 = new FFN<NegativeLogLikelihood<> >;
  model1->Add<Linear<> >(trainData.n_rows, 8);
  model1->Add<SigmoidLayer<> >();
  model1->Add<AdaptiveMeanPooling<> >();
  model1->Add<LogSoftMax<> >();
