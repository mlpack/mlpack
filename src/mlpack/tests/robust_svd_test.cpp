/**
 * @file robust_svd_test.cpp
 * @author Charan Reddy
 *
 * Test file for the Robust SVD class.
 *
...
BOOST_AUTO_TEST_SUITE(RobustSVDTest);
 ...
 * small.
 */
BOOST_AUTO_TEST_CASE(RobustSVDReconstructionError)
{
  ...
  svd::RobustSVD rSVD(0, 10);
  rSVD.Apply(data, U2, s2, V2);
