...
#include <mlpack/core/optimizers/sgd/sgd_P.hpp>
...
{
  SGDTestFunction f;
  SGD_P<SGDTestFunction> s(f, 0.0003, 5000000, 1e-9, true);
...
BOOST_AUTO_TEST_CASE(GeneralizedRosenbrockTest)
{
  ...
  for (size_t i = 10; i < 50; i += 5)
  {
    ...
    SGD_P<GeneralizedRosenbrockFunction> s(f, 0.001, 50000, 1e-15, true);
