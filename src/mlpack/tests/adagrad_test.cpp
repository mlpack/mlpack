/**
 * @file adagrad_test.cpp
 * @author KrishnaKantSingh
 *
...
#include <mlpack/core/optimizers/adagrad/adagrad.hpp>
...
{
  SGDTestFunction f;
  AdaGrad<SGDTestFunction> optimizer(f, 1e-3, 1e-8, 5000000, 1e-9, true);
