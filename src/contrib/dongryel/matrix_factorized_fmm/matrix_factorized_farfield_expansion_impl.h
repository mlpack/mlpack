#ifndef INSIDE_MATRIX_FACTORIZED_FARFIELD_EXPANSCLIN_H
#error "This is not a public header file!"
#endif

#ifndef MATRIX_FACTORIZED_FARFIELD_EXPANSCLIN_IMPL_H
#define MATRIX_FACTORIZED_FARFIELD_EXPANSCLIN_IMPL_H
