...
void Test(u32 digit_1, u32 digit_2,
  ...
  sprintf(hypothesis_dir, 
	  "/scratch/niche/fastlib-stl/contrib/niche/discriminative_sparse_coding/fx/mnist_dlcc/mnist/digit1_%d__digit2_%d__n_iterations_1e5__n_pegasos_iterations_1e7__n_atoms_%d__lambda1_%g__lambda2_%g__lambdaw_%g",
